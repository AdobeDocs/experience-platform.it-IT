...
È possibile utilizzare [!DNL HTTP API] connettore di origine per inviare i dati a Platform. Il [!DNL HTTP API] origine supportata da [!DNL Data Prep] consente di mappare qualsiasi dato non conforme a XDM su un set di dati conforme a XDM.
