...
title: Panoramica del connettore di origine dell’archiviazione file di Azure
...
La documentazione seguente fornisce informazioni sulle modalità di connessione [!DNL Azure File Storage] a [!DNL Platform] utilizzando le API o l’interfaccia utente:
