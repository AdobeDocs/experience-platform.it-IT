---
keywords: Experience Platform;home;argomenti comuni;Azure Data Lake Storage Gen2;ADLS-Gen2;adls gen2;ADLS Gen2
...
Le origini di archiviazione cloud possono inserire i tuoi dati in [!DNL Platform] senza dover scaricare, formattare o caricare. I dati acquisiti possono essere formattati come XDM JSON, XDM Parquet o delimitati. Ogni passaggio del processo viene integrato nel flusso di lavoro Origini. [!DNL Platform] consente di inserire dati da [!DNL Azure Data Lake Storage Gen2] (ADLS-Gen2) tramite batch.
...
La documentazione seguente fornisce informazioni sulle modalità di connessione [!DNL Azure Data Lake Storage Gen2] a [!DNL Platform] utilizzando le API o l’interfaccia utente:

### Utilizzo delle API

- [Creare una connessione di base ADLS-Gen2 utilizzando l&#39;API del servizio Flow](../../tutorials/api/create/cloud-storage/adls-gen2.md)
