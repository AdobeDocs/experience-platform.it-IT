...
Adobe Experience Platform fornisce connettività nativa per i provider di cloud come AWS, [!DNL Google Cloud Platform], e [!DNL Azure], che consente di estrarre i dati da questi sistemi. I dati acquisiti possono essere formattati come JSON, Parquet o delimitati. Il supporto per i provider di archiviazione cloud include [!DNL Apache] HDFS.
...
La documentazione seguente fornisce informazioni sulle modalità di connessione [!DNL Apache] HDFS a [!DNL Platform] utilizzando le API o l’interfaccia utente:
