...
topic: overview
description: Scopri come collegare Google Cloud Storage ad Adobe Experience Platform utilizzando le API o l'interfaccia utente.
...
- [Creare una connessione di origine di archiviazione Google Cloud utilizzando l&#39;API del servizio di flusso](../../tutorials/api/create/cloud-storage/google.md)
...
- [Creare una connessione sorgente di archiviazione Google Cloud nell&#39;interfaccia utente](../../tutorials/ui/create/cloud-storage/google-cloud-storage.md)
