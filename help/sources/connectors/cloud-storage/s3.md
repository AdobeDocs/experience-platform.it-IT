...
topic: overview
description: Scoprite come collegare S3 ad Adobe Experience Platform utilizzando le API o l'interfaccia utente.
...
La documentazione seguente fornisce informazioni su come collegare S3 ad Adobe Experience Platform utilizzando le API o l&#39;interfaccia utente:

### Utilizzo delle API

- [Creare una connessione di origine S3 utilizzando l&#39;API di servizio di flusso](../../tutorials/api/create/cloud-storage/s3.md)
