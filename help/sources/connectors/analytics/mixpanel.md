...
Questa sezione descrive i passaggi preliminari da completare per autenticare il tuo account e portare i tuoi dati di [!DNL Mixpanel] in Experience Platform.
...
Infine, crea uno [schema](../../../xdm/schema/composition.md) Experience Platform richiesto per [!DNL Mixpanel Event Export API]. Per ulteriori informazioni sui mapping richiesti per lo schema, vedere la guida alla [creazione di una connessione di origine [!DNL Mixpanel] nell&#39;interfaccia utente](../../tutorials/ui/create/analytics/mixpanel.md#additional-resources).

![Crea schema](../../images/tutorials/create/mixpanel-export-events/schema.png)

## Connetti [!DNL Mixpanel] ad Experience Platform tramite API

La documentazione seguente fornisce informazioni su come connettere [!DNL Mixpanel] ad Experience Platform tramite API o tramite l&#39;interfaccia utente:
...
## Connetti [!DNL Mixpanel] ad Experience Platform tramite l&#39;interfaccia utente
