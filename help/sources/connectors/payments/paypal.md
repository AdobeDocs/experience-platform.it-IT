...
Experience Platform fornisce supporto per l’acquisizione di dati da un’applicazione di pagamenti di terze parti. Il supporto per i fornitori di servizi di pagamento include [!DNL PayPal].
...
La documentazione seguente fornisce informazioni sulle modalità di connessione [!DNL PayPal] in Platform tramite API o l’interfaccia utente:
