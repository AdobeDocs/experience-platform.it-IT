...
# [!DNL PayPal] connettore

Adobe Experience Platform consente di acquisire dati da sorgenti esterne e allo stesso tempo di strutturare, etichettare e migliorare i dati in arrivo tramite i servizi Platform. È possibile acquisire dati da diverse sorgenti, come applicazioni di Adobe, archiviazione basata su cloud, database e molti altri.

Experience Platform fornisce il supporto per l’acquisizione di dati da un’applicazione di pagamento di terze parti. Il supporto per i fornitori di pagamenti include [!DNL PayPal].
...
La documentazione seguente fornisce informazioni su come connettersi a [!DNL PayPal] Platform utilizzando le API o l’interfaccia utente:

## Connetti [!DNL PayPal] alla piattaforma utilizzando le API

- [Creare una connessione di base PayPal utilizzando l’API del servizio di flusso](../../tutorials/api/create/payments/paypal.md)
...
## Connetti [!DNL PayPal] alla piattaforma utilizzando l’interfaccia utente
