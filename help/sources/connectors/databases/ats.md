...
title: Panoramica del connettore origine archivio tabelle Azure
topic: overview
description: Scoprite come collegare Azure Table Storage ad Adobe Experience Platform utilizzando le API o l'interfaccia utente.
...
# (Beta) [!DNL Azure Table Storage] connettore
...
[!DNL Experience Platform] fornisce il supporto per l&#39;acquisizione di dati da un database di terze parti. [!DNL Platform] può connettersi a diversi tipi di database, ad esempio relazionali, NoSQL o data warehouse. Il supporto per i provider di database include [!DNL Azure Table Storage].
...
La documentazione seguente fornisce informazioni su come connettersi [!DNL Azure Table Storage] a [!DNL Platform] utilizzando le API o l&#39;interfaccia utente:

## Connetti [!DNL Azure Table Storage] a [!DNL Platform] utilizzando le API

- [Creare una connessione di origine Azure Table Storage utilizzando l&#39;API Flow Service](../../tutorials/api/create/databases/ats.md)
...
- [Creazione di una connessione di origine Azure Table Storage nell&#39;interfaccia utente](../../tutorials/ui/create/databases/ats.md)
