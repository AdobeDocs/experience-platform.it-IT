...
topic: overview
description: La documentazione seguente fornisce informazioni su come collegare Azure Table Storage alla piattaforma utilizzando le API o l'interfaccia utente.
...
# Connettore (Beta) [!DNL Azure Table Storage]
...
La documentazione seguente fornisce informazioni su come connettersi [!DNL Azure Table Storage] all&#39; [!DNL Platform] utilizzo delle API o dell&#39;interfaccia utente:

## Connessione [!DNL Azure Table Storage] all&#39; [!DNL Platform] utilizzo delle API
...
## Connessione [!DNL Azure Table Storage] all’ [!DNL Platform] interfaccia utente
