...
La documentazione seguente fornisce informazioni su come connettersi [!DNL Azure Table Storage] su Platform utilizzando le API o l’interfaccia utente:

## Connetti [!DNL Azure Table Storage] su Platform tramite API
...
## Connetti [!DNL Azure Table Storage] su Platform tramite l’interfaccia utente
