...
topic: overview
description: La documentazione seguente fornisce informazioni su come collegare l'Data Explorer di Azure alla piattaforma utilizzando le API o l'interfaccia utente.
