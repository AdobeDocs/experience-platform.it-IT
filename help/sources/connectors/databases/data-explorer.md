...
title: Panoramica del connettore di origine di Data Explorer di Azure
topic: overview
description: Scoprite come collegare l'Data Explorer di Azure ad Adobe Experience Platform utilizzando le API o l'interfaccia utente.
...
# (Beta) [!DNL Azure Data Explorer] connettore
...
La documentazione seguente fornisce informazioni su come connettersi [!DNL Azure Data Explorer] a [!DNL Platform] utilizzando le API o l&#39;interfaccia utente:

## Connetti [!DNL Azure Data Explorer] a [!DNL Platform] utilizzando le API

- [Creazione di una connessione di origine dell&#39;Data Explorer di Azure tramite l&#39;API del servizio di flusso](../../tutorials/api/create/databases/data-explorer.md)
...
- [Creazione di una connessione di origine di Data Explorer di Azure nell&#39;interfaccia utente](../../tutorials/ui/create/databases/data-explorer.md)
