...
topic: overview
description: La documentazione seguente fornisce informazioni su come collegare Apache Hive in Azure HDInsights alla piattaforma utilizzando le API o l'interfaccia utente.
