...
title: Panoramica del connettore origine Couchbase
topic: overview
description: Scopri come collegare Couchbase ad Adobe Experience Platform utilizzando le API o l'interfaccia utente.
...
- [Creare una connessione di origine Couchbase utilizzando l&#39;API del servizio di flusso](../../tutorials/api/create/databases/couchbase.md)
