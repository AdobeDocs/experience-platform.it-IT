...
## Connetti [!DNL Apache Spark] su [!DNL Azure HDInsights] a [!DNL Experience Platform] tramite API
...
## Connetti [!DNL Apache Spark] il [!DNL Azure HDInsights] a [!DNL Experience Platform] tramite l&#39;interfaccia utente
