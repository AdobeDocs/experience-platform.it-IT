...
title: Panoramica del connettore di origine Apache Spark su Azure HDInsights
...
# (Beta) [!DNL Apache Spark] il [!DNL Azure HDInsights] connettore
...
[!DNL Experience Platform] fornisce supporto per l’acquisizione di dati da un database di terze parti. [!DNL Platform] può connettersi a diversi tipi di database, ad esempio database relazionali, NoSQL o data warehouse. Il supporto per i provider di database include [!DNL Apache Spark] il [!DNL Azure HDInsights].
...
La documentazione seguente fornisce informazioni sulle modalità di connessione [!DNL Apache Spark] il [!DNL Azure HDInsights] a [!DNL Platform] utilizzando le API o l’interfaccia utente:

## Connetti [!DNL Apache Spark] il [!DNL Azure HDInsights] a [!DNL Platform] utilizzo delle API
...
## Connetti [!DNL Apache Spark] il [!DNL Azure HDInsights] a [!DNL Platform] utilizzo dell’interfaccia utente
