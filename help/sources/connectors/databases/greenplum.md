...
title: Panoramica del connettore di origine GreenPlum
...
Sono supportati diversi tipi di database di terze parti, inclusi data warehouse relazionali, NoSQL o di terze parti. Il supporto per i provider di database include [!DNL GreenPlum].
...
La documentazione seguente fornisce informazioni sulle modalità di connessione [!DNL GreenPlum] a [!DNL Platform] utilizzando le API o l’interfaccia utente:

## Connetti [!DNL GreenPlum] a [!DNL Platform] utilizzo delle API

- [Creare una connessione di base GreenPlum utilizzando l’API del servizio Flow](../../tutorials/api/create/databases/greenplum.md)
...
## Connetti [!DNL GreenPlum] a [!DNL Platform] utilizzo dell’interfaccia utente
