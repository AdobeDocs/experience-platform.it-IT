...
title: Panoramica del connettore origine GreenPlum
topic: overview
description: Scopri come collegare GreenPlum ad Adobe Experience Platform utilizzando le API o l'interfaccia utente.
...
- [Creare una connessione di origine GreenPlum utilizzando l&#39;API del servizio di flusso](../../tutorials/api/create/databases/greenplum.md)
