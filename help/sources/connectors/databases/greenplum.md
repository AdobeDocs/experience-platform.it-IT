...
topic: overview
description: La documentazione seguente fornisce informazioni su come collegare GreenPlum alla piattaforma utilizzando le API o l'interfaccia utente.
...
La documentazione seguente fornisce informazioni su come connettersi [!DNL GreenPlum] all&#39; [!DNL Platform] utilizzo delle API o dell&#39;interfaccia utente:

## Connessione [!DNL GreenPlum] all&#39; [!DNL Platform] utilizzo delle API
...
## Connessione [!DNL GreenPlum] all’ [!DNL Platform] interfaccia utente
