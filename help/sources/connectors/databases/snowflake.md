...
La documentazione seguente fornisce informazioni su come connettersi [!DNL Snowflake] su Platform utilizzando le API o l’interfaccia utente:

## Connetti [!DNL Snowflake] su Platform tramite API
...
## Connetti [!DNL Snowflake] su Platform tramite l’interfaccia utente
