...
topic: overview
description: La documentazione seguente fornisce informazioni su come collegare Google BigQuery alla piattaforma utilizzando le API o l'interfaccia utente.
