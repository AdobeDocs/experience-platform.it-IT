...
Sono supportati diversi tipi di database di terze parti, tra cui relazionale, NoSQL o date warehouse. Il supporto per i provider di database include [!DNL HP Vertica].
