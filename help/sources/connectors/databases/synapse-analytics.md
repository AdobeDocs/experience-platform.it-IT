...
La documentazione seguente fornisce informazioni su come connettersi [!DNL Azure Synapse Analytics] a [!DNL Platform] utilizzando le API o l’interfaccia utente:
...
## Connetti [!DNL Azure Synapse Analytics] a [!DNL Platform] utilizzo dell’interfaccia
