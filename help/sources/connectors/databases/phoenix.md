...
topic: overview
description: Scoprite come collegare Phoenix ad Adobe Experience Platform utilizzando le API o l'interfaccia utente.
...
La documentazione seguente fornisce informazioni su come connettersi [!DNL Phoenix] a [!DNL Platform] utilizzando le API o l&#39;interfaccia utente:

## Connetti [!DNL Phoenix] a [!DNL Platform] utilizzando le API

- [Creare una connessione di origine Phoenix utilizzando l&#39;API del servizio di flusso](../../tutorials/api/create/databases/phoenix.md)
...
## Connetti [!DNL Phoenix] a [!DNL Platform] utilizzando l&#39;interfaccia utente
