...
La documentazione seguente fornisce informazioni su come connettere [!DNL Teradata Vantage] a Platform tramite API o tramite l&#39;interfaccia utente:

## Connetti [!DNL Teradata Vantage] a Platform tramite API
