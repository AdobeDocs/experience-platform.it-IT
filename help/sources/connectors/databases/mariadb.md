...
- [Creare una connessione di base MariaDB utilizzando l’API del servizio di flusso](../../tutorials/api/create/databases/mariadb.md)
...
## Connetti [!DNL MariaDB] a [!DNL Platform] utilizzo dell’interfaccia
