...
Experience Platform fornisce supporto per l’acquisizione di dati da un database di terze parti. [!DNL Platform] può connettersi a diversi tipi di database, ad esempio database relazionali, NoSQL o data warehouse. Il supporto per i provider di database include [!DNL MariaDB].
...
La documentazione seguente fornisce informazioni sulle modalità di connessione [!DNL MariaDB] a [!DNL Platform] utilizzando le API o l’interfaccia utente:

## Connetti [!DNL MariaDB] a [!DNL Platform] utilizzo delle API
...
## Connetti [!DNL MariaDB] a [!DNL Platform] utilizzo dell’interfaccia utente
