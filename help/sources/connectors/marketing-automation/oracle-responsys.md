...
title: Panoramica dell’origine di Responsys di un Oracle (Beta)
...
# (Beta) [!DNL Oracle Responsys] sorgente

>[!NOTE]
>
>Il [!DNL Oracle Responsys] sorgente in versione beta. Consulta la [Panoramica sulle origini](../../home.md#terms-and-conditions) per ulteriori informazioni sull’utilizzo di fonti etichettate beta.
...
Experienci Platform fornisce supporto per l’acquisizione di dati da un sistema di automazione del marketing di terze parti. Il supporto per i provider di automazione marketing include [!DNL Oracle Responsys].
...
La documentazione seguente fornisce informazioni sulle modalità di connessione [!DNL Oracle Responsys] in Platform tramite API o l’interfaccia utente:

## Connetti [!DNL Oracle Responsys] alla piattaforma utilizzando le API
