...
Experience Platform supporta l’acquisizione di dati da un sistema di automazione marketing di terze parti. Il supporto per i fornitori di automazione di marketing include HubSpot.

La documentazione seguente fornisce informazioni su come collegare HubSpot alla piattaforma utilizzando le API o l&#39;interfaccia utente:

## Collegare HubSpot alla piattaforma mediante le API
...
## Collegare HubSpot alla piattaforma mediante l’interfaccia utente
