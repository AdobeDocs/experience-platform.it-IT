...
* Dopo aver installato correttamente l&#39;estensione del connettore, accedi al tuo account Adobe in Experience Cloud e [conferma l&#39;ID organizzazione](https://experienceleague.adobe.com/docs/core-services/interface/administration/organizations.html?lang=it#concept_EA8AEE5B02CF46ACBDAD6A8508646255). Questo ID è associato alla società di Experience Cloud con provisioning. È formattato come stringa alfanumerica composta da 24 caratteri e include un `@AdobeOrg` obbligatorio.
