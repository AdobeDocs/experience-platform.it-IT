...
* **Eventi Storefront**: acquisisce le interazioni dell&#39;acquirente come `View Page`, `View Product` e `Add to Cart`. Per i commercianti B2B, gli eventi storefront acquisiscono anche [elenchi di richieste](https://experienceleague.adobe.com/docs/commerce-admin/b2b/requisition-lists/requisition-lists.html?lang=it).
...
* [Installa  [!DNL Data Connection] l&#39;estensione](https://experienceleague.adobe.com/docs/commerce-merchant-services/data-connection/fundamentals/install.html?lang=it) per Adobe Commerce. È possibile scaricare l&#39;estensione del connettore da [Adobe Marketplace](https://commercemarketplace.adobe.com/magento-experience-platform-connector.html).
* Dopo aver installato correttamente l&#39;estensione del connettore, accedi al tuo account Adobe in Experience Cloud e [conferma l&#39;ID organizzazione](https://experienceleague.adobe.com/docs/core-services/interface/administration/organizations.html?lang=it#concept_EA8AEE5B02CF46ACBDAD6A8508646255). Questo ID è associato alla società con provisioning di Experience Cloud. È formattato come stringa alfanumerica composta da 24 caratteri e include un `@AdobeOrg` obbligatorio.
...
* Una volta configurato lo schema, devi creare un set di dati basato sul nuovo schema. Questo set di dati conterrà i dati [!DNL Commerce] inviati. Per i passaggi dettagliati su come creare un set di dati per i dati [!DNL Commerce], consulta la guida sull&#39;[invio di dati ad Experience Platform](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/experience-cloud/platform.html?lang=it#create-a-dataset).
* Quindi, crea un flusso di dati e seleziona lo schema XDM che contiene i gruppi di campi specifici di Commerce. Per ulteriori informazioni sugli stream di dati, leggere la [panoramica sugli stream di dati](https://experienceleague.adobe.com/docs/experience-platform/datastreams/overview.html?lang=it).
* Quindi è necessario connettere l&#39;istanza di Adobe Commerce al [Connettore servizi Commerce](https://experienceleague.adobe.com/docs/commerce-merchant-services/user-guides/integration-services/saas.html?lang=it). Questo consente di distribuire l’istanza Commerce come SaaS (Software as a Service).
