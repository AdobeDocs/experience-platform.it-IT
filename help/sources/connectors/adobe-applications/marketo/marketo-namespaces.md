...
| Nome schema | Classe base | Gruppi di campi | [!DNL Profile] nello schema | Identità primaria | Spazio dei nomi dell’identità primaria | Identità secondaria | Spazio dei nomi dell’identità secondaria | Relazione | Note |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
