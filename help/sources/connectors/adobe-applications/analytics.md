...
| Nuovi dati da inserire nel Customer Journey Analytics senza [unione](https://experienceleague.adobe.com/docs/analytics-platform/using/stitching/overview.html?lang=en) | &lt; 3,75 ore |
...
Per ulteriori informazioni sulle latenze del Customer Journey Analytics, vedere: [Guardrail Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-admin/guardrails.html?lang=en).
...
Questi campi non sono contrassegnati come identità. Al contrario, le stesse identità (se presenti nell’evento) vengono copiate in XDM `identityMap` come coppie chiave-valore:
