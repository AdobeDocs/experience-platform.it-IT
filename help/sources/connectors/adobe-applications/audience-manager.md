...
| Dati dispositivi AAM | Dati del dispositivo con ECID e realizzazioni del segmento corrispondenti, aggregati in Audience Manager. I dati non sono visibili come batch nel set di dati. È possibile abilitare **[!UICONTROL Profilo]** , per acquisire direttamente i dati nel profilo. | Registra |
...
| Recupero dati dispositivi AAM | Set di dati da importare dati di dispositivi passati. Contiene gli ECID e le realizzazioni dei segmenti corrispondenti aggregati in Audience Manager. I dati non sono visibili come batch nel set di dati. È possibile abilitare **[!UICONTROL Profilo]** attiva per acquisire direttamente i dati nel profilo. | Registra |
...
| --- | --- | --- | --- |
| Dati in tempo reale | Eventi | &lt;25 minuti | Tempo dall’acquisizione nel nodo Audience Manager Edge alla visualizzazione nel data lake. |
