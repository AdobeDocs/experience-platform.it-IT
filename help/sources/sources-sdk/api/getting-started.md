...
Per utilizzare Origini self-service (SDK batch), devi assicurarti di avere accesso a una Sandbox organizzazione con provisioning di origini Adobe Experience Platform.
