...
title: Configurare le specifiche di esplorazione per le origini self-service (Batch SDK)
...
# Configurare le specifiche di esplorazione per le origini self-service (Batch SDK)
...
Dopo aver popolato le specifiche di esplorazione, è possibile creare una specifica di connessione completa utilizzando l&#39;API [!DNL Flow Service]. Per ulteriori informazioni, vedere la [Guida dell&#39;API Self-Serve Sources (Batch SDK)](../api/api-overview.md).
