...
- Connettori di origine disponibili {#connectors}
   - Applicazioni di Adobe {#adobe-applications}
      ...
      - Mappature campi {#mapping}
         ...
         - [Mappature campi Audience Manager](connectors/adobe-applications/mapping/audience-manager.md)
         - [Mappature campi Marketo Engage](connectors/adobe-applications/mapping/marketo.md)
         - [Mappature campi Microsoft Dynamics](connectors/adobe-applications/mapping/dynamics.md)
   ...
   - Archiviazione cloud {#cloud-storage}
      ...
      - [Archiviazione di oggetti di Oracle](connectors/cloud-storage/oracle-object-storage.md)
   ...
   - Database {#databases}
      ...
      - [Connettore Databricks](connectors/databases/databricks.md)
...
- Esercitazioni API {#api-tutorials}
   - Creare una connessione di base {#create}
      ...
      - Archiviazione cloud {#cloud-storage}
         ...
         - [Archiviazione di oggetti di Oracle](tutorials/api/create/cloud-storage/oracle-object-storage.md)
      ...
      - Customer success {#customer-success}
         - [Service Cloud Salesforce](tutorials/api/create/customer-success/salesforce-service-cloud.md)
      ...
      - Marketing automation {#marketing-automation}
         ...
         - [Attività di Oracle NetSuite](tutorials/api/create/marketing-automation/oracle-netsuite-activities.md)
         - [Entità di Oracle NetSuite](tutorials/api/create/marketing-automation/oracle-netsuite-entities.md)
   ...
   - [Abilita la modifica di acquisizione dei dati](tutorials/api/change-data-capture.md)
- Tutorial sull’interfaccia utente {#ui-tutorials}
   - Creare una connessione sorgente {#create}
      ...
      - Archiviazione cloud {#cloud-storage}
         ...
         - [Archiviazione di oggetti di Oracle](tutorials/ui/create/cloud-storage/oracle-object-storage.md)
      ...
      - Customer Success {#customer-success}
         - [Service Cloud Salesforce](tutorials/ui/create/customer-success/salesforce-service-cloud.md)
      ...
      - Fedeltà {#loyalty}
         ...
         - [Eventi di streaming Kobie](tutorials/ui/create/loyalty/kobie-streaming.md)
...
- Origini self-service (SDK in batch) {#sdk}
   ...
   - Streaming SDK {#streaming-sdk}
      ...
      - [Documenta la sorgente (Streaming SDK)](sources-sdk/streaming/document-streaming.md)
...
- [Indirizzo IP inserisco nell&#39;elenco Consentiti](ip-address-allow-list.md)
- [Domande frequenti](./troubleshooting.md)
- [Documentazione delle API](https://www.adobe.io/experience-platform-apis/references/flow-service/)
