...
topic: overview
description: Questa esercitazione fornisce i passaggi per l'autenticazione di un connettore sorgente Amazon  (in seguito denominato "Kinesis") tramite l'interfaccia utente della piattaforma.
...
Per ulteriori informazioni su questi valori, fare riferimento a [ [!DNL Kinesis] questo documento](https://docs.aws.amazon.com/streams/latest/dev/getting-started.html).
...
Sotto la **[!UICONTROL Cloud Storage]** categoria, selezionare **[!UICONTROL Amazon Kinesis]**. Se si tratta della prima volta che si utilizza questo connettore, selezionare **[!UICONTROL Configure]**. In caso contrario, selezionare **[!UICONTROL Add data]** per creare un nuovo [!DNL Kinesis] connettore.
