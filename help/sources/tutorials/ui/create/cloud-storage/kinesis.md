...
Sotto la *[!UICONTROL Cloud Storage]* categoria, selezionare **[!UICONTROL Amazon Kinesis]** e fare clic **sull&#39;icona + (+)** per creare un nuovo [!DNL Kinesis] connettore.
...
Seguendo questa esercitazione, ti sei collegato al tuo [!DNL Kinesis] account a [!DNL Platform]. Ora puoi continuare con l’esercitazione successiva e [configurare un flusso di dati per trasferire i dati dall’archiviazione cloud ad Platform](../../dataflow/streaming/cloud-storage.md).