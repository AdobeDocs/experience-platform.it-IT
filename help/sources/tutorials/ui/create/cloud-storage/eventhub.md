...
Se si dispone già di una [!DNL Event Hubs] connessione valida, è possibile ignorare il resto del documento e procedere all&#39;esercitazione sulla [configurazione di un flusso di dati](../../dataflow/streaming/cloud-storage-streaming.md).
...
Seguendo questa esercitazione hai collegato il tuo [!DNL Event Hubs] account a [!DNL Platform]. Ora puoi continuare con l’esercitazione successiva e [configurare un flusso di dati per trasferire i dati dall’archiviazione cloud [!DNL Platform]](../../dataflow/streaming/cloud-storage-streaming.md).