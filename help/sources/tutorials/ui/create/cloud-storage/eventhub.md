...
Sotto la *[!UICONTROL Cloud Storage]* categoria, selezionate **[!UICONTROL Azure Event Hubs]** seguito **[!UICONTROL Add data]** da per creare un nuovo connettore per hub eventi.
...
Seguendo questa esercitazione, avete collegato il vostro account Hubs evento a [!DNL Platform]. Ora puoi continuare con l’esercitazione successiva e [configurare un flusso di dati per trasferire i dati dall’archiviazione cloud alla piattaforma](../../dataflow/streaming/cloud-storage.md).