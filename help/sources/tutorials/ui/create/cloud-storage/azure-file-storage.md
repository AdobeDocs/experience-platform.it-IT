...
Sotto la *[!UICONTROL Databases]* categoria, selezionare **[!UICONTROL Azure File Storage]** seguito da **[!UICONTROL Add data]** per creare un nuovo connettore di archiviazione file di Azure.
...
Seguendo questa esercitazione, è stata stabilita una connessione all&#39; [!DNL Azure File Storage] account. Ora puoi continuare con l’esercitazione successiva e [configurare un flusso di dati per trasferire i dati dall’archiviazione cloud alla piattaforma](../../dataflow/batch/cloud-storage.md).