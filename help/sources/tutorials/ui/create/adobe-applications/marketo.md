...
Le sezioni seguenti forniscono linee guida aggiuntive che puoi seguire quando utilizzi [!DNL Marketo] sorgente.

### Messaggi di errore nell’interfaccia utente {#error-messages}

I seguenti messaggi di errore vengono visualizzati nell’interfaccia utente quando Platform rileva problemi di configurazione:

#### [!DNL Munchkin ID] non è mappato nell&#39;organizzazione appropriata

L&#39;autenticazione verrà negata se il tuo [!DNL Munchkin ID] non è mappato all’organizzazione Platform in uso. Configura la mappatura tra [!DNL Munchkin ID] e la tua organizzazione che utilizza [[!DNL Marketo] interfaccia](https://app-sjint.marketo.com/#MM0A1).

![Messaggio di errore che indica che l’istanza Marketo non è mappata correttamente nell’organizzazione Adobe.](../../../../images/tutorials/create/marketo/munchkin-not-mapped.png)

#### Identità principale mancante

Se manca un’identità primaria, un flusso di dati non riesce a salvarlo e a caricarlo. Assicurati che [esiste un&#39;identità principale nello schema XDM](../../../../../xdm/tutorials/create-schema-ui.md), prima di tentare di configurare un flusso di dati.

![Messaggio di errore che indica che l&#39;identità principale è mancante dallo schema XDM.](../../../../images/tutorials/create/marketo/no-primary-identity.png)
