---
title: Acquisire Dati In Batch Da Kobie In Experience Platform Utilizzando L’Interfaccia Utente
description: Scopri come acquisire i dati batch da Kobie in Adobe Experience Platform utilizzando l’interfaccia utente.
badge: Beta
hide: true
hidefromtoc: true
...
# Acquisire dati batch da [!DNL Kobie] in Experience Platform utilizzando l&#39;interfaccia utente

Leggi questo tutorial per scoprire come acquisire dati batch dall&#39;account [!DNL Kobie] in Adobe Experience Platform utilizzando l&#39;area di lavoro origini nell&#39;interfaccia utente.
...
>[!IMPORTANT]
>
>Leggi la [[!DNL Kobie] panoramica](../../../../connectors/loyalty/kobie.md) per scoprire i passaggi necessari per completare i prerequisiti prima di collegare l&#39;account ad Experience Platform.
...
Per acquisire i dati da [!DNL Kobie], selezionare la scheda di origine **[!UICONTROL Kobie Batch Source Connector]** in *[!UICONTROL Loyalty]*, quindi selezionare **[!UICONTROL Add data]**.
...
Per creare un nuovo account per l&#39;origine [!DNL Kobie], selezionare **[!UICONTROL New account]** e fornire un nome e una descrizione facoltativa per l&#39;account. Quindi, fornisci il dominio [!DNL Kobie] e [!UICONTROL Kobie Management API Key]. Al termine, selezionare **[!UICONTROL Connect to source]** e attendere alcuni istanti per consentire la connessione.



### Usa un account esistente

Per utilizzare un account esistente, selezionare **[!UICONTROL Existing account]** e selezionare l&#39;account [!DNL Kobie] che si desidera utilizzare dall&#39;interfaccia account.
...
>[!IMPORTANT]
>
>Per ulteriori informazioni sulla mappatura dei dati di origine [!DNL Kobie], leggere la panoramica di [[!DNL Kobie]]
