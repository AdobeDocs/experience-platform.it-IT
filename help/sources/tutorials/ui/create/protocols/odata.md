...
topic: overview
description: Questa esercitazione fornisce i passaggi per la creazione di un connettore sorgente generico Open Data Protocol (in seguito denominato "OData") tramite l'interfaccia utente della piattaforma.
...
Se disponete già di una [!DNL OData] connessione valida, potete ignorare il resto del documento e procedere all&#39;esercitazione sulla [configurazione di un flusso di dati](../../dataflow/protocols.md)
