...
Sotto la *[!UICONTROL Protocols]* categoria, selezionate **[!UICONTROL Generic OData]** per esporre una barra delle informazioni sul lato destro dello schermo. La barra delle informazioni fornisce una breve descrizione della sorgente selezionata e le opzioni per collegarsi alla sorgente o visualizzare la documentazione. Per creare una nuova connessione in entrata, selezionare **[!UICONTROL Add data]**.
...
Seguendo questa esercitazione, è stata stabilita una connessione all&#39; [!DNL OData] account. Ora puoi continuare con l&#39;esercitazione successiva e [configurare un flusso di dataset per portare i dati dei protocolli nella piattaforma](../../dataflow/protocols.md).