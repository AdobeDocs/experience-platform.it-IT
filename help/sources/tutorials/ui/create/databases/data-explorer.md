...
Sotto la *[!UICONTROL Databases]* categoria, selezionare **[!UICONTROL Azure Data Explorer]** seguito da **[!UICONTROL Add data]** per creare un nuovo connettore Data Explorer.
...
Seguendo questa esercitazione, è stata stabilita una connessione all&#39; [!DNL Data Explorer] account. Ora puoi continuare con l’esercitazione successiva e [configurare un flusso di dati per l’inserimento di dati nella piattaforma](../../dataflow/databases.md).