...
topic: overview
description: Questa esercitazione fornisce i passaggi per la creazione di un connettore di origine MySQL tramite l'interfaccia utente della piattaforma.
