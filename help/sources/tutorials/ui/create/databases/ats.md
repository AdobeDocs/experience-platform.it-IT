...
topic: overview
type: Tutorial
description: Questa esercitazione fornisce i passaggi per la creazione di un connettore di origine Azure Table Storage (di seguito "ATS") tramite l'interfaccia utente della piattaforma.
