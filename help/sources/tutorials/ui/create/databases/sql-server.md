...
topic: overview
description: Questa esercitazione fornisce i passaggi per la creazione di un connettore di origine Microsoft SQL Server (di seguito "SQL Server") tramite l'interfaccia utente della piattaforma.
