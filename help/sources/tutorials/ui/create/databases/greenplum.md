...
topic: overview
description: Questa esercitazione fornisce i passaggi per la creazione di un connettore sorgente GreenPlum utilizzando l'interfaccia utente della piattaforma.
