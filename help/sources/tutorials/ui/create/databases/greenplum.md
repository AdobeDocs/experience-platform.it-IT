...
Sotto la *[!UICONTROL Databases]* categoria, selezionare **[!UICONTROL GreenPlum]** fare clic **sull&#39;icona + (+)** per creare un nuovo [!DNL GreenPlum] connettore.
...
Seguendo questa esercitazione, è stata stabilita una connessione all&#39; [!DNL GreenPlum] account. Ora puoi continuare con l’esercitazione successiva e [configurare un flusso di dati per l’inserimento di dati in Platform](../../dataflow/databases.md).