...
I connettori di origine in  Adobe Experience Platform consentono di trasferire i dati esternamente originati su base programmata. Questa esercitazione fornisce i passaggi per creare un Apache Hive sul connettore di origine Azure HDInsights utilizzando l&#39;interfaccia utente di Platform.
...
Per accedere al tuo account Hive su Platform, devi fornire i seguenti valori:
...
Dopo aver raccolto le credenziali necessarie, potete seguire i passaggi descritti di seguito per creare un nuovo account Hive per la connessione ad Platform.
...
Seguendo questa esercitazione hai stabilito una connessione con il tuo account Hive. Ora puoi continuare con l’esercitazione successiva e [configurare un flusso di dati per l’inserimento di dati in Platform](../../dataflow/databases.md).