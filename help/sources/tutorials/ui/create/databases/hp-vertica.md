...
Seguendo questa esercitazione, hai stabilito una connessione al tuo [!DNL Vertica] account HP. Ora puoi continuare con l’esercitazione successiva e [configurare un flusso di dati per l’inserimento di dati in Platform](../../dataflow/databases.md).