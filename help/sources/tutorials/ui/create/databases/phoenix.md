...
topic: overview
type: Tutorial
description: Questa esercitazione fornisce i passaggi per la creazione di un connettore sorgente Phoenix mediante l'interfaccia utente della piattaforma.
...
Se disponete già di una [!DNL Phoenix] connessione valida, potete ignorare il resto del documento e procedere all&#39;esercitazione sulla [configurazione di un flusso di dati](../../dataflow/databases.md)
