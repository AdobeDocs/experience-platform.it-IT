...
Per accedere al tuo account Spark sulla piattaforma, devi fornire i seguenti valori:
...
Dopo aver raccolto le credenziali necessarie, potete seguire i passaggi descritti di seguito per creare un nuovo account Spark per la connessione alla piattaforma.
...
Seguendo questa esercitazione, hai stabilito una connessione con il tuo account Spark. Ora puoi continuare con l’esercitazione successiva e [configurare un flusso di dati per l’inserimento di dati nella piattaforma](../../dataflow/databases.md).