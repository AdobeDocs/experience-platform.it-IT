...
topic: overview
description: Questa esercitazione fornisce i passaggi per la creazione di un connettore di origine ServiceNow utilizzando l'interfaccia utente della piattaforma.
...
Se disponete già di una [!DNL ServiceNow] connessione valida, potete ignorare il resto del documento e procedere all&#39;esercitazione sulla [configurazione di un flusso di dati](../../dataflow/customer-success.md)
