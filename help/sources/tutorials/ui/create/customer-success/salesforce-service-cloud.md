...
topic: overview
description: Questa esercitazione fornisce i passaggi per la creazione di un connettore sorgente Salesforce Service Cloud (in seguito denominato "SSC") tramite l'interfaccia utente della piattaforma.
