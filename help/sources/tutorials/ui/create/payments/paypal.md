...
Sotto la *[!UICONTROL CRM]* categoria, selezionate **[!UICONTROL PayPal]** per esporre una barra delle informazioni sul lato destro dello schermo. La barra delle informazioni fornisce una breve descrizione della sorgente selezionata e le opzioni per collegarsi alla sorgente o visualizzare la documentazione. Per creare una nuova connessione di base in entrata, selezionare **[!UICONTROL Add data]**.
...
Seguendo questa esercitazione hai stabilito una connessione di base all&#39; [!DNL PayPal] account. Ora puoi continuare con l&#39;esercitazione successiva e [configurare un flusso di dati per portare i dati CRM nella piattaforma](../../dataflow/payments.md).