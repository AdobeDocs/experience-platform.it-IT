...
Selezionare **[!DNL Demandbase Intent]** nella categoria *[!UICONTROL B2B]*, quindi selezionare **[!UICONTROL Configurazione]**.
...
>abstract="Anche se Adobe utilizza il sito web XDM accountOrganization.website, alcuni clienti potrebbero utilizzare campi personalizzati per i rispettivi siti web. Di conseguenza, devi assicurarti che l’origine del dominio sia il campo dominio/sito web che corrisponderà ai record dell’account Demandbase rispetto agli account Experience Platform."
