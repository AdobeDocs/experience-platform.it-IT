...
Per utilizzare [!DNL Demandbase], selezionare la scheda di origine **[!UICONTROL Demandbase Intent]** in [!UICONTROL Data & Identity Partners], quindi selezionare **[!UICONTROL Add data]**.
...
Per creare un nuovo account, selezionare **[!UICONTROL New account]**, quindi fornire un nome account e, facoltativamente, una descrizione per i dettagli dell&#39;account. Quindi, fornisci i valori di autenticazione appropriati per autenticare l’origine su Experience Platform. Per connettere l&#39;account [!DNL Demandbase Intent], è necessario disporre delle credenziali seguenti:
