...
title: Creare un flusso di dati utilizzando un’origine di successo del cliente nell’interfaccia utente
topic-legacy: overview
type: Tutorial
description: Un flusso di dati è un’attività pianificata che recupera e acquisisce dati da un’origine a un set di dati della Platform. Questa esercitazione fornisce passaggi su come creare un flusso di dati per una sorgente di successo cliente tramite l’interfaccia utente di Platform.
...
Un flusso di dati è un’attività pianificata che recupera e acquisisce dati da un’origine a un set di dati in Adobe Experience Platform. Questa esercitazione fornisce passaggi su come creare un flusso di dati per un’origine di successo del cliente utilizzando l’interfaccia utente di Platform.

>[!NOTE]
>
>Per creare un flusso di dati, è necessario disporre già di un account autenticato con un&#39;origine di successo cliente. Un elenco di esercitazioni per la creazione di diversi account sorgente di successo del cliente nell’interfaccia utente è disponibile nella sezione [panoramica di origini](../../../home.md#customer-success).
...
Dopo aver creato l&#39;account di origine del successo del cliente, la **[!UICONTROL Aggiungi dati]** viene visualizzato un passaggio che fornisce un’interfaccia per esplorare la gerarchia di tabella dell’account di origine del successo cliente.
...
Seguendo questa esercitazione, hai creato correttamente un flusso di dati per trasferire i dati dall’origine di successo del cliente a Platform. I dati in arrivo possono ora essere utilizzati da downstream [!DNL Platform] servizi quali [!DNL Real-Time Customer Profile] e [!DNL Data Science Workspace]. Per ulteriori informazioni, consulta i seguenti documenti:
