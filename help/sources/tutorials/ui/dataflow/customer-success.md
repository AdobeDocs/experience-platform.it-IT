...
Un flusso di dati è un&#39;attività pianificata che recupera e trasferisce dati da un&#39;origine a un [!DNL Platform] set di dati. Questa esercitazione fornisce i passaggi per configurare un nuovo flusso di dati utilizzando l&#39;account di successo del cliente.
...
Dopo aver creato il connettore di successo del cliente, viene visualizzato il *[!UICONTROL Select data]* passaggio che fornisce un&#39;interfaccia interattiva per esplorare la gerarchia dei file.
...
Seguendo questa esercitazione, hai creato con successo un flusso di dati per acquisire i dati da un&#39;origine di successo cliente e hai acquisito informazioni approfondite sul monitoraggio dei set di dati. I dati in entrata possono ora essere utilizzati dai [!DNL Platform] servizi a valle come [!DNL Real-time Customer Profile] e [!DNL Data Science Workspace]. Per ulteriori informazioni, consulta i documenti seguenti:
...
Nella *[!UICONTROL authenticaton]* schermata, selezionate il nome dell&#39;account associato al flusso di dati da disattivare.
