...
# Configurare un flusso di dati per un connettore di successo cliente nell&#39;interfaccia utente

Un flusso di dati è un&#39;attività pianificata che recupera e trasferisce dati da un&#39;origine a un set di dati della piattaforma. Questa esercitazione fornisce i passaggi per configurare un nuovo flusso di dati utilizzando l&#39;account di successo del cliente.
...
Inoltre, questa esercitazione richiede che sia già stato creato un account di successo cliente. Un elenco di esercitazioni per la creazione di diversi connettori di successo cliente nell’interfaccia utente è disponibile nella panoramica [dei connettori](../../../home.md)sorgente.

## Seleziona dati

Dopo aver creato il connettore di successo del cliente, viene visualizzato il passaggio *Seleziona dati* , che fornisce un&#39;interfaccia interattiva per esplorare la gerarchia dei file.
...
Durante questo processo, potete anche abilitare l&#39;assimilazione *parziale* e la diagnostica ** degli errori. L&#39;abilitazione dell&#39;inserimento ** parziale consente di assimilare i dati contenenti errori, fino a un determinato limite che è possibile impostare. Se si abilita la diagnostica *degli* errori, verranno forniti dettagli su eventuali dati non corretti che vengono inseriti in batch separatamente. Per ulteriori informazioni, consultate la panoramica sull’assimilazione [parziale dei](../../../../ingestion/batch-ingestion/partial.md)batch.
...
![programmazione](../../../images/tutorials/dataflow/customer-success/scheduling.png)
...
Nell&#39;area di lavoro *Origini* , seleziona l&#39;origine di successo cliente che desideri visualizzare nella categoria Successo ** cliente. Selezionate Origine ** Connect per avviare l&#39;interfaccia di autenticazione. Per visualizzare un flusso di dati esistente, selezionare Account ** esistente e selezionare l&#39;account a cui si desidera accedere.
...
Seguendo questa esercitazione, hai creato con successo un flusso di dati per acquisire i dati da un&#39;origine di successo cliente e hai acquisito informazioni approfondite sul monitoraggio dei set di dati. I dati in entrata possono ora essere utilizzati dai servizi della piattaforma a valle, come Profilo cliente in tempo reale e Data Science Workspace. Per ulteriori informazioni, consulta i documenti seguenti:
...
Nella schermata di *autenticazione* , selezionare il nome dell&#39;account associato al flusso di dati che si desidera disattivare.
