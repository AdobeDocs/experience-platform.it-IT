---
keywords: ' Experience Platform;home;argomenti comuni;configurare il flusso di dati;connettore per il successo del cliente'
solution: Experience Platform
title: Configurare un flusso di dati per una connessione di origine con successo cliente nell'interfaccia utente
topic: overview
type: Tutorial
description: Un flusso di dati è un'attività pianificata che recupera e trasferisce dati da un'origine a un dataset [!DNL Platform] . Questa esercitazione fornisce i passaggi per configurare un nuovo flusso di dati utilizzando l'account di successo del cliente.
...
# Configurare un flusso di dati per una connessione con successo cliente nell&#39;interfaccia utente

Un flusso di dati è un&#39;attività pianificata che recupera e trasferisce dati da un&#39;origine a un set di dati [!DNL Platform]. Questa esercitazione fornisce i passaggi per configurare un nuovo flusso di dati utilizzando l&#39;account di successo del cliente.
...
Inoltre, questa esercitazione richiede che sia già stato creato un account di successo cliente. Un elenco di esercitazioni per la creazione di diversi connettori di successo cliente nell&#39;interfaccia utente è disponibile nella [panoramica dei connettori sorgente](../../../home.md).

## Seleziona dati

Dopo aver creato il connettore di successo del cliente, viene visualizzato il passaggio **[!UICONTROL Select data]**, che fornisce un&#39;interfaccia interattiva per esplorare la gerarchia dei file.
...
Nella schermata **[!UICONTROL Authentication]**, selezionate il nome dell&#39;account associato al flusso di dati da disattivare.
