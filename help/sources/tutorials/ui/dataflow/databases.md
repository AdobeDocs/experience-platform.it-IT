...
Dopo aver creato l&#39;account di database, viene visualizzato il passaggio **[!UICONTROL Select data]** che fornisce un&#39;interfaccia interattiva per esplorare la gerarchia del database.
...
Per acquisire dati in un set di dati esistente, seleziona **[!UICONTROL Existing dataset]**, quindi fai clic sull’icona del set di dati.
...
Nell’area di lavoro **[!UICONTROL Sources]**, seleziona la scheda **[!UICONTROL Dataflows]** . Quindi, seleziona il flusso di dati da disattivare.

![](../../../images/tutorials/dataflow/databases/list-of-dataflows.png)

La colonna **[!UICONTROL Properties]** viene visualizzata sul lato destro dello schermo, incluso un pulsante di attivazione/disattivazione **[!UICONTROL Enabled]**. Seleziona l’interruttore per disattivare il flusso di dati. La stessa opzione può essere utilizzata per riattivare un flusso di dati dopo che è stato disabilitato.
