...
Inoltre, questa esercitazione richiede che tu abbia già creato un account di pagamento. Un elenco di esercitazioni per la creazione di diversi connettori di pagamento nell’interfaccia utente è disponibile nella sezione [panoramica dei connettori sorgente](../../../home.md).

## Seleziona dati

Dopo aver creato il tuo account di pagamento, **[!UICONTROL Seleziona dati]** viene visualizzato un passaggio che fornisce un’interfaccia interattiva per l’esplorazione della gerarchia dei file.
