...
Inoltre, questa esercitazione richiede che sia già stato creato un conto pagamenti. Un elenco di esercitazioni per la creazione di diversi connettori di pagamento nell&#39;interfaccia utente è disponibile nella panoramica [dei connettori](../../../home.md)sorgente.

## Seleziona dati

Dopo aver creato il conto pagamenti, viene visualizzato il *[!UICONTROL Select data]* passaggio, che fornisce un&#39;interfaccia interattiva per esplorare la gerarchia dei file.
...
![programmazione](../../../images/tutorials/dataflow/payments/scheduling.png)
