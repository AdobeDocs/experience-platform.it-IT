...
Seguendo questa esercitazione, hai creato un flusso di dati per portare i dati dall’origine dei pagamenti a Platform. I dati in arrivo possono ora essere utilizzati da servizi [!DNL Platform] downstream come [!DNL Real-Time Customer Profile] e [!DNL Data Science Workspace]. Per ulteriori informazioni, consulta i seguenti documenti:
