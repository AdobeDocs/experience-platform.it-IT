...
Viene visualizzato il passaggio *Mapping* , che fornisce un&#39;interfaccia interattiva per mappare i dati di origine a un set di dati della piattaforma. I file sorgente formattati in JSON o Parquet devono essere conformi a XDM e non devono essere configurati manualmente. I file CSV, al contrario, richiedono la configurazione esplicita della mappatura, ma consentono di scegliere quali campi di dati di origine mappare.
...
Nell&#39;area di lavoro *Origini* , fate clic sulla scheda **Sfoglia** . Quindi, fare clic sul nome dell&#39;account associato al flusso di dati attivo che si desidera disattivare.
