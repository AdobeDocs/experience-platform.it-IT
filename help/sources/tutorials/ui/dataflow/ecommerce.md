...
# Creare un flusso di dati utilizzando un’origine di e-commerce nell’interfaccia utente

Un flusso di dati è un’attività pianificata che recupera e acquisisce dati da un’origine a un set di dati in Adobe Experience Platform. Questa esercitazione fornisce passaggi su come creare un flusso di dati per un’origine e-commerce utilizzando l’interfaccia utente di Platform.

>[!NOTE]
>
>Per creare un flusso di dati, è necessario disporre già di un account autenticato con un&#39;origine di e-commerce. Un elenco di esercitazioni per la creazione di diversi account sorgente di e-commerce nell’interfaccia utente è disponibile nella sezione [panoramica di origini](../../../home.md#ecommerce).
...
Dopo aver creato il tuo account di origine di e-commerce, la **[!UICONTROL Aggiungi dati]** viene visualizzato un passaggio che fornisce un&#39;interfaccia per esplorare la gerarchia di tabelle dell&#39;account di origine di e-commerce.
