...
title: Creare un flusso di dati utilizzando un E-Commerce Source nell’interfaccia utente
type: Tutorial
description: Un flusso di dati è un’attività pianificata che recupera e acquisisce dati da un’origine a un set di dati di Experience Platform. Questo tutorial illustra come creare un flusso di dati per un’origine e-commerce utilizzando l’interfaccia utente di Experience Platform.
...
# Creare un flusso di dati utilizzando un’origine e-commerce nell’interfaccia utente

Un flusso di dati è un’attività pianificata che recupera e acquisisce dati da un’origine a un set di dati in Adobe Experience Platform. Questo tutorial illustra come creare un flusso di dati per un’origine e-commerce utilizzando l’interfaccia utente di Experience Platform.

>[!NOTE]
>
>* Per creare un flusso di dati, è necessario disporre già di un account autenticato con un’origine e-commerce. Un elenco di esercitazioni per la creazione di diversi account di origine di e-commerce nell&#39;interfaccia utente è disponibile nella [panoramica origini](../../../home.md#ecommerce).
...
Dopo aver creato l&#39;account di origine di e-commerce, viene visualizzato il passaggio **[!UICONTROL Aggiungi dati]**, che fornisce un&#39;interfaccia per esplorare la gerarchia delle tabelle dell&#39;account di origine di e-commerce.
...
Seguendo questa esercitazione, hai creato correttamente un flusso di dati per portare i dati dall’origine di e-commerce ad Experience Platform. I dati in arrivo possono ora essere utilizzati da servizi [!DNL Experience Platform] downstream come [!DNL Real-Time Customer Profile] e [!DNL Data Science Workspace]. Per ulteriori informazioni, consulta i seguenti documenti:
