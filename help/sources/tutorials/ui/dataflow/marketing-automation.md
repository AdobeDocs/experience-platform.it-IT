---
keywords: ' Experience Platform;home;argomenti popolari;marketing, connettore di automazione'
solution: Experience Platform
title: Configurare un flusso di dati per una connessione di origine di Marketing Automation nell'interfaccia utente
topic: overview
type: Tutorial
description: Un flusso di dati è un'attività pianificata che recupera e trasferisce dati da un'origine a un dataset [!DNL Platform] . Questa esercitazione fornisce i passaggi per configurare un nuovo flusso di dati utilizzando l'account di automazione marketing.
...
Un flusso di dati è un&#39;attività pianificata che recupera e trasferisce dati da un&#39;origine a un set di dati [!DNL Platform]. Questa esercitazione fornisce i passaggi per configurare un nuovo flusso di dati utilizzando l&#39;account di automazione marketing.
...
Inoltre, questa esercitazione richiede che sia già stato creato un account di automazione marketing. Un elenco di esercitazioni per la creazione di diversi connettori di automazione marketing nell&#39;interfaccia utente è disponibile nella [panoramica dei connettori sorgente](../../../home.md).
...
Nella schermata **[!UICONTROL authentication]**, selezionare il nome della connessione associata al flusso di dati che si desidera disattivare.
