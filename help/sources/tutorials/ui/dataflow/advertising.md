...
Inoltre, questa esercitazione richiede che tu abbia già creato un account pubblicitario. Un elenco di esercitazioni per la creazione di diversi connettori di pagamento nell’interfaccia utente è disponibile nella sezione [panoramica dei connettori sorgente](../../../home.md).

## Seleziona dati

Dopo aver creato il tuo account pubblicitario, **[!UICONTROL Seleziona dati]** viene visualizzato un passaggio che fornisce un’interfaccia interattiva per l’esplorazione della gerarchia dei file.
...
La **[!UICONTROL Seleziona schema]** viene visualizzata la finestra di dialogo . Seleziona lo schema da applicare al nuovo set di dati, quindi fai clic su **[!DNL Done]**.
