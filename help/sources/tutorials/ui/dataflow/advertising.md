...
title: Configurare un flusso di dati per una connessione a un’origine pubblicitaria nell’interfaccia utente
topic-legacy: overview
type: Tutorial
description: Un flusso di dati è un’attività pianificata che recupera e acquisisce dati da un’origine a un set di dati Adobe Experience Platform. Questa esercitazione fornisce i passaggi per configurare un nuovo flusso di dati utilizzando il tuo account pubblicitario.
...
Un flusso di dati è un’attività pianificata che recupera e acquisisce dati da un’origine a un set di dati Adobe Experience Platform. Questa esercitazione fornisce i passaggi per configurare un nuovo flusso di dati utilizzando il tuo account pubblicitario.
...
Inoltre, questa esercitazione richiede che tu abbia già creato un account pubblicitario. Un elenco di esercitazioni per la creazione di diversi connettori di pagamento nell&#39;interfaccia utente è disponibile nella [panoramica dei connettori sorgente](../../../home.md).

## Seleziona dati

Dopo aver creato l&#39;account pubblicitario, viene visualizzato il passaggio **[!UICONTROL Seleziona dati]** , che fornisce un&#39;interfaccia interattiva per esplorare la gerarchia dei file.
...
Viene visualizzata la finestra di dialogo **[!UICONTROL Seleziona schema]**. Seleziona lo schema da applicare al nuovo set di dati, quindi fai clic su **[!DNL Done]**.
...
![revisione](../../../images/tutorials/dataflow/advertising/review.png)
...
Nella schermata **[!UICONTROL Dataflows]** , seleziona il nome del flusso di dati da disattivare.
