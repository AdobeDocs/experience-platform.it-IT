...
| `auth.params.` | Contiene le credenziali necessarie per autenticare l&#39;origine. L’host principale e il token di accesso per la connessione all’API. |
| `auth.params.host` | L&#39;ambiente da cui [!DNL OneTrust Integration] i dati devono essere estratti da . |
