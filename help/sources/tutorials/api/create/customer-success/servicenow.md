...
Questa esercitazione utilizza l&#39;API del servizio di flusso per seguire i passaggi necessari per connettersi  Experience Platform a un server ServiceNow.
...
Per creare una connessione ServiceNow, è necessario che all&#39;interno di Flow Service sia presente un set di specifiche di connessione ServiceNow. Il primo passo per la connessione di Platform a ServiceNow è recuperare queste specifiche.
