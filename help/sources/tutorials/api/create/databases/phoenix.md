...
title: Creare una connessione di origine Phoenix utilizzando l'API del servizio di flusso
topic: overview
type: Tutorial
description: Scoprite come collegare un database Phoenix ad Adobe Experience Platform utilizzando l'API del servizio di flusso.
...
# Creare una connessione di origine [!DNL Phoenix] utilizzando l&#39;API [!DNL Flow Service]
