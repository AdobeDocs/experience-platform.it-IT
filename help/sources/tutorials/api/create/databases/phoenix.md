...
Seguendo questa esercitazione, hai creato un [!DNL Phoenix] connessione di base utilizzando [!DNL Flow Service] API. Puoi usare questo ID di connessione di base nelle seguenti esercitazioni:
