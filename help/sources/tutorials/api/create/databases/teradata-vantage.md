...
title: Creare una connessione Teradata Vantage Base utilizzando l’API del servizio Flow
...
Per creare un ID di connessione di base, eseguire una richiesta POST all&#39;endpoint `/connections` fornendo le credenziali di autenticazione [!DNL Teradata Vantage] come parte del corpo della richiesta.
