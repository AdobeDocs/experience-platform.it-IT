...
topic: overview
type: Tutorial
description: Questa esercitazione utilizza l'API del servizio di flusso per seguire i passaggi necessari per connettere Azure Synapse Analytics (in seguito denominata "Synapse") a  Experience Platform.
...
Questa esercitazione utilizza l’API del servizio di flusso per guidarvi nei passaggi da effettuare per la connessione [!DNL Azure Synapse Analytics] (in seguito denominata &quot;[!DNL Synapse]&quot;) a [!DNL Experience Platform].
