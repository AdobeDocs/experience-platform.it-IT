...
Questa esercitazione descrive i passaggi necessari per creare una connessione di base per [!DNL Apache Spark] su [!DNL Azure HDInsights] (in seguito denominata &quot;[!DNL Spark]&quot;) utilizzando l&#39;API [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
