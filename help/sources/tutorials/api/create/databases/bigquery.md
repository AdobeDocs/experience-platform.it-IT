...
Questa esercitazione utilizza l’API del servizio di flusso per seguire i passaggi necessari per connettere Experience Platform a Google BigQuery (di seguito &quot;BigQuery&quot;).
...
Per creare una connessione BigQuery, all&#39;interno del servizio di flusso deve essere presente un set di specifiche di connessione BigQuery. Il primo passo per connettere Platform a BigQuery è recuperare queste specifiche.
