...
title: Creare una connessione di origine Oracle  utilizzando l'API del servizio di flusso
topic: overview
type: Tutorial
description: Scoprite come collegare  Oracle a  Experience Platform utilizzando l'API del servizio di flusso.
...
# Creare una connessione di origine [!DNL Oracle] utilizzando l&#39;API [!DNL Flow Service]
