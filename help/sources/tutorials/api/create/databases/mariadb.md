...
title: Creare una connessione di origine MariaDB utilizzando l'API del servizio di flusso
topic: overview
type: Tutorial
description: Scoprite come collegare Adobe Experience Platform a MariaDB utilizzando l'API del servizio di flusso.
...
# Creare una connessione di origine [!DNL MariaDB] utilizzando l&#39;API [!DNL Flow Service]
