...
title: Creare una connessione di origine Apache Cassandra utilizzando l'API del servizio di flusso
topic: overview
type: Tutorial
description: Scoprite come collegare Apache Cassandra ad Adobe Experience Platform utilizzando l'API del servizio di flusso.
