...
# Creare un connettore [!DNL Microsoft] SQL Server utilizzando l&#39; [!DNL Flow Service] API
...
Questa esercitazione utilizza l&#39; [!DNL Flow Service] API per seguire i passaggi necessari per connettersi [!DNL Experience Platform] a un [!DNL Microsoft] SQL Server (di seguito &quot;SQL Server&quot;).
...
Le sezioni seguenti forniscono informazioni aggiuntive che sarà necessario conoscere per collegarsi correttamente a SQL Server utilizzando l&#39; [!DNL Flow Service] API.
...
Per ulteriori informazioni su come ottenere una stringa di connessione, consultare [questo documento](https://docs.microsoft.com/en-us/dotnet/framework/data/adonet/sql/authentication-in-sql-server)di SQL Server.
...
Seguendo questa esercitazione, avete creato una connessione SQL Server utilizzando l&#39; [!DNL Flow Service] API e ottenuto il valore ID univoco della connessione. L&#39;ID connessione può essere utilizzato nell&#39;esercitazione successiva quando si apprende come [esplorare i database o i sistemi NoSQL utilizzando l&#39;API](../../explore/database-nosql.md)del servizio di flusso.
