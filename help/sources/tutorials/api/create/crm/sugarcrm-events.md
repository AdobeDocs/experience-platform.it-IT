...
## Connetti [!DNL SugarCRM Events] ad Experience Platform utilizzando l&#39;API [!DNL Flow Service]

Di seguito vengono descritti i passaggi necessari per autenticare l&#39;origine [!DNL SugarCRM], creare una connessione di origine e creare un flusso di dati per portare i dati degli eventi in Experience Platform.
...
Per creare un ID di connessione di base, eseguire una richiesta POST all&#39;endpoint `/connections` fornendo le credenziali di autenticazione [!DNL SugarCRM Events] come parte del corpo della richiesta.
...
L&#39;ultimo passaggio per portare dati da [!DNL SugarCRM Events] ad Experience Platform consiste nella creazione di un flusso di dati. A questo punto sono stati preparati i seguenti valori obbligatori:
