...
## Connetti [!DNL SugarCRM Accounts & Contacts] ad Experience Platform utilizzando l&#39;API [!DNL Flow Service]

Di seguito vengono descritti i passaggi necessari per autenticare l&#39;origine [!DNL SugarCRM], creare una connessione di origine e creare un flusso di dati per portare i dati degli account e dei contatti in Experience Platform.
...
Per creare un ID di connessione di base, eseguire una richiesta POST all&#39;endpoint `/connections` fornendo le credenziali di autenticazione [!DNL SugarCRM Accounts & Contacts] come parte del corpo della richiesta.
...
L&#39;ultimo passaggio per portare dati da [!DNL SugarCRM Accounts & Contacts] ad Experience Platform consiste nella creazione di un flusso di dati. A questo punto sono stati preparati i seguenti valori obbligatori:
