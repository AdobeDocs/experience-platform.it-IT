...
Per creare un ID connessione di base, eseguire una richiesta POST all&#39;endpoint `/connections` fornendo le credenziali di autenticazione [!DNL Shopify] come parte dei parametri della richiesta.
...
* [Crea un flusso di dati per portare dati E-Commerce in Experience Platform utilizzando l&#39;API  [!DNL Flow Service] &#x200B;](../../collect/ecommerce.md)
