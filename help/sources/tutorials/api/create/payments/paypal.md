---
keywords: Experience Platform;home;argomenti popolari;connettore PayPal;paypal;Paypal;;home;popular topic;PayPal connector;paypal;Paypal
...
Per creare un ID connessione di base, eseguire una richiesta POST all&#39;endpoint `/connections` fornendo le credenziali di autenticazione [!DNL PayPal] come parte dei parametri della richiesta.
...
* [Crea un flusso di dati per portare i dati dei pagamenti ad Experience Platform utilizzando l&#39;API  [!DNL Flow Service] ](../../collect/payments.md)
