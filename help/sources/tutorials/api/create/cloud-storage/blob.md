...
Questo tutorial descrive i passaggi necessari per creare una connessione di base per [!DNL Azure Blob] (in seguito denominati &quot;[!DNL Blob]&quot;) utilizzando [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
...
Per creare un [!DNL Blob] tramite l&#39;URI della firma di accesso condiviso, effettuare una richiesta POST al [!DNL Flow Service] fornendo al tempo stesso valori per il tuo [!DNL Blob] `sasUri`.
