...
Questa esercitazione utilizza l&#39;API [!DNL Flow Service] per guidarvi attraverso i passaggi necessari per collegarvi [!DNL Experience Platform] a uno storage [!DNL Azure Blob] (in seguito denominato &quot;Blob&quot;).

Se si preferisce utilizzare l&#39;interfaccia utente in [!DNL Experience Platform], l&#39;esercitazione sull&#39;interfaccia utente del connettore di origine BLOB di [Azure fornisce istruzioni dettagliate per eseguire azioni simili.](../../../ui/create/cloud-storage/blob.md)
...
Le sezioni seguenti forniscono informazioni aggiuntive che sarà necessario conoscere per collegarsi correttamente a un archivio Blob utilizzando l&#39;API [!DNL Flow Service].

### Raccogli credenziali richieste

Affinché [!DNL Flow Service] possa connettersi all&#39;archivio Blob, è necessario fornire i valori per la seguente proprietà di connessione:
...
Per ulteriori informazioni su come ottenere una stringa di connessione, fare riferimento a [questo documento BLOB di Azure](https://docs.microsoft.com/en-us/azure/storage/common/storage-configure-connection-string).
...
Seguendo questa esercitazione, hai creato una connessione Blob utilizzando le API e un ID univoco è stato ottenuto come parte del corpo della risposta. Puoi utilizzare questo ID connessione per [esplorare gli archivi cloud utilizzando l&#39;API del servizio di flusso](../../explore/cloud-storage.md) o [assimilare i dati del parquet tramite l&#39;API del servizio di flusso](../../cloud-storage-parquet.md).