...
# Creare un connettore FTP utilizzando l&#39; [!DNL Flow Service] API

>[!NOTE]
>
>Il connettore FTP è in versione beta. Le funzioni e la documentazione sono soggette a modifiche. Per ulteriori informazioni sull&#39;utilizzo dei connettori con etichetta beta, consulta la panoramica [](../../../../home.md#terms-and-conditions) Origini.

Questa esercitazione utilizza l&#39; [!DNL Flow Service] API per guidarvi nei passaggi necessari per la connessione [!DNL Experience Platform] a un server FTP (File Transfer Protocol).
...
Le sezioni seguenti forniscono informazioni aggiuntive che sarà necessario conoscere per collegarsi correttamente a un server FTP utilizzando l&#39; [!DNL Flow Service] API.

### Raccogli credenziali richieste

Per poter [!DNL Flow Service] connettersi all&#39;FTP, è necessario fornire valori per le seguenti proprietà di connessione:
...
Per creare una connessione FTP utilizzando l&#39;autenticazione di base, effettua una richiesta di POST all&#39; [!DNL Flow Service] API fornendo al contempo i valori per la connessione `host`, `userName`e `password`.
