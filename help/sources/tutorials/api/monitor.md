...
Per visualizzare lo stato del flusso di dati, effettua una richiesta GET all&#39;API [!DNL Flow Service] e fornisci l&#39;ID flusso corrispondente del flusso di dati.
