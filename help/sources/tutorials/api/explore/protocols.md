...
title: Esplora un sistema di protocollo utilizzando l'API del servizio di flusso
topic: overview
description: Questa esercitazione utilizza l’API del servizio di flusso per esplorare le applicazioni dei protocolli.
...
Questa esercitazione utilizza l&#39;API [!DNL Flow Service] per esplorare le applicazioni di protocolli.
...
Per esplorare il sistema di protocollo utilizzando le API [!DNL Platform], è necessario possedere un ID di connessione di base valido. Se non si dispone già di una connessione di base per il sistema di protocollo con cui si desidera lavorare, è possibile crearne una tramite la seguente esercitazione:
...
Utilizzando l&#39;ID connessione per l&#39;applicazione protocolli, è possibile esplorare le tabelle di dati eseguendo le richieste di GET. Utilizzate la seguente chiamata per trovare il percorso della tabella che desiderate ispezionare o assimilare in [!DNL Platform].
...
Una risposta corretta restituisce un array di tabelle dall&#39;applicazione protocolli. Trovare la tabella che si desidera inserire in [!DNL Platform] e prendere nota della relativa proprietà `path`, in quanto è necessario fornirla nel passaggio successivo per ispezionare la struttura.
...
Seguendo questa esercitazione, hai esplorato l&#39;applicazione protocolli, trovato il percorso della tabella che desideri inserire in [!DNL Platform], e ottenuto informazioni sulla sua struttura. Potete utilizzare queste informazioni nell&#39;esercitazione successiva per [raccogliere i dati dall&#39;applicazione protocolli e portarli nella piattaforma](../collect/protocols.md).
