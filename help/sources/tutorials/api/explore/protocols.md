...
Una risposta corretta restituisce un array di tabelle dall&#39;applicazione protocolli. Trovare la tabella che si desidera inserire [!DNL Platform] e prendere nota della relativa `path` proprietà, in quanto è necessario fornire nel passaggio successivo per ispezionare la sua struttura.
