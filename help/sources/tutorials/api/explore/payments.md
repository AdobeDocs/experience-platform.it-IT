...
# Esplorare un sistema di pagamento utilizzando l&#39;API [!DNL Flow Service]
...
Utilizzando l&#39;ID di connessione per il sistema di pagamenti, è possibile esplorare le tabelle di dati eseguendo le richieste di GET. Utilizza la seguente chiamata per trovare il percorso della tabella che desideri controllare o acquisire in [!DNL Platform].
...
Una risposta corretta restituisce un array di tabelle dal sistema di pagamenti. Trova la tabella da inserire in [!DNL Platform] e prendi nota della relativa proprietà `path`, in quanto devi fornirla nel passaggio successivo per ispezionarne la struttura.
