...
Questa esercitazione descrive i passaggi per recuperare i dati da un sistema di successo cliente di terze parti e acquisirli in [!DNL Platform] tramite i connettori sorgente e l’ [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
