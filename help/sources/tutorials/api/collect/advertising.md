...
Questa esercitazione descrive i passaggi per recuperare i dati da un’applicazione pubblicitaria di terze parti e acquisirli in Adobe Experience Platform tramite i connettori sorgente e il [[!DNL Flow Service]](https://www.adobe.io/experience-platform-apis/references/flow-service/) API.
...
Seguendo questa esercitazione, hai creato un connettore di origine per raccogliere dati da un sistema pubblicitario su base pianificata. I dati in arrivo possono ora essere utilizzati dai servizi della piattaforma a valle, come [!DNL Real-time Customer Profile] e [!DNL Data Science Workspace]. Per ulteriori informazioni, consulta i seguenti documenti:
