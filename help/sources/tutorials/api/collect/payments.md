...
# Creare un flusso di dati per le origini pagamenti utilizzando l&#39;API [!DNL Flow Service]

Questo tutorial illustra i passaggi necessari per recuperare i dati da un&#39;origine di pagamenti e portarli a Platform utilizzando [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).

>[!NOTE]
>
>* Per creare un flusso di dati, è necessario disporre già di un ID connessione di base valido con un’origine pagamenti. Se non disponi di questo ID, consulta la [panoramica origini](../../../home.md#payments) per un elenco delle origini pagamenti con cui puoi creare una connessione di base.
...
Seguendo questa esercitazione, hai creato un connettore di origine per raccogliere i dati da un&#39;applicazione di pagamenti su base pianificata. I dati in arrivo possono ora essere utilizzati dai servizi Platform a valle come [!DNL Real-Time Customer Profile] e [!DNL Data Science Workspace]. Per ulteriori informazioni, consulta i seguenti documenti:
