...
>[!NOTE]
>
>Per creare un flusso di dati, è necessario disporre già di un ID di connessione di base valido con un&#39;origine del database. Se non disponi di questo ID, consulta la sezione [panoramica di origini](../../../home.md#database) per un elenco delle origini di database con cui è possibile creare una connessione di base.
