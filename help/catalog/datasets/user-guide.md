...
Se un set di dati è abilitato per [!DNL Profile], l’eliminazione di tale set di dati tramite l’interfaccia utente lo eliminerà sia dal Data Lake che dall’archivio profili all’interno di Platform.
