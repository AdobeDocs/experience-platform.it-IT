...
Adobe Experience Platform Tags ora supporta **[!UICONTROL Usage Authorizations]**, una potente funzionalità che consente di condividere in modo sicuro pacchetti di estensione privati con partner attendibili senza renderli disponibili al pubblico nel catalogo delle estensioni. Questa funzione crea un ponte sicuro tra le organizzazioni, consentendoti di sfruttare il codice di estensione personalizzato dell’altra organizzazione mantenendo al contempo la privacy e il controllo sulle soluzioni proprietarie.
...
I pacchetti di estensione pubblici e privati possono essere condivisi tramite [!UICONTROL Usage Authorizations], anche se le estensioni nella disponibilità Sviluppo non possono avere autorizzazioni associate.
...
Per condividere un&#39;estensione, passa all&#39;interfaccia utente di Data Collection e seleziona **[!UICONTROL Tags]** dal menu di navigazione a sinistra. Da qui, seleziona una proprietà esistente o creane una nuova.

Dopo aver selezionato o creato la proprietà desiderata, selezionare **[!UICONTROL Extensions]** nel menu di navigazione a sinistra, quindi selezionare la scheda **[!UICONTROL Usage Authorizations]**.
...
Seleziona **[!UICONTROL Extension]** da condividere dalle estensioni disponibili nel menu a discesa. L’elenco mostra le estensioni di proprietà dell’organizzazione e il loro stato di disponibilità. Le estensioni la cui versione più recente è disponibile in **Sviluppo** non verranno visualizzate in questo elenco.
