...
La creazione di una proprietà mobile nell’interfaccia utente Data Collection consente di:
...
Un’estensione è un pacchetto di codice (JavaScript, HTML e CSS) che estende l’interfaccia utente di Data Collection e le funzionalità client.Puoi generare, gestire e aggiornare le integrazioni tramite un&#39;interfaccia praticamente self-service. Paragonando i tag a un sistema operativo, le estensioni sono le applicazioni che consentono di eseguire determinate attività.
