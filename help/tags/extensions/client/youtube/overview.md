...
Per ulteriori informazioni su come creare e sfruttare in modo efficace gli elementi dati in Experience Platform, consulta la documentazione di [elementi dati](../../../ui/managing-resources/data-elements.md).
