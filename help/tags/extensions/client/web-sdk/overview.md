...
Per informazioni dettagliate sulla configurazione dell’estensione Platform Web SDK, consulta [Configurare l’estensione tag Web SDK](web-sdk-extension-configuration.md).
