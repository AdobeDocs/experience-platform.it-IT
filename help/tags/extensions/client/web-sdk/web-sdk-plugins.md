...
>[!IMPORTANT]
>
>L&#39;estensione deve essere utilizzata con l&#39;estensione Adobe Experience Platform Web SDK. Per informazioni sulla versione da utilizzare con AppMeasurement, consulta la panoramica sulla [Estensione Common Analytics Plugins](../plugins/overview.md).

Questo documento illustra come configurare l’estensione tag Plugin dell’SDK Web e utilizzarla per potenziare [Estensione Adobe Experience Platform Web SDK](../web-sdk/overview.md).
