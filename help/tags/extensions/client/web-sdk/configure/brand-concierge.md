...
Una casella di controllo che raccoglie le origini se un utente è passato alla pagina da un collegamento all’interno di una conversazione Brand Concierge. Deselezionato per impostazione predefinita. Se abilitata, la libreria controlla il parametro della stringa di query `adobe_brand_concierge_source` e popola il relativo valore in `xdm.channel.referringSource`.
