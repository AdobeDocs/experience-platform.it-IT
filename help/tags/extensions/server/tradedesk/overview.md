...
Puoi utilizzare l&#39;estensione [[!DNL The Trade Desk Real-Time Conversions API]](https://partner.thetradedesk.com/v3/portal/data/doc/DataConversionEventsApi) per inviare dati da Adobe Experience Platform Edge Network a [!DNL The Trade Desk] utilizzando le funzionalità dell&#39;API nelle regole di [inoltro eventi](../../../ui/event-forwarding/overview.md).

Utilizzando l&#39;estensione [!DNL The Trade Desk Real-Time Conversions API], puoi sfruttare le funzionalità API nelle regole di [inoltro eventi](../../../ui/event-forwarding/overview.md) per inviare dati a [!DNL The Trade Desk] da Adobe Experience Platform Edge Network.
...
Selezionare **[!UICONTROL Extensions]** nel menu di navigazione a sinistra. Nella scheda **[!UICONTROL Catalog]**, seleziona la scheda API Conversioni in tempo reale di **[!UICONTROL The Trade Desk]**, quindi seleziona **[!UICONTROL Install]**.
...
Nella schermata successiva, immettere [!UICONTROL Advertiser ID] e facoltativamente [!UICONTROL Merchant ID]. Puoi incollare l’ID direttamente in questi input, oppure puoi utilizzare un elemento dati. Questi verranno utilizzati come valori predefiniti durante una chiamata evento all&#39;API Conversioni in tempo reale di [!DNL The Trade Desk]. Al termine, fai clic su **[!UICONTROL Save]**.
...
![Pagina di configurazione dell&#39;estensione [!DNL The Trade Desk] con i campi [!UICONTROL Advertiser ID] e [!UICONTROL Merchant ID] evidenziati.](../../../images/extensions/server/tradedesk/configure-extension.png)
...
Crea una nuova [regola](../../../ui/managing-resources/rules.md) di inoltro eventi nella proprietà di inoltro eventi. In **[!UICONTROL Actions]**, aggiungere una nuova azione e impostare l&#39;estensione su **[!UICONTROL The Trade Desk]**. Selezionare **[!UICONTROL Real Time Conversion]** per **[!UICONTROL Action Type]**.
...
Dopo la selezione, vengono visualizzati controlli aggiuntivi per configurare ulteriormente i dati dell&#39;evento che verranno inviati a [!DNL The Trade Desk]. Selezionare **[!UICONTROL Keep Changes]** per salvare la regola.
...
>[!NOTE]
>
>I campi [!UICONTROL Configuration Overrides] ti consentono di impostare [!DNL Advertiser ID] e/o [!DNL Merchant ID] diversi per ogni regola.
...
Consulta la documentazione di [!DNL The Trade Desk] sulle [best practice per l&#39;API [!DNL The Trade Desk] Conversioni in tempo reale](https://partner.thetradedesk.com/v3/portal/data/doc/DataConversionEventsApi) per maggiori informazioni su come implementare in modo efficace l&#39;integrazione.
