...
L&#39;estensione [[!DNL Pinterest] Conversions](https://developers.pinterest.com/docs/conversions/conversion-management/) API [event forwarding](../../../ui/event-forwarding/overview.md) ti consente di sfruttare i dati acquisiti in Adobe Experience Platform Edge Network e inviarli a [!DNL Pinterest]. Questo documento descrive i casi di utilizzo dell&#39;estensione, come installarla e come integrarne le funzionalità nell&#39;inoltro degli eventi [rules](../../../ui/managing-resources/rules.md).
...
Questa estensione deve essere utilizzata se si desidera utilizzare i dati di Edge Network in [!DNL Pinterest] per sfruttare le funzionalità di analisi dei clienti.
...
Per connettere Experience Platform a [!DNL Pinterest], sono necessari i seguenti input:
...
Nel menu di navigazione a sinistra, selezionare **[!UICONTROL Extensions]**. Selezionare **[!UICONTROL Install]** sulla scheda per l&#39;estensione [!DNL Pinterest] nella scheda **[!UICONTROL Catalog]**.

![Catalogo che visualizza l&#39;estensione [!DNL Pinterest] con [!UICONTROL Install] evidenziato.](../../../images/extensions/server/pinterest/install.png)
...
Nel menu di navigazione a sinistra, selezionare **[!UICONTROL Extensions]**. Selezionare **[!UICONTROL Configure]** sulla scheda per l&#39;estensione [!DNL Pinterest] nella scheda [!UICONTROL Installed]**.

Estensione ![[!DNL Pinterest] visualizzata nella scheda [!UICONTROL Install] con [!UICONTROL Configure] evidenziato.](../../../images/extensions/server/pinterest/configure.png)

Nella schermata successiva, immettere [!UICONTROL Ads Account Id] e [!UICONTROL Conversion Access Token] raccolti in precedenza nella sezione [dettagli configurazione](#configuration-details). Al termine, selezionare **[!UICONTROL Save]**.

![Nella schermata [!DNL Pinterest] [!UICONTROL Configure] sono evidenziati i campi di input [!UICONTROL Ads Account Id] e [!UICONTROL Conversion Access Token].](../../../images/extensions/server/pinterest/input.png)
...
Crea una nuova [regola](../../../ui/managing-resources/rules.md) nella proprietà di inoltro eventi. In **[!UICONTROL Actions]**, aggiungere una nuova azione e impostare l&#39;estensione su **[!UICONTROL Pinterest]**. Per inviare eventi Edge Network a [!DNL Pinterest], impostare **[!UICONTROL Action Type]** su **[!UICONTROL Send Event].**

![Creazione della regola [!DNL Pinterest] [!UICONTROL Send Event].](../../../images/extensions/server/pinterest/rule.png)
...
![L&#39;elemento [!DNL Pinterest] [!UICONTROL Event Data] evidenziato nell&#39;azione della regola.](../../../images/extensions/server/pinterest/event-data.png)
...
| [!UICONTROL Client User Agent] | Stringa dell’agente utente del browser web dell’utente. | Mozilla/5.0 (piattaforma; rv:geckoversion) Gecko/geckotrail Firefox/firefoxversion |
| [!UICONTROL Customer information data] | Oggetto JSON contenente altre informazioni sul cliente. Scegli se fornire JSON non elaborato o utilizzare un set semplificato di input chiave-valore. | { &quot;ph&quot;: &quot;122333445&quot; } |

![L&#39;elemento [!DNL Pinterest] [!UICONTROL User Data] evidenziato nell&#39;azione della regola.](../../../images/extensions/server/pinterest/user-data.png)
...
![L&#39;elemento [!DNL Pinterest] [!UICONTROL Custom Data] evidenziato nell&#39;azione della regola.](../../../images/extensions/server/pinterest/custom-data.png)
