...
| Input | Descrizione |
| --- | --- |
| [!UICONTROL Namespace] | Il nome del [!DNL Event Hubs] spazio dei nomi creato quando [configurazione dell’hub eventi](https://learn.microsoft.com/en-us/azure/event-hubs/event-hubs-create#create-an-event-hubs-namespace). |
