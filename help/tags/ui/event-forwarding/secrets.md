...
>abstract="Affinché un segreto possa essere utilizzato dall’inoltro di eventi, deve essere assegnato a un ambiente esistente. Se non hai creato ambienti per la proprietà di inoltro degli eventi, devi configurarli prima di continuare."
