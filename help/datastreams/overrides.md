...
![La schermata dell’interfaccia utente Datastreams mostra le impostazioni del servizio Adobe Target, con le sostituzioni del token di proprietà evidenziate.](assets/overrides/override-target.png)
...
![La schermata dell’interfaccia utente Datastreams mostra le impostazioni del servizio Adobe Analytics, con le sostituzioni della suite di rapporti evidenziate.](assets/overrides/override-analytics.png)
...
![La schermata dell’interfaccia utente dei flussi di dati mostra le impostazioni del servizio Adobe Experience Platform, con le sostituzioni del set di dati dell’evento evidenziate.](assets/overrides/override-aep.png)
...
![La schermata dell’interfaccia utente per i flussi di dati mostra le impostazioni del flusso di dati, con le sostituzioni del contenitore di sincronizzazione ID di terze parti evidenziate.](assets/overrides/override-container.png)
...
Quando viene inviata una sostituzione della configurazione con `configure` è incluso nei seguenti comandi Web SDK.
...
* [configura](../edge/fundamentals/configuring-the-sdk.md)
