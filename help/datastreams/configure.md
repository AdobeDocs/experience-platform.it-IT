...
>[!NOTE]
>
>Ogni configurazione del servizio contiene un pulsante di attivazione **[!UICONTROL Abilitato]** che si attiva automaticamente quando il servizio viene selezionato. Per disabilitare il servizio selezionato per lo stream di dati, seleziona di nuovo il pulsante di attivazione **[!UICONTROL Abilitato]**.
