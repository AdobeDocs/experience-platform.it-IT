...
| [!UICONTROL First Party ID Cookie] | Quando è abilitata, questa impostazione comunica alla rete Edge di fare riferimento a un cookie specificato durante la ricerca di un [ID dispositivo di prime parti](/help/collection/identity/fpid.md), anziché cercare questo valore nella mappa di identità.<br><br>Quando si abilita questa impostazione, è necessario fornire il nome del cookie che deve memorizzare l&#39;ID. |
