...
* È stato risolto un problema a causa del quale gli oggetti non destinati all’uso pubblico venivano esposti tramite la promessa risolta dal comando `configure` .
