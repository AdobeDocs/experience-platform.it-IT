...
>[!IMPORTANT]
>
>L&#39;ID dello spazio dei nomi passato nel `identityMap` fa distinzione tra maiuscole e minuscole. Assicurati di utilizzare l’ID corretto dello spazio dei nomi per evitare la raccolta di dati incompleti.
