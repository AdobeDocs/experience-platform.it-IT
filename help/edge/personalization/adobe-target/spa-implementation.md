...
Di seguito sono riportati alcuni vantaggi derivanti dall’utilizzo dell’SDK Web Adobe Experience Platform per le applicazioni a pagina singola:
...
1. Installare [Adobe Experience Platform Web SDK](../../fundamentals/installing-the-sdk.md)
...
>[!NOTE]
>
>Per utilizzare Visual Experience Composer (Compositore esperienza visivo) per la SPA, è necessario installare l&#39;estensione [](https://chrome.google.com/webstore/detail/adobe-target-vec-helper/ggjpideecfnbipkacplkhhaflkdjagak)Adobe Target VEC Helper Chrome.
