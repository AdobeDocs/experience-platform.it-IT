...
Configura le `Target Third Party ID Namespace` nel tuo [Datastream](../../fundamentals/datastreams.md), utilizzando lo spazio dei nomi ID che si desidera utilizzare come ID di terze parti mbox.
