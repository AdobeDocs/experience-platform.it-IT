...
Il primo passaggio nell’implementazione di Adobe Experience Platform [!DNL Web SDK] consiste nel copiare e incollare il seguente &quot;codice base&quot; il più possibile nel `<head>` tag del codice HTML:
