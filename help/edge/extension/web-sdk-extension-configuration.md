...
## [!UICONTROL Sovrascrittura della configurazione del Datastream]
...
1. Innanzitutto, devi definire le sostituzioni della configurazione del datastream nel [pagina di configurazione di datastream](../datastreams/configure.md).
2. Quindi devi inviare le sostituzioni alla rete Edge tramite un comando SDK per web o utilizzando l’estensione tag SDK per web.

Vedi il datastream [la configurazione sostituisce la documentazione](../datastreams/overrides.md) per istruzioni dettagliate su come ignorare le configurazioni del datastream.

Invece di passare le sostituzioni tramite un comando SDK per web, puoi configurare le sostituzioni nella schermata dell’estensione dei tag mostrata di seguito.

![Immagine che mostra le sostituzioni della configurazione del datastream nella pagina dell&#39;estensione del tag SDK per web.](../assets/extension/overview/datastream-overrides.png)
