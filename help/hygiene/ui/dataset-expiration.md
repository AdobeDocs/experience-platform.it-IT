...
Per creare una richiesta, selezionare **[!UICONTROL Create request]** dalla pagina principale nell&#39;area di lavoro.
...
![Area di lavoro [!UICONTROL Data Lifecycle] con [!UICONTROL Create request] evidenziata.](../images/ui/ttl/create-request-button.png)

Viene visualizzato il flusso di lavoro per la creazione delle richieste. Nella sezione [!UICONTROL Requested Action], seleziona **[!UICONTROL Delete Dataset]** per aggiornare i controlli per la pianificazione della scadenza dei set di dati.

![Il flusso di lavoro di creazione delle richieste con l&#39;opzione [!UICONTROL Delete dataset] evidenziata.](../images/ui/ttl/dataset-selected.png)

### Seleziona una data e un set di dati {#select-date-and-dataset}

Nella sezione **[!UICONTROL Requested Action]**, seleziona una data entro la quale desideri eliminare il set di dati. È possibile immettere la data manualmente (nel formato `mm/dd/yyyy`) o selezionare l&#39;icona del calendario (![Icona del calendario.](/help/images/icons/calendar.png)) per selezionare la data da una finestra di dialogo.
...
In **[!UICONTROL Dataset Details]**, selezionare l&#39;icona del database (![Icona del database.](/help/images/icons/database.png)) per aprire una finestra di dialogo di selezione del set di dati. Scegli un set di dati dall&#39;elenco a cui applicare la scadenza, quindi seleziona **[!UICONTROL Done]**.

![Finestra di dialogo [!UICONTROL Select dataset] con un set di dati selezionato ed evidenziato [!UICONTROL Done].](../images/ui/ttl/select-dataset.png)
...
La sezione [!UICONTROL Dataset Details] viene compilata in modo da includere l&#39;identità e lo schema primari per il set di dati selezionato. In **[!UICONTROL Request settings]** immettere un nome e una descrizione facoltativa per la richiesta, seguita da **[!UICONTROL Submit]**.

![Richiesta di scadenza del set di dati completata con il pulsante [!UICONTROL Request settings] e [!UICONTROL Submit] evidenziato.](../images/ui/ttl/submit.png)

Viene visualizzata una finestra di dialogo [!UICONTROL Confirm request]. Ti viene chiesto di confermare il nome del set di dati e la data in cui verrà eliminato. Selezionare **[!UICONTROL Submit]** per continuare.

Dopo l&#39;invio della richiesta, viene creato un ordine di lavoro che viene visualizzato nella scheda principale dell&#39;area di lavoro [!UICONTROL Data Lifecycle]. Da qui è possibile monitorare lo stato dell&#39;ordine di lavoro durante l&#39;elaborazione della richiesta.
...
Per modificare o annullare la scadenza di un set di dati, selezionare **[!UICONTROL Dataset]** nella pagina principale dell&#39;area di lavoro e selezionare la scadenza del set di dati dall&#39;elenco.
