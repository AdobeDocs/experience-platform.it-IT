...
>[!IMPORTANT]
>
>Questo endpoint rappresenta la funzionalità beta per le cancellazioni dei record. Per informazioni sulle funzionalità più recenti, utilizza [`/workorder` endpoint](./workorder.md) invece.
