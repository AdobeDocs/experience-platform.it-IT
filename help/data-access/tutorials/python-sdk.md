...
topic: tutorial
type: Tutorial
description: L'SDK Secure Python Data Access è un kit di sviluppo software che consente la lettura e la scrittura di set di dati da Adobe Experience Platform.
