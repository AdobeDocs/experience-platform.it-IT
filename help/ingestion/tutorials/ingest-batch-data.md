...
Area di lavoro dei set di dati all’interno di [!DNL Experience Platform] consente di visualizzare e gestire tutti i set di dati creati dalla tua organizzazione e di crearne di nuovi.
