...
L’area di lavoro Set di dati in [!DNL Experience Platform] consente di visualizzare e gestire tutti i set di dati creati dall’organizzazione IMS, nonché di crearne di nuovi.
