---
title: Mappare un file CSV a uno schema XDM utilizzando la funzione Recommendations (Beta) generata da IA
...
![Il [!UICONTROL Dettagli del flusso di dati] sezione completata](../../images/tutorials/map-csv-recommendations/dataflow-detail-complete.png)
...
![Il [!UICONTROL Mappatura] nell’interfaccia utente, mostra tutti i campi CSV mappati e la struttura di schema risultante](../../images/tutorials/map-csv-recommendations/schema-generated.png)
...
![Il [!UICONTROL Fine] pulsante selezionato, completamento del processo di mappatura CSV](../../images/tutorials/map-csv-recommendations/finish-mapping.png)
...
![Il [!UICONTROL Modifica] pulsante selezionato accanto alla struttura dello schema](../../images/tutorials/map-csv-recommendations/edit-schema-structure.png)
