...
The following table outlines the appropriate formatting to define different field types, including those with optional properties. [](https://json-schema.org/understanding-json-schema/reference/type.html)
