...
>abstract="Seleziona lo schema con cui vuoi stabilire una relazione. A seconda della classe dello schema, può anche avere relazioni esistenti con altre entità nel contesto B2B. Consulta la documentazione per scoprire la correlazione tra le classi dello schema B2B."
...
>title="Spazio dei nomi dell’identità di riferimento"
>abstract="Spazio dei nomi (tipo) per il campo dell&#39;identità primaria dello schema di riferimento. Per poter partecipare a una relazione, lo schema di riferimento deve avere un campo di identità primaria stabilito. Per ulteriori informazioni sulle identità nelle relazioni B2B, consulta la documentazione."
...
>abstract="Etichetta che descrive la relazione tra lo schema corrente e lo schema di riferimento (ad esempio, &#39;Account correlato&#39;). Questa etichetta viene utilizzata in Profilo e segmentazione per dare contesto ai dati provenienti da entità B2B correlate. Per ulteriori informazioni sulla creazione di relazioni tra schemi B2B, consulta la documentazione."

>[!CONTEXTUALHELP]
>id="platform_xdm_b2b_relationship_name_reference"
>title="Nome di relazione dallo schema di riferimento"
>abstract="Etichetta che descrive la relazione tra lo schema di riferimento e lo schema corrente (ad esempio, &quot;Opportunità correlate&quot;). Questa etichetta viene utilizzata in Profilo e segmentazione per dare contesto ai dati provenienti da entità B2B correlate. Per ulteriori informazioni sulla creazione di relazioni tra schemi B2B, consulta la documentazione."
