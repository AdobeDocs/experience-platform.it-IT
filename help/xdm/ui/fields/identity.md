...
Dopo aver selezionato la casella di controllo vengono visualizzati controlli aggiuntivi. Se si desidera che questo campo sia l&#39;identità primaria dello schema, selezionare la casella di controllo **[!UICONTROL Primary identity]**.
...
In **[!UICONTROL Identity namespace]**, utilizzare il menu a discesa per selezionare lo spazio dei nomi appropriato per il campo di identità. Sono elencati gli spazi dei nomi standard forniti da Adobe, insieme a tutti gli spazi dei nomi personalizzati definiti dalla tua organizzazione.
...
Se il campo è stato impostato anche come identità primaria, verrà elencato anche in **[!UICONTROL Required fields]** nella barra a sinistra. Se il campo di identità è nidificato all’interno della struttura dello schema, verranno elencati come obbligatori anche tutti i campi principali.
...
Per informazioni su come definire altri tipi di campi XDM in [, consulta la panoramica su ](./overview.md#special)definizione dei campi nell&#39;interfaccia utente[!DNL Schema Editor].
