...
>abstract="Quando uno schema è abilitato per il profilo, tutti i set di dati creati da questo schema partecipano a Real-Time Customer Profile, che unisce dati provenienti da origini diverse per creare una visualizzazione completa di ciascun cliente. Uno schema utilizzato per acquisire i dati nel profilo non può essere disabilitato. Per ulteriori informazioni, consulta la documentazione dello strumento."
