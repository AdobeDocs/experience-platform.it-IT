...
description: È possibile ricercare risorse specifiche nell'API del Registro di sistema dello schema eseguendo una richiesta di GET che include l'URI $id (URL-encoded) della risorsa nel percorso della richiesta.
