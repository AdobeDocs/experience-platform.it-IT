...
description: 'Uno schema può essere considerato come il modello per i dati da inserire nel Experience Platform . Ogni schema è composto da una classe e da zero o più mixin. In altre parole, non è necessario aggiungere un mixin per definire uno schema, ma nella maggior parte dei casi verrà utilizzato almeno un mixin. '
