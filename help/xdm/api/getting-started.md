...
Nelle guide API vengono visualizzati i riferimenti a un `TENANT_ID`. Questo ID viene utilizzato per garantire che le risorse create siano spaccate correttamente e contenute all&#39;interno dell&#39;organizzazione. Se non conosci il tuo ID, puoi accedervi eseguendo la seguente richiesta GET:
