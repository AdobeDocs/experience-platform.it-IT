...
description: 'Puoi modificare o aggiornare le risorse nel contenitore tenant utilizzando una richiesta di PATCH. Il Registro di sistema dello schema supporta tutte le operazioni standard di patch JSON, incluse le operazioni di aggiunta, rimozione e sostituzione. '
