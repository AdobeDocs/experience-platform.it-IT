...
description: Il Registro di sistema dello schema consente di sostituire un'intera risorsa tramite un'operazione PUT. L'operazione riscrive sostanzialmente la risorsa, pertanto il corpo della richiesta deve includere tutti i campi necessari per la creazione di una nuova risorsa utilizzando una richiesta di POST.
