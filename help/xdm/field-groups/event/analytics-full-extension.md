...
# [!UICONTROL Adobe Analytics ExperienceEvent Full Extension] gruppo di campi schema

[!UICONTROL Adobe Analytics ExperienceEvent Full Extension] è un gruppo di campi dello schema standard per la [[!DNL XDM ExperienceEvent] classe](../../classes/experienceevent.md), che acquisisce le metriche comuni raccolte da Adobe Analytics.
...
| Proprietà | Tipo di dati | Descrizione |
| --- | --- | --- |
| `firstWeb` | [[!UICONTROL Web Information]](../../data-types/web-information.md) | Le informazioni relative alla pagina web, al collegamento e al referente del primo evento esperienza per questo utente finale. |
...
Ogni oggetto pari utilizza il tipo di dati [[!UICONTROL Measure]](../../data-types/measure.md), fornendo un identificatore univoco e un valore quantificabile.
...
| Proprietà | Tipo di dati | Descrizione |
| --- | --- | --- |
| `search` | [[!UICONTROL Search]](../../data-types/search.md) | Acquisisce informazioni relative alla ricerca web o mobile della voce di sessione. |
| `web` | [[!UICONTROL Web Information]](../../data-types/web-information.md) | Acquisisce informazioni sui clic dei collegamenti, sui dettagli della pagina web, sulle informazioni del referente e sui dettagli del browser per la voce della sessione. |
