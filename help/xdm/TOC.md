...
* Tutorial {#tutorials}
   ...
   * [Un campo XDM nell’interfaccia utente di](tutorials/field-deprecation-ui.md)
   * [Un campo XDM nell’API è diventato obsoleto](tutorials/field-deprecation-api.md)
