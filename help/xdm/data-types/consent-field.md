...
# [!UICONTROL Tipo di dati ] campo consenso generico

[!UICONTROL Il ] campo Consent generico è un tipo di dati XDM standard che descrive la selezione di un cliente per una particolare preferenza di consenso.
