...
| timeseries.identity.graph.imsorg.graphstrength.uniqueidentities.count | Numero di identità univoche memorizzate nel grafico delle identità per la tua organizzazione per una particolare forza grafico (&quot;sconosciuta&quot;, &quot;debole&quot; o &quot;forte&quot;). | Forza del grafico (**Obbligatorio**) |
...
| `report` | Contiene informazioni contestuali sull’errore, inclusa la sandbox e l’organizzazione utilizzate nell’operazione che l’ha attivato. |
...
| `INSGHT-1003-401` | Errore di convalida sandbox | Impossibile elaborare la richiesta a causa di un errore di convalida sandbox. Assicurati che il nome della sandbox fornito nella `x-sandbox-name` l’intestazione rappresenta una sandbox valida e abilitata per la tua organizzazione prima di riprovare. |
