...
Dopo aver creato il processo di segmento una tantum o la pianificazione in corso, puoi creare un processo di esportazione del segmento per esportare i risultati in un set di dati o esportare i risultati in una destinazione. The following sections provide guidance on both of these options.
