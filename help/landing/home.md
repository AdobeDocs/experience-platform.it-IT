...
Puoi iniziare a utilizzare [!DNL Platform] in modo rapido e semplice seguendo insieme a esercitazioni dettagliate che coprono tutto, dalla preparazione dei dati per l’acquisizione agli algoritmi avanzati di machine-learning. Queste esercitazioni sono state progettate per integrare le informazioni presenti nella documentazione [!DNL Experience Platform], in modo che, per risultati ottimali, la documentazione rimanga a portata di mano durante il completamento delle esercitazioni.

Per iniziare, visita la pagina di destinazione [Esercitazioni di Experience Platform](https://www.adobe.com/go/platform-tutorials-home-en) .

## Documenti e risorse di riferimento

* [**Nozioni di base sulle API**](api-fundamentals.md)\
   Scopri le nozioni di base sull’utilizzo delle API [!DNL Platform] .

* [**Documenti di riferimento API**](https://www.adobe.com/go/platform-api-reference-en)\
   Scopri le API [!DNL Experience Platform] , tra cui intestazioni, parametri, richieste di esempio e risposte.<br/>*Questi documenti sono ospitati su Adobe I/O.*
