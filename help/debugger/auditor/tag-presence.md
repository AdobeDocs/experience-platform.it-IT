...
| --- | --- | --- | --- |
| Adobe Advertising - Presenza di codice | 5 | Il tag Adobe Advertising non è disponibile nel DOM. | Implementa il tag Adobe Advertising utilizzando l&#39;estensione tag [Adobe Advertising](../../destinations/catalog/advertising/adobe-advertising-cloud.md). |
| Adobe Advertising - Pixel di segmento implementati | 5 | Aggiorna i pixel del segmento di Adobe Advertising ai nuovi tag di sola immagine di Adobe Advertising. L’utilizzo di tag di segmento AMO obsoleti può causare la perdita di dati. | Implementa il pixel del segmento di Adobe Advertising utilizzando l&#39;estensione tag [Adobe Advertising](../../destinations/catalog/advertising/adobe-advertising-cloud.md). |
