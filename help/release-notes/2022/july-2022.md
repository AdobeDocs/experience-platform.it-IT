...
| Gruppo di campi | [[!UICONTROL Meteo attuale]](https://github.com/adobe/xdm/blob/master/components/classes/weather.schema.json) | Un gruppo di campi per [!UICONTROL XDM ExperienceEvent] e [!UICONTROL Meteo] classi, utilizzate per acquisire le condizioni meteo correnti per un codice postale. |
| Gruppo di campi | [[!UICONTROL Meteo previsto]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/forecasted-weather.schema.json) | Un gruppo di campi per [!UICONTROL XDM ExperienceEvent] e [!UICONTROL Meteo] classi, utilizzate per acquisire le condizioni meteo previste per un codice postale. |
...
| Gruppo di campi | [[!UICONTROL Dettagli dell’interazione di contenuti multimediali]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/experience-event/experienceevent-media.schema.json) | Un gruppo di campi per [!UICONTROL XDM ExperienceEvent] classe che acquisisce i dettagli di un’interazione multimediale. |
...
| Funzione | Descrizione |
| --- | --- |
| Disponibilità generale dell’origine [!DNL Azure Data Explorer] | Utilizza l’origine Data Explorer di Azure per portare i dati dal tuo [!DNL Azure] da Experience Platform. Consulta la [[!DNL Azure Data Explorer] panoramica dell’origine](../../sources/connectors/databases/data-explorer.md) per ulteriori informazioni. |
