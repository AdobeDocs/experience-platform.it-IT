...
Consulta la sezione [Panoramica di Real-Time CDP, B2B Edition](../../rtcdp/b2b-overview.md) per ulteriori informazioni sulle funzioni B2B disponibili, oppure [esercitazione end-to-end](../../rtcdp/b2b-tutorial.md) Per ulteriori informazioni sulla modalità di creazione dei profili account nell’ambito del flusso di lavoro B2B.
...
| Gruppo di campi | [[!UICONTROL Dettagli dell&#39;interazione con i contenuti multimediali]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/experience-event/experienceevent-media.schema.json) | Un gruppo di campi per [!UICONTROL ExperienceEvent XDM] classe che acquisisce i dettagli relativi a un&#39;interazione multimediale. |
| Gruppo di campi | [[!UICONTROL Dettagli dell’interazione con MediaAnalytics]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/experience-event/experienceevent-media-analytics.schema.json) | Un gruppo di campi per [!UICONTROL ExperienceEvent XDM] che acquisisce i dettagli relativi a un&#39;interazione con il reporting multimediale. |
