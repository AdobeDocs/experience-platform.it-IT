...
Adobe non investe più nel supporto di [Internet Explorer 10 (IE10)](https://docs.microsoft.com/en-us/lifecycle/announcements/internet-explorer-10-end-of-support) e [Internet Explorer 11 (IE11)](https://docs.microsoft.com/en-us/lifecycle/announcements/internet-explorer-11-end-of-support) per i tag in Adobe Experience Platform. Microsoft ha terminato il supporto per questi browser, le moderne tecnologie web sono sempre più incompatibili con essi e il settore più ampio si è allontanato da loro. Questi fattori rendono difficile e costoso mantenere la compatibilità con le versioni precedenti. Anche se Adobe non rimuove attivamente il supporto per IE10 e IE11, le nuove funzioni per i tag non vengono più testate o ottimizzate per questi browser. Questa modifica consente ad Adobe di fornire più rapidamente funzionalità moderne.
...
| --- | --- | --- |
| Classe | [[!UICONTROL Weather]](https://github.com/adobe/xdm/blob/master/components/classes/weather.schema.json) | Classe basata su record utilizzata per l&#39;acquisizione di dati meteo. |
| Gruppo di campi | [[!UICONTROL Current Weather]](https://github.com/adobe/xdm/blob/master/components/classes/weather.schema.json) | Un gruppo di campi per le classi [!UICONTROL XDM ExperienceEvent] e [!UICONTROL Weather], utilizzato per acquisire le condizioni meteo correnti per un codice postale. |
| Gruppo di campi | [[!UICONTROL Forecasted Weather]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/forecasted-weather.schema.json) | Un gruppo di campi per le classi [!UICONTROL XDM ExperienceEvent] e [!UICONTROL Weather], utilizzato per acquisire le condizioni meteo previste per un codice postale. |
| Gruppo di campi | [[!UICONTROL Product Triggers]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/product-triggers.schema.json) | Un gruppo di campi per le classi [!UICONTROL XDM ExperienceEvent] e [!UICONTROL Weather], utilizzato per acquisire trigger specifici per il prodotto che sfruttano le condizioni meteo note per determinare il comportamento del consumatore. |
| Gruppo di campi | [[!UICONTROL Relative Triggers]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/relative-triggers.schema.json) | Un gruppo di campi per le classi [!UICONTROL XDM ExperienceEvent] e [!UICONTROL Weather], utilizzato per acquisire trigger relativi che sfruttano le condizioni meteo note per determinare il comportamento del consumatore. |
| Gruppo di campi | [[!UICONTROL Severe Triggers]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/severe-triggers.schema.json) | Un gruppo di campi per le classi [!UICONTROL XDM ExperienceEvent] e [!UICONTROL Weather], utilizzato per acquisire i trigger che sfruttano le condizioni meteorologiche avverse note per determinare il comportamento del consumatore. |
| Gruppo di campi | [[!UICONTROL Weather Triggers]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/weather-triggers.schema.json) | Un gruppo di campi per le classi [!UICONTROL XDM ExperienceEvent] e [!UICONTROL Weather], utilizzato per acquisire trigger generali che sfruttano le condizioni meteo note per determinare il comportamento del consumatore. |
| Gruppo di campi | [[!UICONTROL Media Interaction Details]](https://github.com/adobe/xdm/blob/master/docs/reference/fieldgroups/experience-event/experienceevent-media.schema.json) | Un gruppo di campi per la classe [!UICONTROL XDM ExperienceEvent] che acquisisce i dettagli di un&#39;interazione multimediale. |
| Gruppo di campi | [[!UICONTROL MediaAnalytics Interaction Details]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/experience-event/experienceevent-media-analytics.schema.json) | Un gruppo di campi per la classe [!UICONTROL XDM ExperienceEvent] che acquisisce i dettagli di un&#39;interazione con i report multimediali. |
| Tipo di dati | [[!UICONTROL Advertising details information]](https://github.com/adobe/xdm/blob/master/components/datatypes/advertisingdetails.schema.json) | Acquisisce i dettagli di una risorsa pubblicitaria. |
| Tipo di dati | [[!UICONTROL Advertising Pod details information]](https://github.com/adobe/xdm/blob/master/components/datatypes/advertisingpoddetails.schema.json) | Acquisisce i dettagli di un pod pubblicitario, una sequenza di più annunci riprodotti in un’unica interruzione pubblicitaria. |
| Tipo di dati | [[!UICONTROL Chapter details information]](https://github.com/adobe/xdm/blob/master/components/datatypes/chapterdetails.schema.json) | Acquisisce dettagli su un capitolo o un segmento in un contenuto video. |
| Tipo di dati | [[!UICONTROL Error details information]](https://github.com/adobe/xdm/blob/master/components/datatypes/errordetails.schema.json) | Acquisisce i dettagli di un errore di riproduzione video. |
| Tipo di dati | [[!UICONTROL Player state data information]](https://github.com/adobe/xdm/blob/master/components/datatypes/playerstatedata.schema.json) | Acquisisce i dettagli relativi allo stato di un lettore video. |
| Tipo di dati | [[!UICONTROL Qoe Data details information]](https://github.com/adobe/xdm/blob/master/components/datatypes/qoedatadetails.schema.json) | Acquisisce dettagli sulla qualità dell’esperienza (QoE) relativi a un evento di riproduzione video. |
| Tipo di dati | [[!UICONTROL Session details information]](https://github.com/adobe/xdm/blob/master/components/datatypes/sessiondetails.schema.json) | Acquisisce i dettagli della sessione su un evento di riproduzione video. |
...
| Funzione | Descrizione |
| --- | --- |
| Disponibilità generale dell’origine [!DNL Azure Data Explorer] | Utilizza l&#39;origine Data Explorer di Azure per portare i dati dall&#39;istanza [!DNL Azure] ad Experience Platform. Per ulteriori informazioni, vedere [[!DNL Azure Data Explorer] panoramica origine](../../sources/connectors/databases/data-explorer.md). |
