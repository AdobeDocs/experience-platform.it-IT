...
| [Adobe Advertising DSP](../../destinations/catalog/advertising/adobe-advertising-dsp-connection.md) | La destinazione Adobe Advertising Cloud [!DNL Demand-Side Platform] (DSP) ti consente di condividere segmenti autenticati di prime parti con inserzionisti e utenti approvati per l’attivazione della campagna con DSP. |
...
| [Proposte di rendering](/help/collection/js/commands/applypropositions.md) nelle applicazioni a pagina singola senza incrementare le metriche. | Il comando `applyPropositions` appena aggiunto consente di eseguire il rendering o l&#39;esecuzione di un array di proposte da [!DNL Target] in applicazioni a pagina singola, senza incrementare le metriche [!DNL Analytics] e [!DNL Target]. Questo miglioramento aumenta l’accuratezza della generazione di rapporti. |
