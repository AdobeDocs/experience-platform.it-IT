...
| Funzione | Descrizione |
| --- | --- |
| Scadenza set di dati | [Scadenze programmate](../../hygiene/ui/dataset-expiration.md) per i set di dati di Platform. |
...
| Funzione | Descrizione |
| ------- | ----------- |
| Applicazione delle politiche di consenso (disponibilità limitata) | Se la tua organizzazione ha acquistato l&#39;offerta del componente aggiuntivo Healthcare Shield, ora puoi [creare criteri di consenso](../../data-governance/policies/user-guide.md#consent-policy) in automatico [applicare i consensi e le preferenze dei clienti nella partecipazione ai segmenti](../../data-governance/enforcement/auto-enforcement.md#consent-policy-evaluation). |
