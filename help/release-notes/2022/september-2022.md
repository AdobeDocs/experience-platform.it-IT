...
| Funzione | Descrizione |
| ----------- | ----------- |
| SDK di destinazione | Destination SDK fornisce ora supporto completo ai partner e ai clienti che creano destinazioni in batch (o basate su file) prodotte o private. Per ulteriori informazioni, consulta le seguenti pagine della documentazione: <ul><li>[Panoramica di Destination SDK](/help/destinations/destination-sdk/overview.md)</li><li>[Configurare una destinazione basata su file](/help/destinations/destination-sdk/configure-file-based-destination-instructions.md)</li><li>[Configurare le opzioni di formattazione dei file per le destinazioni basate su file](/help/destinations/destination-sdk/configure-file-based-destination-instructions.md)</li><li>[Verificare le destinazioni basate su file](/help/destinations/destination-sdk/file-based-destination-testing-overview.md)</li></ul> |
