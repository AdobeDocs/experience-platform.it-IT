...
| [Supporto per le chiavi di deduplicazione](../../destinations/ui/activate-batch-profile-destinations.md#deduplication-keys) | Eliminare più record dello stesso profilo nei file di esportazione selezionando una chiave di deduplicazione. Come chiave di deduplicazione puoi selezionare un singolo spazio dei nomi o fino a due attributi di schema XDM. |
