...
| Funzione | Descrizione |
| ------- | ----------- |
| Schemi relazionali | Semplifica la modellazione dei dati con gli schemi relazionali (noti in precedenza come schemi basati su modelli). Ora puoi creare gli schemi più facilmente con esempi e indicazioni completi. Questa funzione è attualmente disponibile per i titolari di licenze per l’orchestrazione delle campagne e verrà estesa in disponibilità generale alla clientela Data Distiller, rendendo la modellazione dei dati più accessibile ed efficiente. |
