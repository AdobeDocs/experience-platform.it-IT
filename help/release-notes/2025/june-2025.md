...
| ------- | ----------- |
| Autorizzazione per esportare i dati della dashboard | Le opzioni **[!UICONTROL Download CSV]** e **[!UICONTROL Send as email]** nei dashboard ora richiedono l&#39;autorizzazione **[!UICONTROL Export Dashboard Data]**. Questa autorizzazione garantisce che solo gli utenti autorizzati possano esportare dati di approfondimenti tabulati, supportando regole di governance e criteri di controllo degli accessi ai dati più rigidi. Per ulteriori informazioni, consulta la sezione sulle [autorizzazioni della guida al controllo degli accessi](../../access-control/home.md#permissions). |
...
| Funzione | Descrizione |
| ------- | ----------- |
| Opzione di esportazione Invia come e-mail | È ora possibile esportare fino a 10.000 record dai dashboard in modalità Query Pro selezionando **[!UICONTROL Send as email]** dal menu **[!UICONTROL View more]**. Questa opzione invia in modo sicuro un collegamento per il download all’indirizzo e-mail associato ad Adobe per esportazioni più grandi. Per ulteriori informazioni, consulta la [guida visualizza altro](../../dashboards/sql-insights-query-pro-mode/view-more.md#export). |
...
| Aggiornamento destinazione [[!DNL Braze]](../../destinations/catalog/mobile-engagement/braze.md) | A partire dal 19 giugno 2025 nel catalogo delle destinazioni, puoi visualizzare due schede **[!DNL Braze]** affiancate. Questo è dovuto a un aggiornamento interno del servizio destinazioni. Il connettore di destinazione [!DNL Braze] esistente è stato rinominato in **[!UICONTROL (Deprecated) Braze]** ed è ora disponibile una nuova scheda con il nome **[!UICONTROL Braze]**. <br> Utilizzare la connessione **[!UICONTROL Braze]** nel catalogo per i nuovi flussi di dati di attivazione. Se sono presenti flussi di dati attivi nella destinazione **[!UICONTROL (Deprecated) Braze]**, questi verranno aggiornati automaticamente e non è quindi richiesta alcuna azione da parte dell’utente. <br> Se si creano flussi di dati tramite [Flow Service API](https://developer.adobe.com/experience-platform-apis/references/destinations/), è necessario aggiornare [!DNL flow spec ID] e [!DNL connection spec ID] ai seguenti valori: <ul><li>Flow spec ID: `cb7919bd-69aa-462d-bcc0-db7cdc7fdf51`</li><li>Connection spec ID: `ab957205-5a78-4393-b901-b930ed548220`</li></ul> |
