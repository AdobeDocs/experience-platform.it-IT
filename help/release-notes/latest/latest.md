...
| --- | --- |
| Disponibilità generale dell’agente di supporto per prodotti | È ora possibile utilizzare l’agente di supporto per i prodotti nell’Assistente IA, per risolvere problemi in maniera facile e senza uscire dai flussi di lavoro. Gli amministratori del supporto della tua organizzazione ora possono utilizzare l’agente di supporto del prodotto per creare i ticket dell’Assistenza clienti, completi dei dettagli di contesto e sessione derivanti dalle interazioni con l’Assistente IA. <br><br>L&#39;accesso all’agente di supporto per i prodotti è disponibile fino al 30 novembre 2025. Contatta il rappresentante del tuo account Adobe per richiedere la licenza dell’agente di supporto per i prodotti e continuare a utilizzare la funzione dopo questa data. Per ulteriori informazioni, consulta la [documentazione sull’agente di supporto per i prodotti](../../ai-assistant/new-features/customer-support.md). |
...
| Funzione | Descrizione |
| --- | --- |
| Aggiornamento e supporto del [pubblico personalizzato di Facebook](../../destinations/catalog/social/facebook.md) per gli identificatori relativi agli indirizzi | A partire dal 23 maggio 2025 e per tutto il mese di giugno 2025, nel catalogo delle destinazioni potresti vedere temporaneamente due schede per la destinazione **[!DNL Facebook Custom Audience]**, per un massimo di alcune ore. Ciò è dovuto a un aggiornamento interno del servizio destinazioni e al supporto di nuovi campi volti a migliorare le funzioni di targeting e corrispondenza con profili su proprietà Facebook. Per informazioni sui nuovi campi relativi all’indirizzo, consulta la sezione sulle [identità supportate](#supported-identities). <br><br>Se vedi una scheda con l’etichetta **[!UICONTROL (Nuovo) Pubblico personalizzato Facebook]**, usala per i nuovi flussi di dati di attivazione. I flussi di dati esistenti verranno aggiornati automaticamente, pertanto non è richiesta alcuna azione da parte tua. Eventuali modifiche apportate ai flussi di dati esistenti durante questo periodo verranno mantenute dopo l’aggiornamento. Una volta completato l’aggiornamento, la scheda della destinazione **[!UICONTROL (Nuovo) Pubblico personalizzato di Facebook]** verrà rinominata **[!DNL Facebook Custom Audience]**. <br><br>Quando crei flussi di dati usando l’[API del servizio Flusso](https://developer.adobe.com/experience-platform-apis/references/destinations/), devi aggiornare [!DNL flow spec ID] e [!DNL connection spec ID] ai seguenti valori: <ul><li>Flow spec ID: `bb181d00-58d7-41ba-9c15-9689fdc831d3`</li><li>Connection spec ID: `c8b97383-2d65-4b7a-9913-db0fbfc71727`</li></ul> |
| Supporto ID pubblicità su dispositivi mobili per la destinazione [Google Customer Match + Display &amp; Video 360](../../destinations/catalog/advertising/google-customer-match-dv360.md#supported-identities) | Ora puoi attivare i tipi di pubblico nella destinazione [Google Customer Match + Display &amp; Video 360](../../destinations/catalog/advertising/google-customer-match-dv360.md#supported-identities) in base agli ID pubblicità su dispositivi mobili, ad esempio [!DNL GAID] e [!DNL IDFA]. |
...
| Funzione | Descrizione |
| --- | --- |
| [!DNL Identity Graph Linking Rules] | La funzione [!DNL Identity Graph Linking Rules] è ora in disponibilità generale. La funzione [!DNL Identity Graph Linking Rules] evita la “modalità ridotta del grafo”, garantendo profili cliente distinti e precisi per il marketing personalizzato in Experience Platform e nelle sue applicazioni. Le sue funzionalità principali includono:<ul><li>[Strumento di simulazione del grafo](../../identity-service/identity-graph-linking-rules/graph-simulation.md): esplora l’algoritmo e verifica le configurazioni delle impostazioni di identità.</li><li> [Impostazioni di identità](../../identity-service/identity-graph-linking-rules/identity-settings-ui.md): configura spazi dei nomi univoci e imposta le priorità.</li><li>[Dashboard delle identità](../../identity-service/identity-graph-linking-rules/implementation-guide.md#validate-your-graphs): monitora i grafi e convalida le impostazioni di identità.</li></ul> **Nota**: non verranno apportate modifiche ai dati finché non avrai configurato manualmente le impostazioni di identità. |
