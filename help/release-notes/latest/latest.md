...
| Funzione | Descrizione |
| --- | --- |
| Eliminazione dei consumatori | [Elimina record consumer](../../hygiene/ui/delete-consumer.md) dal data lake e dall&#39;archivio profili in base ai dati di identità principali. |
