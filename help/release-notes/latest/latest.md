...
- [Note sulla versione di Adobe Experience Platform](#adobe-experience-platform-release-notes)
   - [Dashboard {#dashboards}](#dashboards-dashboards)
      - [Dashboard dei profili account](#account-profiles-dashboards)
      - [Dashboard di profili](#profile-dashboards)
      - [Dashboard delle destinazioni](#destinations-dashboards)
   ...
   - [Edizione B2B di Real-time Customer Data Platform {#b2b}](#real-time-customer-data-platform-b2b-edition-b2b)
...
Per istruzioni su come utilizzare account correlati nelle definizioni dei segmenti, consulta la guida su [Casi d’uso della segmentazione per Real-time Customer Data Platform B2B Edition](../../rtcdp/segmentation/b2b.md#related-accounts).
