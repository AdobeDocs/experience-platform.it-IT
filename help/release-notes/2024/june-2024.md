...
| --- | --- |
| Assistente IA in Experience Platform | Ora puoi utilizzare l’Assistente IA in Experience Platform. L’Assistente IA supporta Experience Platform, Real-time Customer Data Platform, Adobe Journey Optimizer e Customer Journey Analytics. <br> ![Assistente AI in Experience Experience Platform.](../2024/assets/june/ai-assistant-full.png "Assistente AI in Experience Experience Platform."){width="100" zoomable="yes"} <br> Per ulteriori informazioni su questa funzionalità, leggere la [Guida dell’interfaccia utente dell’Assistente IA](../../ai-assistant/ui-guide.md). |
