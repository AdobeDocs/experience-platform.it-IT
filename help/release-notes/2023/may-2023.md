...
| ----------- | ----------- |
| **[[!UICONTROL Mailchimp Interest Categories]](../../destinations/catalog/email-marketing/mailchimp-interest-categories.md)** | **[!UICONTROL Mailchimp]** è una piattaforma di automazione del marketing e un servizio di marketing via e-mail utilizzato dalle aziende per gestire i contatti (clienti, clienti o altre parti interessate) tramite mailing list e campagne di marketing via e-mail. Utilizza questo connettore per ordinare i contatti in base ai loro interessi e preferenze. |
...
| Gruppo di campi | [[!UICONTROL XDM Individual Prospect Profile]](https://github.com/adobe/xdm/pull/1721/files) | L&#39;opzione `partnerProspect` per i tag di metadati è stata aggiunta alla classe [!UICONTROL XDM Individual Prospect Profile]. |
| Tipo di dati | (Multiplo) | Sono stati aggiunti diversi campi per il tipo di dati [[!UICONTROL Media details information]](https://github.com/adobe/xdm/pull/1716/files). |
| Tipo di dati | [[!UICONTROL Session details information]](https://github.com/adobe/xdm/pull/1716/files) | È stato aggiunto un nuovo campo per indicare se si è verificato un reindirizzamento. |
| Gruppo di campi | [[!UICONTROL MediaAnalytics Interaction Details]](https://github.com/adobe/xdm/pull/1716/files) | È stato aggiunto un nuovo campo relativo al reporting sui contenuti multimediali. |
...
Per ulteriori informazioni sui servizi Query Service, consulta [Panoramica su Query Service](../../query-service/home.md).
...
| Supporto dell’interfaccia utente per la modalità bozza | Ora tramite l’interfaccia utente di puoi mettere in pausa e salvare l’avanzamento durante il flusso di lavoro delle origini. È possibile selezionare **[!UICONTROL Save as draft]** durante i passaggi di dettaglio, mappatura e pianificazione del flusso di lavoro per salvarlo come bozza per un completamento successivo. Per ulteriori informazioni, consulta la guida sul [salvataggio dei flussi di dati come bozze nell’interfaccia utente](../../sources/tutorials/ui/draft.md). |
