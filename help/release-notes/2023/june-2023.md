...
| Tipo di dati | [[!UICONTROL Rete per la consegna dei contenuti (CDN)]](https://github.com/adobe/xdm/pull/1733/files) | Alle [!UICONTROL Informazioni sui dettagli della sessione] è stato aggiunto un campo per descrivere la rete per la consegna dei contenuti (CDN) utilizzata. |
