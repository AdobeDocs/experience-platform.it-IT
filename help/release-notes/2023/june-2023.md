...
| [!BADGE Beta]Supporto {type=Informative} per [!DNL RainFocus] | Ora puoi utilizzare l’integrazione delle origini [!DNL RainFocus] per portare i dati di gestione degli eventi e di analisi dall’account [!DNL RainFocus] su Experience Platform. Per ulteriori informazioni, leggi la [[!DNL RainFocus] panoramica dell’origine](../../sources/connectors/analytics/rainfocus.md). |
