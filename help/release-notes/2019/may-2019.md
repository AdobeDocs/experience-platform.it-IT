...
| [!DNL Schema Library] | Il [!DNL Schema Library] contiene tutto [!DNL Schema Registry] le risorse, comprese quelle definite da una singola organizzazione IMS e quelle messe a disposizione di tutti gli utenti per Adobe, [!DNL Experience Platform] partner e fornitori le cui applicazioni sono integrate con [!DNL Experience Platform]. |
...
| Funzione | Descrizione |
| -----------| ---------- |
| Grafo identità | Un grafo di identità è una mappa delle relazioni tra identità che si aggiorna con l’attività del cliente in tempo reale. [!DNL Identity Service] gestisce un grafo di identità visibile solo dalla tua organizzazione e basato sui tuoi dati, o grafo privato. [!DNL Identity Service] potenzia il tuo grafico privato quando un record di dati acquisiti contiene più di un’identità, aggiungendo relazioni tra queste identità. |
