...
| Funzione | Descrizione |
| ------- | ----------- |
| Aggiunte API di anteprima profilo | API di anteprima profilo (`/previewsamplestatus`) ora include la possibilità di visualizzare un raggruppamento del totale dei frammenti di profilo nell’organizzazione IMS e la distribuzione dei frammenti di profilo tra gli spazi dei nomi delle identità. |
