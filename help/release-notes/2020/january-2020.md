...
description: ' note sulla versione di Experience Platform del 15 gennaio 2020'
...
| Miglioramenti all&#39;interfaccia utente di Privacy Service | Pagine separate per il monitoraggio dei processi per le normative GDPR e CCPA. Nuovo menu a discesa Tipo __ regolamento per passare dai dati di monitoraggio per GDPR e CCPA. |
