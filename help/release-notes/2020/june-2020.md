...
Per ulteriori informazioni sulla [!DNL Real-time Machine Learning] alfa, per favore vedi [Panoramica sull’apprendimento automatico in tempo reale](../../data-science-workspace/real-time-machine-learning/home.md).
