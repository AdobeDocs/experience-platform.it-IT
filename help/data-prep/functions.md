...
| upsert_array_replace | Questa funzione viene utilizzata per sostituire gli elementi di una matrice. Questa funzione è **only** applicabile durante gli aggiornamenti. Se utilizzata nel contesto di inserti, questa funzione restituisce l&#39;input così come è. | <ul><li>ARRAY: **Obbligatorio** Matrice per sostituire la matrice nel profilo.</li><li>INDICE: **Facoltativo** La posizione da cui deve avvenire la sostituzione.</li></li> | upsert_array_replace(ARRAY, INDEX) | `upsert_array_replace([123, 456], 1)` | [123, 456] |
