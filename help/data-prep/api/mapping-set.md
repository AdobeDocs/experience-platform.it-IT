...
Per recuperare un elenco di tutti i set di mappatura per l’organizzazione IMS, devi effettuare una richiesta GET al `/mappingSets` endpoint.
...
La richiesta seguente recupererà gli ultimi due set di mappatura all’interno dell’organizzazione IMS.
