...
| Scheda | Descrizione |
| --- | ----------- |
| Funzione | Nella scheda Funzioni sono elencate le funzioni disponibili per la trasformazione dei dati. Per ulteriori informazioni sulle funzioni utilizzabili nei campi calcolati, consulta la guida su [utilizzo delle funzioni di preparazione dati (Mapper)](./functions.md). |
