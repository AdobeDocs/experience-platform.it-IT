...
description: Panoramica di alto livello su come gestire le autorizzazioni e controllare l’accesso alle funzioni nelle connessioni Real-time Customer Data Platform (RTCDP).
