...
Verrà visualizzato il popover **[!UICONTROL Composition properties]**. È possibile inserire i dettagli della composizione, inclusi il titolo e la descrizione qui.
...
Dopo aver aggiornato i dettagli della composizione, seleziona **[!UICONTROL Save]** per confermare questi aggiornamenti. L’area di lavoro per la composizione del pubblico viene nuovamente visualizzata.

L&#39;area di lavoro della composizione del pubblico è composta da quattro diversi tipi di blocchi: **[[!UICONTROL Audience]](#audience-block)**, **[[!UICONTROL Exclude]](#exclude-block)**, **[[!UICONTROL Rank]](#rank-block)** e **[[!UICONTROL Split]](#split-block)**.
...
Il tipo di blocco **[!UICONTROL Audience]** ti consente di aggiungere i sottogruppi di pubblico che desideri utilizzare per comporre il nuovo pubblico più grande. Per impostazione predefinita, un blocco **[!UICONTROL Audience]** è incluso nella parte superiore dell&#39;area di lavoro della composizione.

Quando selezioni il blocco **[!UICONTROL Audience]**, nella barra a destra vengono visualizzati i controlli per etichettare il pubblico, aggiungere tipi di pubblico al blocco e creare regole personalizzate per il blocco di pubblico.
...
Aggiungere tipi di pubblico al blocco Pubblico. selezionare **[!UICONTROL Add Audience]**.
...
Viene visualizzato un elenco di tipi di pubblico. Seleziona i tipi di pubblico da includere, seguiti da **[!UICONTROL Add]** per aggiungerli al blocco di pubblico.
...
I tipi di pubblico selezionati verranno ora visualizzati nella barra a destra quando viene selezionato il blocco **[!UICONTROL Audience]**. Da qui, puoi modificare il tipo di unione dei tipi di pubblico combinati.
...
| [!UICONTROL Exclude overlap] | I tipi di pubblico vengono combinati, con solo quelli condivisi in **uno, ma non tutti**. Equivale a un&#39;operazione XOR. |
...
Per aggiungere una regola personalizzata al blocco Pubblico, selezionare **[!UICONTROL Build rule]**.
...
Dopo aver aggiunto una regola personalizzata, seleziona **[!UICONTROL Save]** per aggiungere la regola al tuo pubblico.
...
Il tipo di blocco **[!UICONTROL Exclude]** ti consente di escludere uno o più attributi del pubblico secondario specificato dal nuovo pubblico più grande.

Per aggiungere un blocco **[!UICONTROL Exclude]**, seleziona l&#39;icona **+**, seguita da **[!UICONTROL Exclude]**.

![L&#39;opzione Escludi è selezionata.](../images/ui/audience-composition/add-exclude-block.png)

Blocco **[!UICONTROL Exclude]** aggiunto. Quando questo blocco è selezionato, i dettagli sull’esclusione vengono visualizzati nella barra a destra. Questo include l’etichetta del blocco e il tipo di esclusione. È possibile escludere [per pubblico](#exclude-audience) o [per attributo](#exclude-attribute).
...
Se escludi per pubblico, puoi selezionare il pubblico da escludere selezionando **[!UICONTROL Add Audience]**.

![È selezionato il pulsante [!UICONTROL Add audience], che consente di scegliere il pubblico da escludere.](../images/ui/audience-composition/add-excluded-audience.png)
...
Viene visualizzato un elenco di tipi di pubblico. Seleziona **[!UICONTROL Add]** per aggiungere il pubblico da escludere al blocco di esclusione.
...
Se si esclude per attributo, è possibile selezionare gli attributi da escludere selezionando l&#39;icona ![filtro](/help/images/icons/project-edit.png) nella sezione **[!UICONTROL Exclusion rule]**. L’esclusione dell’attributo ti consente di escludere dal pubblico risultante tutti i profili che lo contengono.
...
Viene visualizzato un elenco di attributi di profilo. Seleziona il tipo di attributo da escludere, seguito da **[!UICONTROL Select]** per aggiungerlo al blocco di esclusione.
...
Il tipo di blocco **[!UICONTROL Enrich]** ti consente di arricchire il pubblico con attributi aggiuntivi da un set di dati. Puoi utilizzare questi attributi nei casi di utilizzo di personalizzazione.

Per aggiungere un blocco **[!UICONTROL Enrich]**, seleziona l&#39;icona **+**, seguita da **[!UICONTROL Enrich]**.

![L&#39;opzione [!UICONTROL Enrich] è selezionata.](../images/ui/audience-composition/add-enrich-block.png)

Blocco **[!UICONTROL Enrich]** aggiunto. Quando questo blocco è selezionato, i dettagli sull’arricchimento vengono visualizzati nella barra a destra. Questo include l’etichetta del blocco e il set di dati di arricchimento.
...
![Il pulsante del filtro è evidenziato. Se si seleziona questa opzione, verrà visualizzato il popover [!UICONTROL Select dataset].](../images/ui/audience-composition/enrich-select-dataset.png)

Verrà visualizzato il popover **[!UICONTROL Select dataset]**. Selezionare il set di dati da aggiungere per l&#39;arricchimento, seguito da **[!UICONTROL Select]** per aggiungere il set di dati per l&#39;arricchimento.
...
La sezione **[!UICONTROL Enrichment criteria]** viene ora visualizzata nella barra a destra. In questa sezione puoi selezionare **[!UICONTROL Source join key]** e **[!UICONTROL Enrichment dataset join key]**, che ti consentono di collegare il set di dati di arricchimento al pubblico che stai tentando di creare.

![L&#39;area [!UICONTROL Enrichment criteria] è evidenziata.](../images/ui/audience-composition/enrichment-criteria.png)

Per selezionare **[!UICONTROL Source join key]**, seleziona l&#39;icona ![filtro](/help/images/icons/project-edit.png).

Verrà visualizzato il popover **[!UICONTROL Select a profile attribute]**. Selezionare l&#39;attributo di profilo che si desidera utilizzare come chiave di join di origine, seguito da **[!UICONTROL Select]** per scegliere tale attributo come chiave di join di origine.
...
Per selezionare **[!UICONTROL Enrichment dataset join key]**, seleziona l&#39;icona ![filtro](/help/images/icons/project-edit.png).

Verrà visualizzato il popover **[!UICONTROL Enrichment attributes]**. Selezionare l&#39;attributo che si desidera utilizzare come chiave di join del set di dati di arricchimento, seguito da **[!UICONTROL Select]** per scegliere tale attributo come chiave di join del set di dati di arricchimento.
...
Dopo aver aggiunto entrambe le chiavi di join, verrà visualizzata la sezione **[!UICONTROL Enrichment attributes]**. Ora puoi aggiungere l’attributo con cui desideri migliorare il pubblico. Per aggiungere questi attributi, selezionare **[!UICONTROL Add attribute]**.

Verrà visualizzato il popover **[!UICONTROL Enrichment attributes]**. Puoi selezionare gli attributi dal set di dati con cui arricchire il pubblico, seguito da **[!UICONTROL Select]** per aggiungere gli attributi al pubblico.
...
Il tipo di blocco **[!UICONTROL Rank]** consente di classificare e ordinare i profili in base a un attributo specificato e di includerli nella composizione.

Per aggiungere un blocco **[!UICONTROL Rank]**, seleziona l&#39;icona **+**, seguita da **[!UICONTROL Rank]**.
...
Viene visualizzato un elenco di attributi di profilo. In questo popover, puoi selezionare il tipo di attributo in base al quale classificare il pubblico. Seleziona **[!UICONTROL Select]** per aggiungerlo al tuo blocco di classificazione. Tieni presente che l&#39;attributo selezionato può essere **solo** numeri.
...
Inoltre, puoi limitare il numero di profili restituiti abilitando l&#39;interruttore **[!UICONTROL Add profile limit]**. Quando questa opzione è abilitata, è possibile impostare il numero massimo di profili restituiti all&#39;interno del campo **[!UICONTROL Included profiles]**.
...
>[!NOTE]
>
>Per utilizzare il blocco **[!UICONTROL Split]**, **devi** avere almeno 10 profili nel pubblico.

Il tipo di blocco **[!UICONTROL Split]** consente di suddividere il nuovo pubblico in vari sottogruppi. Puoi suddividere questo pubblico in base alla percentuale o a un attributo.
...
Quando si divide per attributo, il pubblico viene diviso in base agli attributi forniti. Per selezionare l&#39;attributo da dividere, selezionare il blocco **[!UICONTROL Split]**, seguito dall&#39;icona ![filter](/help/images/icons/project-edit.png).
...
Viene visualizzato un elenco di attributi di profilo. Seleziona il tipo di attributo, seguito da **[!UICONTROL Select]** per aggiungerlo al blocco di suddivisione.

![Viene visualizzato un elenco di attributi.](../images/ui/audience-composition/select-attribute.png)

Dopo aver selezionato l’attributo, puoi scegliere quali profili apparterranno a quale pubblico secondario aggiungendo i valori all’interno del campo **[!UICONTROL Values]**.
...
Inoltre, puoi abilitare l&#39;interruttore **[!UICONTROL Other profiles]** per creare un pubblico secondario composto da tutti i profili non selezionati.
