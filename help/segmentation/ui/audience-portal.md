...
Se il pubblico è in scadenza entro sette giorni, puoi selezionare **[!UICONTROL Refresh data expiration]** per riacquisire l&#39;ultimo batch riuscito per il pubblico.

![Il pulsante [!UICONTROL Refresh data expiration] è evidenziato nella pagina dei dettagli del pubblico.](../images/ui/audience-portal/refresh-data-expiration.png)

In questo modo la scadenza dei dati viene estesa del numero di giorni definiti nel caricamento iniziale e vengono utilizzati gli stessi metadati di pubblico. Se la scadenza dei dati non è stata definita in precedenza, viene estesa di 30 giorni. Una volta premuto il pulsante, non è possibile selezionarlo per altri 20 minuti.

Questo pulsante **non** sarà selezionabile nelle seguenti situazioni:

- Nessuna batch riuscita per il pubblico
- Aggiornamento iniziale non riuscito
- La scadenza dei dati è superiore a sette giorni
- Il pubblico è già scaduto
...
>title="Scadenza dati"
>abstract="Il numero di giorni di scadenza dell’iscrizione di un pubblico. Questo valore può essere impostato da 1 giorno a 90 giorni. Una volta scaduta l’appartenenza al pubblico, la valutazione si interrompe e tutti i profili ne escono. Puoi aggiornare la finestra di scadenza quando restano meno di 7 giorni al termine di appartenenza al pubblico. Tuttavia, una volta che restano 0 giorni, non è più possibile aggiornare la finestra di scadenza."
