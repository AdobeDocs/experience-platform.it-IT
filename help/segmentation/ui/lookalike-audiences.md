...
description: Scopri come eseguire il targeting di nuovi tipi di pubblico di alto valore in Adobe Experience Platform utilizzando tipi di pubblico lookalike.
...
>[!IMPORTANT]
>
>Tieni presente che approfondimenti simili e tipi di pubblico simili sono in **disponibilità limitata**.

In Adobe Experience Platform, i tipi di pubblico &quot;lookalike&quot; forniscono informazioni intelligenti su ciascuno dei tipi di pubblico, sfruttando le informazioni basate sull’apprendimento automatico per identificare e indirizzare i clienti di alto valore con le campagne di marketing.

Con i tipi di pubblico lookalike puoi creare tipi di pubblico espansi per rivolgerti a clienti con prestazioni simili a quelle dei tuoi tipi di pubblico con prestazioni migliori o a clienti target simili a quelli convertiti in precedenza.

## Terminologia {#terminology}

Prima di iniziare a utilizzare i tipi di pubblico lookalike, assicurati di comprendere i seguenti concetti:
...
- **Pubblico simile**: un pubblico lookalike è il pubblico che viene creato quando al pubblico di base viene applicato un modello lookalike con una soglia di somiglianza selezionata. Puoi creare più tipi di pubblico con aspetto simile utilizzando lo stesso modello. Il pubblico lookalike è ciò che viene valutato.
...
I seguenti diritti si applicano all’utilizzo di tipi di pubblico lookalike:

- I clienti di Real-Time CDP Prime hanno diritto a **5** pubblico lookalike attivo nelle sandbox di produzione
...
Passa il cursore del mouse su un punto specifico del grafico per visualizzare la percentuale di somiglianza e il conteggio di profili previsto per il punto attualmente evidenziato.

### Tipi di pubblico simili {#list}

La sezione Tipi di pubblico lookalike presenta un elenco di tutti i tipi di pubblico lookalike precedentemente creati per il pubblico di base selezionato.

![Viene evidenziata la sezione Tipi di pubblico.](../images/ui/lookalike-audiences/select-laa.png)
...
>[!IMPORTANT]
>
>Tu **non può** utilizza un pubblico lookalike come pubblico di base per un altro pubblico lookalike. Vale a dire, tu **non può** creare tipi di pubblico simili concatenati.

Per creare un pubblico lookalike, devi selezionare il pubblico da cui vuoi basare il pubblico lookalike. Per accedere all’elenco dei tipi di pubblico disponibili, seleziona **[!UICONTROL Tipi di pubblico]** nella barra di navigazione a sinistra, seguito da **[!UICONTROL Sfoglia]**. Viene visualizzato l’elenco dei tipi di pubblico. In questa pagina puoi selezionare il pubblico da utilizzare come pubblico di base.

![Viene evidenziato il pulsante Tipi di pubblico e il pubblico di base utilizzato per la modellazione lookalike.](../images/ui/lookalike-audiences/browse.png)

Nella pagina dei dettagli del pubblico, seleziona **[!UICONTROL Creare un pubblico simile]** per iniziare il processo di creazione di un pubblico lookalike.

![Il [!UICONTROL Creare un pubblico simile] viene evidenziato.](../images/ui/lookalike-audiences/create-look-alike-audience.png)

Il **[!UICONTROL Creare un pubblico simile]** viene visualizzato popover. In questa pagina puoi impostare la percentuale di somiglianza per il pubblico lookalike.
...
Puoi anche aggiornare i dettagli sul pubblico lookalike, compreso il nome e la descrizione. Per impostazione predefinita, il nome del pubblico lookalike viene generato in base al nome del pubblico di base e alla percentuale di somiglianza precedentemente specificata.
...
Seleziona **[!UICONTROL Crea]** per completare la creazione del pubblico lookalike.
...
Il pubblico lookalike appena creato è accessibile nel **[!UICONTROL Tipi di pubblico simili]** ed è disponibile anche nel Portale dell’audience e per altri utilizzi a valle. Tieni presente che ci vorrà un po’ di tempo prima che il pubblico loodience venga valutato. Finché non viene assegnato un punteggio, il conteggio dei profili apparirà pari a 0.

## Visualizzare i dettagli del pubblico lookalike {#view-details}

Per visualizzare i dettagli di un pubblico lookalike, seleziona il pubblico lookalike in **[!UICONTROL Tipi di pubblico simili]** del pubblico di base.
...
I tipi di pubblico lookalike possono essere configurati in modo da escludere i campi di dati per i quali sono previste restrizioni per l’azione di marketing &quot;Data Science&quot;, applicando le etichette e i criteri di utilizzo dei dati pertinenti. I dati etichettati come non utilizzabili per la data science verranno rimossi dalla considerazione quando si addestrano modelli di pubblico lookalike e quando si genera un pubblico lookalike dal modello addestrato. 
...
Per impostazione predefinita, il processo di modellazione per i tipi di pubblico lookalike escluderà **qualsiasi** campo, set di dati o pubblico in base all’informativa sulla privacy abilitata per la tua organizzazione. Se il pubblico di base non dispone di etichette di contratto, il processo di modellazione escluderà **qualsiasi** campo, set di dati o pubblico in base all’informativa sulla privacy abilitata per la tua organizzazione.
...
Dopo aver letto questa guida, hai imparato a visualizzare informazioni simili e a creare tipi di pubblico simili in base a queste informazioni. Per ulteriori informazioni sui tipi di pubblico nell’interfaccia utente di Adobe Experience Platform, consulta [Guida dell’interfaccia utente di Segmentation Service](./overview.md).
