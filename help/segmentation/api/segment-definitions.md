---
keywords: Experience Platform;home;argomenti popolari;segmentazione;Segmentazione;Segmentation Service;segment definition;segment definitions;api;API;
...
>[!NOTE]
>
>Un’espressione di definizione del segmento può anche fare riferimento a un attributo calcolato. Per ulteriori informazioni, consulta [guida dell’endpoint API per attributi calcolati](../../profile/computed-attributes/ca-api.md)
>
