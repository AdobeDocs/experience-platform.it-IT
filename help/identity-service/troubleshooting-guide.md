...
Di seguito è riportato un elenco dei messaggi di errore relativi a [!DNL Identity Service] è possibile che si verifichi quando si utilizza il [API di acquisizione in batch](https://developer.adobe.com/experience-platform-apis/references/batch-ingestion/).
