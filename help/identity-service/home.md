...
Questa sezione illustra come vengono elaborati i dati forniti ad Adobe Experience Platform prima di essere utilizzati per creare un grafico [!DNL Identity Service] di identità per ciascun cliente.
