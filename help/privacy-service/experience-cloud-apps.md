...
| Adobe Journey Optimizer | ✓ | N/D | I dati memorizzati dell’interessato vengono eliminati dal sistema. | <ul><li>[Accedere/eliminare la documentazione](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/privacy/requests)</li></ul> |
...
| Marketo Engage | ✓ | N/D | I dati memorizzati dell’interessato vengono eliminati dal sistema. | <ul><li>[Accedere/eliminare la documentazione](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/core-marketo-concepts/miscellaneous/privacy-requests)</li><li>[!DNL Marketo] non è in grado di trasferire dati, pertanto le richieste di rifiuto non sono applicabili.</li></ul> |
...
| ------- | ----------- |
| [Adobe Experience Manager](https://experienceleague.adobe.com/en/docs/experience-manager-64/managing/data-protection/data-protection-and-privacy) | Panoramica su come un amministratore della privacy dei clienti o un amministratore AEM può gestire le richieste RGPD. |
| [Adobe Commerce](https://experienceleague.adobe.com/en/docs/commerce-operations/security-and-compliance/overview) | Assicurati che le tue installazioni di Adobe Commerce siano conformi ai requisiti di specifiche normative sulla privacy. |
