...
Affinché questo metodo di reporting funzioni correttamente, devi inviare il [!DNL A4T] dati correlati recuperati da [`sendEvent`](/help/web-sdk/commands/sendevent/overview.md) nell’hit di Analytics.
