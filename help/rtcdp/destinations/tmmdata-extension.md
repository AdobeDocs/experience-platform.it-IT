...
seo-title: Estensione TMMData
description: L’estensione TMMData è una destinazione di analisi in Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
seo-description: L’estensione TMMData è una destinazione di analisi nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
# Estensione TMMData {#tmmdata-extension}

## Panoramica {#overview}

La piattaforma TMMData Foundation per Adobe Marketing Cloud fornisce ai team di marketing gli strumenti per accedere e fondere tutte le loro origini dati critiche - inclusi i dati interni/esterni e online/offline - per un&#39;analisi completa e sicura su più canali, con la configurazione automatica delle campagne e le importazioni dirette in Adobe e altri strumenti di analisi e BI.

TMMData è un&#39;estensione di analisi in Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell&#39;estensione in [Adobe Exchange](hhttps://exchange.adobe.com/experiencecloud.details.100148.tmmdata-foundation-platform.html).
...
![Estensione TMMData](assets/tmmdata-extension.png)
...
Per installare l’estensione TMMData:
...
Per informazioni sulle opzioni di configurazione dell&#39;estensione e sul supporto dell&#39;installazione, vedere la pagina [TMMData in Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100148.tmmdata-foundation-platform.html).
