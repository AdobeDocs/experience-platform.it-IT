...
description: L'estensione Demandbase è una destinazione di analisi in Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
seo-description: L'estensione Demandbase è una destinazione di analisi in Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
Ottieni informazioni sugli account [!DNL Demandbase] B2B direttamente da Adobe  Analytics, dove puoi segmentare il traffico e il comportamento in base a Industria, Entrate e account di destinazione. Questa vista basata sull&#39;account offre informazioni univoche su coinvolgimento, conversione e origine per i visitatori più importanti.
