...
description: L'estensione Demandbase è una destinazione di analisi nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
seo-description: L'estensione Demandbase è una destinazione di analisi nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
# Estensione Demandbase {#demandbase-extension}

## Panoramica {#overview}

Ottieni informazioni approfondite sull&#39;account B2B Demandbase direttamente in Adobe Analytics, dove puoi segmentare il traffico e il comportamento in base al settore, alle entrate e agli account di destinazione. Questa vista basata sull&#39;account offre informazioni univoche su coinvolgimento, conversione e origine per i visitatori più importanti.

Demandbase è un&#39;estensione di analisi in Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell&#39;estensione in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101605.html).
...
![Estensione Demandbase](assets/demandbase-extension.png)
...
Per installare l’estensione Demandbase:
...
Per informazioni sulle opzioni di configurazione dell&#39;estensione, consultate la pagina [dell&#39;estensione](https://exchange.adobe.com/experiencecloud.details.101605.html) Demandbase in Adobe Exchange.
