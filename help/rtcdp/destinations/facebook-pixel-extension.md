...
description: L’estensione Facebook Pixel è una destinazione pubblicitaria nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
# Estensione Facebook Pixel {#facebook-pixel-extension}

## Panoramica {#overview}

Il pixel Facebook è uno strumento di analisi che consente di misurare l&#39;efficacia della pubblicità comprendendo le azioni che le persone intraprendono sul sito Web.

Facebook Pixel è un&#39;estensione pubblicitaria nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate il sito Web [](https://developers.facebook.com/docs/facebook-pixel/)Facebook Pixel.
...
![Estensione Facebook Pixel](assets/facebook-pixel-extension.png)
...
Per installare l’estensione Facebook Pixel:
