...
description: L'estensione Tracciamento conversione testo è una destinazione di analisi nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
seo-description: L’estensione Tracciamento conversione testo è una destinazione di analisi nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
# Estensione tracciamento conversione Yext {#yext-extension}

## Panoramica {#overview}

L’estensione Yext Conversion Tracking Extension (Tracciamento conversione testo) consente di misurare le conversioni che possono essere attribuite all’uso dei prodotti Yext.

Tracciamento conversione testo è un&#39;estensione di analisi in Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell&#39;estensione in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103174.yext-conversion-tracking.html).
...
Per installare l’estensione Tracciamento conversione testo:
