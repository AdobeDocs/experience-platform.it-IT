...
* Puoi inviare le seguenti [identità](../../identity-service/namespaces.md) alle destinazioni Google Ad Manager: ID di cookie **Google, IDFA, GAID, ID Roku, ID Microsoft, ID Amazon Fire TV**.
