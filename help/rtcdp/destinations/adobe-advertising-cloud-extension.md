...
description: L'estensione Adobe Advertising Cloud è una destinazione pubblicitaria nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
Questa è l&#39;estensione Advertising Cloud per l&#39;implementazione della conversione Advertising Cloud e dei tag di segmento per DSP e Search (DCO non è attualmente supportato).

Adobe Advertising Cloud è un&#39;estensione pubblicitaria nella piattaforma dati cliente Adobe in tempo reale.
