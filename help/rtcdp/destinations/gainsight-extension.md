...
description: L’estensione Gainsight è una destinazione di personalizzazione nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
seo-description: L’estensione Gainsight è una destinazione di personalizzazione nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
# Estensione del guadagno {#gainsight-extension}

## Panoramica {#overview}

I vantaggi offerti ai proprietari dei prodotti possono comprendere a fondo il comportamento degli utenti, promuovere l&#39;adozione dei prodotti e raccogliere i commenti degli utenti.

Gainsight è un’estensione di personalizzazione nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell&#39;estensione in [Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.103343.html).
...
![Estensione del guadagno](assets/gainsight-extension.png)
...
Per installare l&#39;estensione Gainsight:
...
Per informazioni sulle opzioni di configurazione dell&#39;estensione e sul supporto per l&#39;installazione, vedere la pagina [Gainsight in Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.103343.html).
