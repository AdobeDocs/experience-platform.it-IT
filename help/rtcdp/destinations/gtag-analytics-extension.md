...
description: L'estensione Google Global Site Tag è una destinazione di analisi nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
seo-description: L'estensione Google Global Site Tag è una destinazione di analisi nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
# Estensione dei tag del sito globale Google {#gtag-analytics-extension}

## Panoramica {#overview}

Inviate i dati a Google Analytics, Google Ads e Google Marketing Platform tramite il Global Site Tag di Google o gtag.js. È possibile configurare più account per prodotto.

Google Global Site Tag è un&#39;estensione di analisi in Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell&#39;estensione in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html).
...
Per installare l’estensione Google Global Site Tag:
...
Per informazioni sulle opzioni di configurazione dell&#39;estensione, consultate la pagina [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html) dell&#39;estensione.
