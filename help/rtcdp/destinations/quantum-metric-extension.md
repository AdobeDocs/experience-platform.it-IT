...
description: L’estensione Quantum Metric (Metrica quantistica) è una destinazione di analisi nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
seo-description: L’estensione Quantum Metric (Metrica quantistica) è una destinazione di analisi nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
# Estensione quantistica {#quantum-metric-extension}

## Panoramica {#overview}

L&#39;integrazione di Quantum Metric con Adobe Launch facilita l&#39;implementazione senza codifica del tag di raccolta dati di Quantum Metric. Inoltre, questa estensione offre la possibilità di acquisire gli elementi di dati di Launch contenenti informazioni utili dall’API Quantum Metric.

Quantum Metric è un&#39;estensione di analisi nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell&#39;estensione in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html).
...
Per installare l’estensione Quantum Metric:
...
Per informazioni sulle opzioni di configurazione dell&#39;estensione e sul supporto dell&#39;installazione, consultate la pagina Metrica [quantitativa in Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html).
