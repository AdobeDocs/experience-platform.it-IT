...
description: L’estensione Quantum Metric (Metrica quantistica) è una destinazione di analisi in Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
seo-description: L’estensione Quantum Metric (Metrica quantitativa) è una destinazione di analisi in Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
[!DNL Quantum Metric's] l&#39;integrazione con Adobe Launch facilita la distribuzione in modalità protetta dei tag di raccolta [!DNL Quantum Metric's] dati. Inoltre, questa estensione offre la possibilità di acquisire gli elementi di dati di Launch contenenti informazioni utili dall&#39; [!DNL Quantum Metric] API.
