...
description: L’estensione Qualtrics Website Feedback è una destinazione di sondaggi nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
seo-description: L’estensione Qualtrics Website Feedback è una destinazione di sondaggi nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
# Estensione Qualtrics Website Feedback {#qualtrics-extension}

## Panoramica {#overview}

Qualtrics Website Feedback consente di coinvolgere i visitatori del sito Web con il messaggio giusto, al momento giusto. Sia che desideriate migliorare l&#39;esperienza dei visitatori con i sondaggi di feedback sui siti Web o aumentare la conversione, Qualtrics Website Feedback vi ha coperto.

Crea e distribuisci in pochi minuti messaggi web con il tuo brand altamente mirati grazie a un&#39;interfaccia intuitiva, point-and-click. I dati e le informazioni raccolte dal sito Web vengono visualizzati insieme ai dati di feedback dei clienti su tutti i canali, offrendo una visione completa dell&#39;esperienza dei clienti, il tutto su un&#39;unica piattaforma.

Qualtrics Website Feedback è un&#39;estensione del sondaggio in Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell&#39;estensione in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).
...
![Estensione Qualtrics Website Feedback](assets/qualtrics-extension.png)
...
Per installare l’estensione Qualtrics Website Feedback:
...
Per informazioni sulle opzioni di configurazione dell&#39;estensione e sul supporto per l&#39;installazione, consultate la pagina Feedback del sito Web [Qualtrics in Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).
