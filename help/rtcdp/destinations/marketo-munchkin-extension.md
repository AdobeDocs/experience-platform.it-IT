...
description: L’estensione Marketo Munchkin è una destinazione di personalizzazione nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
seo-description: L’estensione Marketo Munchkin è una destinazione di personalizzazione nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
# Estensione Marketo Munchkin {#marketo-munchkin-extension}

## Panoramica {#overview}

Dalla gestione dei lead al marketing basato sugli account, la Piattaforma di coinvolgimento di Marketo semplifica la pianificazione, l&#39;organizzazione e la misurazione del coinvolgimento con clienti e potenziali clienti in ogni fase della loro esperienza.

Il codice JavaScript Munchkin di Marketo consente di monitorare le visite e i clic delle pagine dell’utente finale sulle pagine di destinazione e sulle pagine Web esterne.

Marketo Munchkin è un&#39;estensione e-mail disponibile nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell&#39;estensione in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101054.marketo-munchkin.html).
...
Per installare l&#39;estensione Marketo Munchkin:
