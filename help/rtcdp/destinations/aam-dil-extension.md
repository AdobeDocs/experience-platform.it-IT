---
title: Estensione DIL di Audience Manager
seo-title: Estensione DIL di Audience Manager
description: L’estensione DIL di Audience Manager è una destinazione DMP (Data Management Platform) in Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
seo-description: L’estensione DIL di Audience Manager è una destinazione DMP (Data Management Platform) in Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
# Estensione DIL di Audience Manager {#aam-dil-extension}

## Panoramica {#overview}

Questa è l’estensione Adobe Audience Manager Data Integration Library (implementazione lato client). Nota: Questa estensione non è destinata all&#39;inoltro lato server (SSF) di dati Adobe Analytics. Per SSF, utilizzate l&#39;estensione Adobe Analytics. Importante: A partire dalla versione 8.0, DIL dipende dal servizio Experience Cloud ID, versione 3.3 o successiva. Implementa sia il servizio Experience Cloud ID che il servizio DIL per funzionalità complete di integrazione dei dati di Audience Manager.

Audience Manager DIL è un’estensione DMP (Data Management Platform) in Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consulta la pagina [dell’estensione](https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/adobe-audience-manager-extension.html) Audience Manager nella documentazione di avvio della piattaforma Experience.
...
![Estensione DIL di Audience Manager](/help/rtcdp/destinations/assets/aam-dil-extension.png)
...
Per installare l’estensione DIL di Audience Manager:
...
Per informazioni sulle opzioni di configurazione dell&#39;estensione, consulta la pagina [dell&#39;estensione](https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/adobe-audience-manager-extension.html) Audience Manager nella documentazione di Experience Launch.
