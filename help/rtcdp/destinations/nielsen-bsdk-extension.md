...
description: L’estensione Nielsen BSDK è una destinazione di analisi nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
seo-description: L’estensione Nielsen BSDK è una destinazione di analisi nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
# Estensione Nielsen BSDK {#nielsen-bsdk-extension}
...
Nielsen BSDK è un&#39;estensione di analisi in Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell&#39;estensione in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.html).
...
![Estensione Nielsen BSDK](assets/nielsen-bsdk-extension.png)
...
Per installare l’estensione Nielsen BSDK:
...
Per informazioni sulle opzioni di configurazione dell&#39;estensione e sul supporto dell&#39;installazione, consultate la pagina BSDK [Nielsen in Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.html).
