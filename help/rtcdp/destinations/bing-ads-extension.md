...
# Estensione Bing Ads Universal Event Tracking (UET) {#bing-ads-extension}

## Panoramica {#overview}

Bing Ads Universal Event Tracking (UET) per il lancio della piattaforma Experience è un modo utile per monitorare cosa accade dopo che qualcuno ha fatto clic sul tuo annuncio di ricerca. Utilizzando un singolo tag UET per registrare le attività dei clienti sul sito Web, potete sfruttare tali dati, per monitorare le conversioni o indirizzare i tipi di pubblico utilizzando elenchi di remarketing.

Bing Ads Universal Event Tracking (UET) è un&#39;estensione pubblicitaria della piattaforma Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell&#39;estensione in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100154.html).
...
Per installare l’estensione Bing Ads Universal Event Tracking (UET):
