...
description: L’estensione D&B Visitor Intelligence è una destinazione di personalizzazione nell’Platform Adobe Real-time Customer Data. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
seo-description: L’estensione D&B Visitor Intelligence è una destinazione di personalizzazione nell’Platform Adobe Real-time Customer Data. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
# [!DNL D&B Visitor Intelligence] estensione {#dnb-extension}

## Panoramica {#overview}

Analizzare i visitatori sconosciuti e convertirli in lead.

[!DNL D&B Visitor Intelligence] è un&#39;estensione di personalizzazione in Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate il sito Web [](https://www.dnb.com/)D&amp;B.
...
![Estensione D&amp;B Visitor Intelligence](assets/dnb-extension.png)
