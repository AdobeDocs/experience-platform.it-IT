...
description: L'estensione JW Player  Analytics (BETA) è una destinazione di analisi nell'Platform dati cliente in tempo reale Adobe. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
seo-description: L'estensione JW Player  Analytics (BETA) è una destinazione di analisi nell'Platform dati cliente in tempo reale Adobe. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
Questa estensione installa la [!DNL JW Player] scheda di rete per collegare [!DNL JW Player] gli eventi ad Adobe Video  Analytics. Sfruttate la potenza di Adobe Video  Analytics per acquisire informazioni dettagliate sulle abitudini di visualizzazione dei video dei clienti.

[!DNL JW Player Analytics] (BETA) è un&#39;estensione di analisi in Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell&#39;estensione in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101523.jw-player-analytics-launch-extension.html).
