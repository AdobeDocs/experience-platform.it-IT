...
description: L'estensione JW Player Analytics (BETA) è una destinazione di analisi nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
seo-description: L'estensione JW Player Analytics (BETA) è una destinazione di analisi nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
# Estensione JW Player Analytics (BETA) {#jw-player-analytics-extension}

## Panoramica {#overview}

Questa estensione installa la scheda JW Player per collegare gli eventi JW Player ad Adobe Video Analytics. Sfruttate la potenza di Adobe Video Analytics per acquisire informazioni dettagliate sulle abitudini di visualizzazione dei video dei vostri clienti.

JW Player Analytics (BETA) è un&#39;estensione di analisi in Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell&#39;estensione in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101523.jw-player-analytics-launch-extension.html).
...
Per installare l’estensione JW Player Analytics (BETA):
