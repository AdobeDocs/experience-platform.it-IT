...
description: L’estensione Tag Web site universale Twitter è una destinazione pubblicitaria nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
seo-description: L’estensione Tag universale Twitter è una destinazione pubblicitaria nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
# Estensione tag Web universale Twitter {#twitter-uwt-extension}

## Panoramica {#overview}

Il tag Twitter Universal Website fornisce azioni per inviare beacon al tag UWT di Twitter.

Il tag Twitter Universal Website è un&#39;estensione pubblicitaria nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate Tracciamento [conversione](https://business.twitter.com/en/solutions/twitter-ads/website-clicks/advanced-conversion-tracking.html)avanzato.
...
![Estensione tag Web universale Twitter](assets/twitter-uwt-extension.png)
...
Per installare l’estensione Tag universale Twitter:
