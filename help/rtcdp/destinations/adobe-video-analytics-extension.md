...
description: Adobe Media  Analytics per l’estensione Audio e Video è una destinazione di analisi nell’Platform dati cliente in tempo reale Adobe. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
seo-description: Adobe Media  Analytics per l’estensione Video è una destinazione di analisi nell’Platform dati cliente in tempo reale Adobe. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
Adobe Media  Analytics per Audio e Video è un componente aggiuntivo alla base  offerta Analytics che offre ai clienti misurazioni affidabili per video, audio e annunci pubblicitari.

Adobe Media  Analytics per Audio e Video è un&#39;estensione di analisi in Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell&#39;estensione in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100157.html).
...
Per installare Adobe  Analytics per l’estensione Video:
...
Per informazioni sulle opzioni di configurazione dell’estensione, consultate la pagina [dell’estensione](https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/media-analytics-extension/overview.html) Adobe Media  Analytics per l’audio e il video nella [!DNL Experience Launch] documentazione.
