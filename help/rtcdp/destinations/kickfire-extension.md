...
description: L'estensione KickFire è una destinazione di personalizzazione nell'Platform dati cliente in tempo reale di Adobe. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
seo-description: L'estensione KickFire è una destinazione di personalizzazione nell'Platform dati cliente in tempo reale di Adobe. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
[!DNL KickFire] è un&#39;estensione di personalizzazione in Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate [il sito Web](https://www.kickfire.com/)Kickfire.
