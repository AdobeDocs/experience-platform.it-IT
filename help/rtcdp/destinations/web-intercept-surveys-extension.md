...
description: L’estensione QueryPro Intercept Survey è una destinazione di sondaggio disponibile in Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
seo-description: L’estensione QueryPro Intercept Survey è una destinazione di sondaggio disponibile in Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
Per installare l’ [!DNL QuestionPro Intercept Surveys] estensione:
