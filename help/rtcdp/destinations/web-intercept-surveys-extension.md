...
description: L’estensione QuestPro Intercept Survey è una destinazione di sondaggio nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
seo-description: L’estensione QuestPro Intercept Survey è una destinazione di sondaggio nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
# Intercept Survey Extension {#questionpro-extension}

## Panoramica {#overview}

I sondaggi Intercept di QuestPro sono una piattaforma per la distribuzione di sondaggi e la raccolta di dati attitudinali al punto di transazione o quando gli utenti entrano/escono dal sito Web.

QuestPro Intercept Survey è un&#39;estensione del sondaggio nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell&#39;estensione in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html).
...
![Intercept Survey Extension](assets/web-intercept-surveys-extension.png)
...
Per installare l’estensione QuestionariPro Intercept Surys:
...
Per informazioni sulle opzioni di configurazione dell&#39;estensione e sul supporto dell&#39;installazione, consultate la pagina [QuestionariPro Intercept Survey in Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html).
