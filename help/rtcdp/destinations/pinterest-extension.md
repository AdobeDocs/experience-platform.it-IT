...
seo-title: Estensione Pinterest Conversion Tracking
description: L’estensione Pinterest Conversion Tracking è una destinazione pubblicitaria della piattaforma Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
seo-description: L'estensione Pinterest Conversion Tracking è una destinazione pubblicitaria nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
# Estensione tracciamento conversione Pinterest {#pinterest-extension}

## Panoramica {#overview}

Monitora le azioni dei visitatori sul tuo sito Web dopo le visualizzazioni del pin promosso. Misura il rendimento degli annunci e crea audience mirate. Puoi trovare ulteriori informazioni [qui](https://ads.pinterest.com/).

Il tracciamento della conversione Pinterest è un&#39;estensione pubblicitaria nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell&#39;estensione in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100523.pinterest-conversion-tracking-for-adobe-launch.html).
...
![Estensione tracciamento conversione Pinterest](assets/pinterest-extension.png)
...
Per installare l’estensione Pinterest Conversion Tracking:
...
Per informazioni sulle opzioni di configurazione dell&#39;estensione e sul supporto per l&#39;installazione, consultate la pagina [Pinterest Conversion Tracking (Tracciamento conversione Pinterest) in Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100523.pinterest-conversion-tracking-for-adobe-launch.html).
