...
description: L’estensione del gestore Nielsen IMA è una destinazione di analisi nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
seo-description: L’estensione del gestore Nielsen IMA è una destinazione di analisi nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
# Estensione gestore Nielsen IMA {#nielsen-ima-extension}

## Panoramica {#overview}

Nielsen IMA Handler è un&#39;estensione di analisi in Adobe Real-time Customer Data Platform.
...
![Estensione gestore Nielsen IMA](assets/nielsen-ima-extension.png)
...
Per installare l’estensione del gestore Nielsen IMA:
