...
description: L’estensione Beemray è una destinazione di personalizzazione in Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
seo-description: L’estensione Beemray è una destinazione di personalizzazione in Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
[!DNL Beemray] consente di accelerare il prodotto con il contesto situazionale. Consentendoti di acquisire informazioni, creare nuove esperienze, stimolare le interazioni e interagire con momenti davvero importanti. Beemray automatizza l&#39;intelligenza contestuale utilizzando l&#39;apprendimento automatico. Beemray si collega ad Adobe Experience Cloud e agli altri partner tecnologici. Tutto ha luogo in tempo reale. Questa estensione installa [!DNL Beemray] l’SDK sul sito.

Beemray è un’estensione di personalizzazione in Adobe Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell&#39;estensione in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101063.beemray-human-context.html).
...
Per installare l’ [!DNL Beemray] estensione:
