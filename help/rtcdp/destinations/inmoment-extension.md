...
description: L’estensione InMoment è una destinazione di sondaggio nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell'estensione in Adobe Exchange.
...
# Estensione InMoment {#inmoment-extension}

## Panoramica {#overview}

L&#39;integrazione di Launch InMoment consente di abilitare rapidamente e facilmente il feedback online tramite il prodotto Digital Intercept. Nell&#39;app, le intercettazioni possono essere configurate e gestite tramite l&#39;amministratore di CXI Cloud, consentendo ai manager CX di avere un maggiore controllo sul loro programma.

InMoment è un’estensione del sondaggio nella piattaforma dati cliente Adobe in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell&#39;estensione in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100847.html).
...
![Estensione in ingresso](/help/rtcdp/destinations/assets/inmoment-extension.png)
...
Per installare l’estensione InMoment:
...
Per informazioni sulle opzioni di configurazione dell&#39;estensione, consultate la pagina [dell&#39;estensione](https://exchange.adobe.com/experiencecloud.details.100847.html) Google Universal Analytics in Adobe Exchange.
