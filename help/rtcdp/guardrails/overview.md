...
* [Guardrail per  [!DNL Edge Network Server API]](/help/server-api/guardrails.md)
...
* [Tutte le descrizioni dei prodotti di Adobe](https://helpx.adobe.com/it/legal/product-descriptions.html)
