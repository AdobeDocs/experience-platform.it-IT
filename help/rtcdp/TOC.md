...
* Introduzione {#intro}
   ...
   * [MCP REAL-TIME CDP](rtcdp-mcp.md)
...
* Schemi {#schemas}
   * [Panoramica degli schemi](schemas/overview.md)
...
* Casi d’uso {#use-cases}
   ...
   * [Sfruttare i casi di utilizzo dell’esperienza del cliente per promuovere gli obiettivi aziendali](/help/rtcdp/use-case-guides/business-use-case-framework.md)
