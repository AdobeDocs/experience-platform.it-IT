...
| Numero massimo di attributi mappati a una destinazione di personalizzazione per sandbox | 20 | Rigido | È possibile mappare un massimo di 20 attributi in un flusso di dati a una destinazione di personalizzazione, per sandbox. |
