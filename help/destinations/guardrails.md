...
| Numero massimo di attributi mappati a una destinazione di personalizzazione per sandbox | 30 | Duro | È possibile mappare un massimo di 30 attributi in un flusso di dati a una destinazione di personalizzazione, per sandbox. |
