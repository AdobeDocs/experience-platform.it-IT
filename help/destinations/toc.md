...
* Funzionamento delle destinazioni {#how-destinations-work}
   ...
   * [Ciclo di vita del pubblico nelle destinazioni di streaming](./how-destinations-work/audience-lifecycle-streaming-destinations.md)
...
* Guide dell’interfaccia utente {#ui}
   ...
   * Attivare i dati nelle destinazioni{#activate}
      ...
      * [Estendere le pianificazioni di esportazione dei set di dati per i flussi di dati creati prima di novembre 2024](./ui/dataset-expiration-update.md)
   ...
   * [Modificare le destinazioni](./ui/edit-destination.md)
...
* Catalogo delle destinazioni {#catalog}
   ...
   * Destinazioni di Adobe{#adobe}
      ...
      * [Connessione Marketo Engage](./catalog/adobe/marketo-engage-connection.md)
      * [(Legacy) (V2) Connessione Marketo Engage](./catalog/adobe/marketo-engage.md)
      * [Connessione Marketo Engage Person Sync](./catalog/adobe/marketo-engage-person-sync.md)
   ...
   * Destinazioni di Advertising{#advertising}
      ...
      * [Connessione pubblico Acxiom RealID](./catalog/advertising/acxiom-real-id-audience-connection.md)
      * [Panoramica sulle destinazioni di Advertising](./catalog/advertising/overview.md)
      * [Connessione Adobe Advertising DSP](./catalog/advertising/adobe-advertising-dsp-connection.md)
      * [Connessione Adobe Advertising DSP legacy](./catalog/advertising/adobe-advertising-cloud-dsp-connection-legacy.md)
      * [Estensione Adobe Advertising](./catalog/advertising/adobe-advertising-cloud.md)
      * [Adform connection](./catalog/advertising/adform.md)
      * [(Legacy) Connessione Amazon Ads](./catalog/advertising/amazon-ads.md)
      * [Connessione Amazon Ads v2](./catalog/advertising/amazon-ads-v2.md)
      ...
      * [Connessione Bombora](./catalog/advertising/bombora.md)
      ...
      * {hide-from-toc}[(Beta) Connessione FreeWheel](./catalog/advertising/freewheel.md)
      ...
      * [(Disponibilità limitata) Google Customer Match + connessione DV360](./catalog/advertising/google-customer-match-dv360.md)
      ...
      * [Connessione a Exchange indice](./catalog/advertising/index-exchange.md)
      * [Connessione Kevel](./catalog/advertising/kevel.md)
      ...
      * [Connessione Customer Match di Microsoft Ads](./catalog/advertising/microsoft-ads-customer-match.md)
      ...
      * [(Beta) Collegamento Reddit Custom Audience](./catalog/advertising/reddit-custom-audience.md)
      * [Connessione Rokt](./catalog/advertising/rokt.md)
   ...
   * Destinazioni di archiviazione cloud {#cloud-storage}
      ...
      * [Connessione BLOB Azure](./catalog/cloud-storage/azure-blob.md)
   ...
   * Destinazioni di e-mail marketing {#email-marketing}
      ...
      * [(API) Connessione Oracle Eloqua](./catalog/email-marketing/oracle-eloqua-api.md)
      * [(File) Connessione Oracle Eloqua](./catalog/email-marketing/oracle-eloqua.md)
   ...
   * Destinazioni social{#social}
      ...
      * [(Aziende) LinkedIn - Connessione tipi di pubblico corrispondenti](./catalog/social/linkedin-b2b.md)
      * [LinkedIn - Connessione tipi di pubblico corrispondenti](./catalog/social/linkedin.md)
   ...
   * Destinazioni di streaming {#streaming}
      ...
      * [Indirizzo IP per le destinazioni di streaming](./catalog/streaming/ip-address-allow-list.md)
...
* Destination SDK {#destination-sdk}
   ...
   * Guide {#guides}
      ...
      * Configurare destinazioni basate su file {#configure-file-based-destinations}
         ...
         * [Configurare una destinazione di archiviazione BLOB di Azure con opzioni di formattazione del file personalizzate e configurazione del nome file personalizzato](../destinations/destination-sdk/guides/batch/configure-blob-destination-with-custom-file-formatting.md)
         * [Configurare una destinazione di Azure Data Lake Storage con opzioni di formattazione del file personalizzate e configurazione del nome file personalizzato](../destinations/destination-sdk/guides/batch/configure-adls-destination-with-custom-file-formatting.md)
