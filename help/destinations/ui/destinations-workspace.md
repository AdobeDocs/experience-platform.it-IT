...
Le schede di destinazione contengono opzioni di controllo primarie e secondarie. I controlli principali includono [!UICONTROL Configurazione], [!UICONTROL Attiva], [!UICONTROL Attivare segmenti], o [!UICONTROL Esportare i set di dati]. I controlli secondari consentono di visualizzare le opzioni. Questi controlli sono descritti di seguito:

| control | Descrizione |
|---------|----------|
| [!UICONTROL Configurazione] | Consente di creare una connessione alla destinazione. |
| [!UICONTROL Attiva] | Dopo aver stabilito una connessione alla destinazione, puoi attivare i segmenti o esportare i set di dati in questa destinazione. |
| [!UICONTROL Attivare segmenti] | Dopo aver stabilito una connessione alla destinazione, puoi attivare i segmenti in questa destinazione. |
...
>[!TIP]
>
> * Seleziona i puntini di sospensione (`...`) in [!UICONTROL Piattaforma] e utilizza la ![Attiva controllo](../assets/ui/workspace/add-data-symbol.png)**[!UICONTROL Attiva ]**/**[!UICONTROL  Attivare segmenti ]**/**[!UICONTROL  Esportare i set di dati ]**per esportare segmenti o set di dati in tale destinazione.
...
Il **[!UICONTROL Sfoglia]** Questa scheda mostra le destinazioni con le quali hai stabilito una connessione. Destinazioni con **[!UICONTROL Abilitato/Disabilitato]** attiva/disattiva, imposta la destinazione rispettivamente su attiva o inattiva. Puoi anche visualizzare le destinazioni in cui i dati scorrono selezionando **[!UICONTROL Segmenti]** > **[!UICONTROL Sfoglia]** e selezionando un segmento da ispezionare. Vedi la tabella seguente per tutte le informazioni fornite per ciascuna destinazione nel [!UICONTROL Sfoglia] scheda:

>[!TIP]
>
> * Seleziona i puntini di sospensione (`...`) in [!UICONTROL Nome] e utilizza la ![Attiva controllo segmenti](../assets/ui/workspace/add-data-symbol.png)**[!UICONTROL Attiva ]**per esportare segmenti o set di dati in tale destinazione.
...
Seleziona il nome della destinazione per visualizzare informazioni sui segmenti attivati in questa destinazione. Clic **[!UICONTROL Modifica attivazione]** per modificare o aggiungere ai segmenti inviati a questa destinazione.
