...
Seleziona una delle destinazioni visualizzate sulla pagina e fai clic su **[!UICONTROL Visualizza flussi di dati]** per visualizzare informazioni su tutte le connessioni configurate per ogni destinazione.
