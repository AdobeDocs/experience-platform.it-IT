...
* Output di esempio con **[!UICONTROL Stringa vuota]** selezionata: `male,,TestLastName`. In questo caso, l’Experience Platform mantiene il valore vuoto e lo esporta così com’è (senza virgolette doppie).
