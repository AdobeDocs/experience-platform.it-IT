...
1. In **[!UICONTROL Seleziona campo]** seleziona gli attributi XDM o i namespace di identità da inviare alla destinazione, quindi scegli **[!UICONTROL Seleziona]**.
...
![Riepilogo della selezione nella fase di revisione.](/help/destinations/assets/ui/activate-batch-profile-destinations/review.png)
...
![Registrazione su schermo che mostra i filtri di segmento disponibili nel passaggio di revisione.](/help/destinations/assets/ui/activate-batch-profile-destinations/filter-segments-batch-review.gif)
...
Per le destinazioni di e-mail marketing e di cloud storage, Adobe Experience Platform crea un `.csv` nel percorso di archiviazione fornito. Attendi la creazione di un nuovo file nel percorso di archiviazione in base alla pianificazione impostata nel flusso di lavoro. Il formato predefinito del file è mostrato di seguito, ma è possibile [modifica i componenti del nome file](#file-names):
