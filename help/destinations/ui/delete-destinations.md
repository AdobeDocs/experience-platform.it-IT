...
Nell&#39;interfaccia utente di [!DNL Adobe Experience Platform], è possibile eliminare le connessioni esistenti alle destinazioni.
...
* [Elimina destinazioni dalla scheda [!UICONTROL Browse]](#delete-browse-tab)
...
3. Selezionare il pulsante ![Altro](/help/images/icons/more.png) nella colonna Nome, quindi selezionare ![Elimina](/help/images/icons/delete.png) **[!UICONTROL Delete]** per rimuovere una connessione di destinazione esistente.
   ![Elimina destinazioni](../assets/ui/delete-destinations/delete-destinations.png)

4. Selezionare **[!UICONTROL Delete]** per confermare la rimozione della connessione di destinazione.
...
5. Selezionare **[!UICONTROL Delete]** nella finestra di dialogo di conferma per rimuovere la destinazione.
