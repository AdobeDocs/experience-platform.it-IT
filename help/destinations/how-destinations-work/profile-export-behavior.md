...
Le [destinazioni Enterprise](/help/destinations/destination-types.md#streaming-profile-export) in Experience Platform sono Amazon Kinesis, Azure Event Hub e API HTTP.
