---
description: Questa pagina elenca e descrive tutte le operazioni API che è possibile eseguire utilizzando l’endpoint API "/authoring/testing/destinationInstance/", per verificare se la destinazione è configurata correttamente e per verificare l’integrità dei flussi di dati alla destinazione configurata.
title: Operazioni API di test della destinazione
...
# Operazioni API di test della destinazione {#template-api-operations}
...
| -------- | ----------- |
| `aggregationKey` | Include informazioni sui criteri di aggregazione configurati per la destinazione. Per ulteriori informazioni, leggere [Criterio di aggregazione](./destination-configuration.md#aggregation) nel documento di configurazione di destinazione. |
