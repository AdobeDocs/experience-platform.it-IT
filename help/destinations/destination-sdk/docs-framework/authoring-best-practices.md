...
In questa pagina sono descritte le regole da seguire per [creare la pagina della documentazione di destinazione](./documentation-instructions.md), per assicurarsi che soddisfi gli standard di qualità della documentazione di [!DNL Adobe Experience Platform].
...
* AEP non è un termine pubblico approvato. Utilizza [!DNL Adobe Experience Platform] al primo utilizzo, quindi Experience Platform e Experience Platform.
   ...
   * **Utilizza**: prima di esportare i dati da [!DNL Adobe Experience Platform] a YourDestination, assicurati di aver letto e completato questi prerequisiti.
