...
1. Nel fork dell’archivio, crea un nuovo ramo per il progetto, come illustrato di seguito. Utilizza questo nuovo ramo per il tuo lavoro.

   ![Crea nuovo ramo GitHub](../assets/docs-framework/new-branch-github.gif)

1. Nella struttura di cartelle GitHub dell&#39;archivio con fork, passa a `experience-platform.en/help/destinations/catalog/[...]`, dove `[...]` è la categoria desiderata per la destinazione. Ad esempio, se stai aggiungendo una destinazione di personalizzazione ad Experience Platform, seleziona la categoria `personalization`. Selezionare **Aggiungi file > Crea nuovo file**.
...
1. Incolla e modifica il contenuto del modello con le informazioni rilevanti per la destinazione in un editor markdown online, ad esempio [dillinger.io](https://dillinger.io/). Seguire le istruzioni nel modello per i dettagli su cosa compilare e quali paragrafi possono essere rimossi.
...
1. Quando sei pronto, salva il file nel ramo.
