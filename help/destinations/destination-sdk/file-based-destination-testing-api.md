...
Se stai costruendo una destinazione pubblica, ora puoi [invia la configurazione di destinazione](../destination-sdk/submit-destination.md) all&#39;Adobe per la revisione.