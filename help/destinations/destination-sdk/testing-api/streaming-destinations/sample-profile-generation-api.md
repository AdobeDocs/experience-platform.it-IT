...
>[!IMPORTANT]
>
>Utilizza i profili di esempio generati qui durante la creazione del modello, nel [passaggio del modello di rendering](render-template-api.md#configurable-aggregation).
