...
È possibile configurare la funzionalità descritta in questo documento utilizzando `/authoring/audience-templates` Endpoint API Letto [Operazioni API per endpoint metadati pubblico](./audience-metadata-api.md) per un elenco completo delle operazioni che è possibile eseguire sull&#39;endpoint.
...
Trova le descrizioni di tutti i parametri nel modello nella documentazione di riferimento. [Operazioni API per endpoint metadati pubblico](./audience-metadata-api.md).
