...
# Configurare un [!DNL Azure Blob Storage] destinazione con opzioni di formattazione file personalizzate e configurazione del nome file personalizzato

## Panoramica {#overview}

Questa pagina descrive come utilizzare Destination SDK per configurare un [!DNL Azure Blob Storage] destinazione con personalizzato [opzioni di formattazione file](../../server-and-file-configuration.md#file-configuration) e un personalizzato [configurazione del nome file](../../file-based-destination-configuration.md#file-name-configuration).
...
Iniziare utilizzando `/destination-server` per creare una configurazione di server e file. Per descrizioni dettagliate dei parametri nella richiesta HTTP, leggi [specifiche di configurazione di server e file per destinazioni basate su file](../../server-and-file-configuration.md#blob-example) e il relativo [configurazioni di formattazione dei file](../../server-and-file-configuration.md#file-configuration).
...
Il payload seguente include una configurazione BLOB di Azure generica, con [Formattazione file CSV](../../server-and-file-configuration.md#file-configuration) parametri di configurazione che gli utenti possono definire nell’interfaccia utente di Experience Platform.
...
![Registrazione schermata che mostra la pagina del catalogo delle destinazioni con una scheda di destinazione selezionata.](../../assets/blob-destination-card.gif)
...
Leggendo questo articolo, ora sai come creare un personalizzato [!DNL Azure Blob Storage] destinazione utilizzando Destination SDK. Successivamente, il tuo team può utilizzare [flusso di lavoro di attivazione per destinazioni basate su file](../../../ui/activate-batch-profile-destinations.md) per esportare i dati nella destinazione.
