---
description: Scopri come utilizzare Destination SDK per configurare una destinazione Amazon S3 con un nome file personalizzato e opzioni di formattazione.
title: Configura una destinazione Amazon S3 con nome file personalizzato e opzioni di formattazione.
...
# Configurare una destinazione Amazon S3 con nome file personalizzato e opzioni di formattazione

## Panoramica {#overview}

Questa pagina descrive come utilizzare Destination SDK per configurare una destinazione Amazon S3 con [opzioni di formattazione file](/help/destinations/destination-sdk/server-and-file-configuration.md#file-configuration) e un personalizzato [configurazione del nome file](/help/destinations/destination-sdk/file-based-destination-configuration.md#file-name-configuration).
...
Prima di procedere con i passaggi descritti di seguito, leggere la [Destination SDK introduzione](/help/destinations/destination-sdk/getting-started.md) per informazioni su come ottenere le credenziali di autenticazione Adobe I/O necessarie e altri prerequisiti per lavorare con le API Destination SDK.

## Passaggio 1: creare una configurazione di server e file {#create-server-file-configuration}

Iniziare utilizzando `/destination-server` per creare una configurazione di server e file. Per descrizioni dettagliate dei parametri nella richiesta HTTP, leggi [specifiche di configurazione di server e file per destinazioni basate su file](/help/destinations/destination-sdk/server-and-file-configuration.md#s3-example) e il relativo [configurazioni di formattazione dei file](/help/destinations/destination-sdk/server-and-file-configuration.md#file-configuration).
...
Il payload seguente include una configurazione Amazon S3 generica, con [Formattazione file CSV](/help/destinations/destination-sdk/server-and-file-configuration.md#file-configuration) parametri di configurazione che gli utenti possono definire nell’interfaccia utente di Experience Platform.
...
Per le descrizioni dettagliate dei parametri utilizzati di seguito, vedi le pagine seguenti:
...
* [Operazioni API di configurazione di destinazione basate su file](/help/destinations/destination-sdk/destination-configuration-api.md#create-file-based)
...
![Registrazione schermata che mostra la pagina del catalogo delle destinazioni con una scheda di destinazione selezionata.](../../assets/destination-card.gif)
...
Dopo aver configurato la destinazione, utilizza [API di pubblicazione della destinazione](/help/destinations/destination-sdk/destination-publish-api.md) per inviare la configurazione all&#39;Adobe per la revisione.
