...
Questa pagina descrive come utilizzare Destination SDK per configurare una destinazione Amazon S3 con [opzioni di formattazione file](configure-file-formatting-options.md) e un personalizzato [configurazione del nome file](../../functionality/destination-configuration/batch-configuration.md#file-name-configuration).
