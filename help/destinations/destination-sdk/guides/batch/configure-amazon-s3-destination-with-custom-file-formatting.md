...
title: Configura una destinazione Amazon S3 con il nome file personalizzato e le opzioni di formattazione.
...
Questa pagina descrive come utilizzare Destination SDK per configurare una destinazione Amazon S3 personalizzata [opzioni di formattazione dei file](configure-file-formatting-options.md) e una [configurazione del nome file](../../functionality/destination-configuration/batch-configuration.md#file-name-configuration).
...
Il payload riportato di seguito include una configurazione Amazon S3 generica, con [Formattazione file CSV](../../functionality/destination-server/file-formatting.md) parametri di configurazione che gli utenti possono definire nell’interfaccia utente di Experience Platform.
...
![Registrazione su schermo che mostra la pagina del catalogo delle destinazioni con una scheda di destinazione selezionata.](../../assets/guides/batch/destination-card.gif)
