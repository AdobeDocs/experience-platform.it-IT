...
Questa pagina descrive come utilizzare Destination SDK per configurare una destinazione SFTP con una destinazione predefinita [opzioni di formattazione file](../../server-and-file-configuration.md#file-configuration) e un personalizzato [configurazione del nome file](../../file-based-destination-configuration.md#file-name-configuration).
...
Iniziare utilizzando `/destination-server` per creare una configurazione di server e file. Per descrizioni dettagliate dei parametri nella richiesta HTTP, leggi [specifiche di configurazione di server e file per destinazioni basate su file](../../server-and-file-configuration.md#sftp-example) e il relativo [configurazioni di formattazione dei file](../../server-and-file-configuration.md#file-configuration).
...
Il payload seguente include una configurazione SFTP generica, con impostazioni predefinite [Formattazione file CSV](../../server-and-file-configuration.md#file-configuration) parametri di configurazione che gli utenti possono definire nell’interfaccia utente di Experience Platform.
