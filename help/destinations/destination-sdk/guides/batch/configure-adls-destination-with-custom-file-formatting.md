...
Questa pagina descrive come utilizzare Destination SDK per configurare un [!DNL Azure Data Lake Storage] destinazione con personalizzato [opzioni di formattazione file](../../server-and-file-configuration.md#file-configuration) e un personalizzato [configurazione del nome file](../../file-based-destination-configuration.md#file-name-configuration).
...
Il payload riportato di seguito include un generico [!DNL Azure Data Lake Storage] configurazione, con [Formattazione file CSV](../../server-and-file-configuration.md#file-configuration) parametri di configurazione che gli utenti possono definire nell’interfaccia utente di Experience Platform.
...
![Registrazione schermata che mostra la pagina del catalogo delle destinazioni con una scheda di destinazione selezionata.](../../assets/adls-destination-card.gif)
