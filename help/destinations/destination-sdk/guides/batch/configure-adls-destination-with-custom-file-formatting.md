---
description: Scopri come utilizzare Destination SDK per configurare una destinazione Azure Data Lake Storage con opzioni di formattazione dei file personalizzate e la configurazione del nome file personalizzato.
title: Configura una destinazione Azure Data Lake Storage con opzioni di formattazione file personalizzate e configurazione del nome file personalizzato.
...
# Configura un [!DNL Azure Data Lake Storage] destinazione con opzioni di formattazione file personalizzate e configurazione del nome file personalizzato

## Panoramica {#overview}

Questa pagina descrive come utilizzare Destination SDK per configurare un [!DNL Azure Data Lake Storage] destinazione con personalizzato [opzioni di formattazione dei file](configure-file-formatting-options.md) e una [configurazione del nome file](../../functionality/destination-configuration/batch-configuration.md#file-name-configuration).

Questa pagina mostra tutte le opzioni di configurazione disponibili per le destinazioni di Azure Data Lake Storage. Puoi modificare le configurazioni mostrate nei passaggi seguenti o eliminare alcune parti delle configurazioni, in base alle esigenze.

Per una descrizione dettagliata dei parametri utilizzati di seguito, vedi [opzioni di configurazione nell’SDK delle destinazioni](../../functionality/configuration-options.md).
...
Inizia utilizzando `/destination-server` endpoint a [creare una configurazione server e file](../../authoring-api/destination-server/create-destination-server.md).
...
Il payload seguente include un [!DNL Azure Data Lake Storage] configurazione, con [Formattazione file CSV](../../functionality/destination-server/file-formatting.md) parametri di configurazione che gli utenti possono definire nell’interfaccia utente di Experience Platform.
...
![Registrazione su schermo che mostra la pagina del catalogo delle destinazioni con una scheda di destinazione selezionata.](../../assets/guides/batch/adls-destination-card.gif)

Nelle immagini e nelle registrazioni seguenti, tieni presente come le opzioni nel [flusso di lavoro di attivazione per destinazioni basate su file](../../../ui/activate-batch-profile-destinations.md) corrispondono alle opzioni selezionate nella configurazione di destinazione.
...
Dopo aver configurato la destinazione, utilizza la [API di pubblicazione della destinazione](../../publishing-api/create-publishing-request.md) per inviare la configurazione ad Adobe per la revisione.
...
Leggendo questo articolo, ora sai come creare un [!DNL Azure Data Lake Storage] destinazione utilizzando la Destination SDK. Successivamente, il team può utilizzare [flusso di lavoro di attivazione per destinazioni basate su file](../../../ui/activate-batch-profile-destinations.md) per esportare i dati nella destinazione.
