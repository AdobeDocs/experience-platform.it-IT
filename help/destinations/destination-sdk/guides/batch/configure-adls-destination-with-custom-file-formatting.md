...
title: (Beta) Configura una destinazione Azure Data Lake Storage con opzioni di formattazione dei file personalizzate e configurazione del nome file personalizzato.
...
# (Beta) Configura un [!DNL Azure Data Lake Storage] destinazione con opzioni di formattazione file personalizzate e configurazione del nome file personalizzato
...
Questa pagina descrive come utilizzare Destination SDK per configurare un [!DNL Azure Data Lake Storage] destinazione con personalizzato [opzioni di formattazione dei file](../../server-and-file-configuration.md#file-configuration) e una [configurazione del nome file](../../file-based-destination-configuration.md#file-name-configuration).
...
Il payload seguente include un [!DNL Azure Data Lake Storage] configurazione, con [Formattazione file CSV](../../server-and-file-configuration.md#file-configuration) parametri di configurazione che gli utenti possono definire nell’interfaccia utente di Experience Platform.
...
![Registrazione su schermo che mostra la pagina del catalogo delle destinazioni con una scheda di destinazione selezionata.](../../assets/adls-destination-card.gif)
