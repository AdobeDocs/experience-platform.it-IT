...
* Ogni opzione di formattazione del file disponibile è documentata a lungo in [configurazione della formattazione dei file](../../server-and-file-configuration.md#file-configuration) sezione .
* Completa i passaggi per [configurare una destinazione basata su file](/help/destinations/destination-sdk/configure-file-based-destination-instructions.md) utilizzando Destination SDK.
...
>[!TIP]
>
>Come promemoria, tutte le opzioni di formattazione disponibili sono documentate in [configurazione della formattazione dei file](../../server-and-file-configuration.md#file-configuration) sezione .
...
![Registrazione su schermo che mostra varie opzioni di formattazione per i file batch.](/help/destinations/destination-sdk/assets/guides/batch/file-formatting-options.gif)
...
![Registrazione su schermo che mostra un esempio di selettori a discesa creati con la configurazione mostrata sopra.](/help/destinations/destination-sdk/assets/guides/batch/dropdown-options-file-formatting.gif)
...
![Registrazione su schermo che mostra l’opzione di formattazione condizionale dei file CSV.](/help/destinations/destination-sdk/assets/guides/batch/conditional-file-formatting.gif)
