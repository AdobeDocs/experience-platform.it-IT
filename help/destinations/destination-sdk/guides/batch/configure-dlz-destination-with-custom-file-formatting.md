...
Questa pagina descrive come utilizzare Destination SDK per configurare un [!DNL Data Landing Zone] destinazione con personalizzato [opzioni di formattazione file](configure-file-formatting-options.md) e un personalizzato [configurazione del nome file](../../functionality/destination-configuration/batch-configuration.md#file-name-configuration).
