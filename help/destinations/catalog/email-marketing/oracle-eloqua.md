...
Per inviare i dati del pubblico a [!DNL Oracle Eloqua], devi prima [connettere la destinazione](#connect-destination) in [!DNL Adobe Experience Platform], quindi [configurare un&#39;importazione dati](#import-data-into-eloqua) dal percorso di archiviazione in [!DNL Oracle Eloqua].
