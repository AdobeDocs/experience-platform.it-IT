...
Per inviare segmenti alle destinazioni di marketing tramite e-mail per le campagne, CDP in tempo reale deve prima connettersi alla destinazione.
...
Per ulteriori informazioni su questo passaggio, consulta il passaggio [Seleziona attributi](../../ui/activate-destinations.md#select-attributes) nell’esercitazione di attivazione delle destinazioni.
...
Per istruzioni su come attivare i segmenti nelle destinazioni di marketing tramite e-mail, vedi [Attivare i dati sulle destinazioni](../../ui/activate-destinations.md).
