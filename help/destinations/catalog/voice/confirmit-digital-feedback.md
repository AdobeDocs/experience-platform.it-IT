...
description: L’estensione Conferma feedback digitale è una voce della destinazione del cliente in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell’estensione, consulta la pagina dell’estensione in Adobe Exchange.
...
[!DNL Confirmit Digital Feedback] Questa soluzione ti aiuta a trasformare il traffico del tuo sito web in informazioni in tempo reale. Con [!DNL Confirmit], possono essere visualizzati sondaggi discreti e altamente mirati in base alle tue esigenze, per incoraggiare i visitatori a fornire feedback, ad esempio:

* Feedback sul sito web
* Soddisfazione delle transazioni
* Motivo intento di uscita
* Informazioni sull’abbandono del carrello
* Soddisfazione generale dei clienti
* E molto altro ancora

[!DNL Confirmit] Digital Feedback è una voce dell’estensione per i clienti in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell&#39;estensione, consulta la pagina dell&#39;estensione in [Scambio Adobe](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html).
...
![Conferma estensione feedback digitale](../../assets/catalog/voice/confirmit-digital-feedback/catalog.png)
...
Per installare [!DNL Confirmit] Estensione feedback digitale:
...
Per informazioni sulle opzioni di configurazione dell’estensione e sul supporto per l’installazione, consulta [Conferma la pagina del feedback digitale su Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html).
