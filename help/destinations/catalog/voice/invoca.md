...
title: Estensione tag Invoca
description: L’estensione Invoca Tags è una voce della destinazione del cliente in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell’estensione, consulta la pagina dell’estensione su Adobe Exchange.
...
# Estensione [!DNL Invoca Tags] {#invoca-extension}

## Panoramica {#overview}

[!DNL Invoca] inserisce dati sulle chiamate e approfondimenti vocali nel percorso dei clienti digitali. Con la piattaforma di call intelligence [!DNL Invoca’s], gli addetti al marketing dispongono infine di analisi per misurare i risultati delle chiamate e collegare le conversioni offline alla spesa digitale.

[!DNL Invoca Tags] è una voce dell&#39;estensione cliente in [!DNL Adobe Experience Platform]. Per ulteriori informazioni sulla funzionalità dell&#39;estensione, vedere la pagina dell&#39;estensione in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100067.invoca.html).
...
![Estensione Invoca](../../assets/catalog/voice/invoca/catalog.png)
...
Per installare l&#39;estensione [!DNL Invoca Tags]:
...
Per informazioni sulle opzioni di configurazione dell&#39;estensione e sul supporto per l&#39;installazione, vedere la pagina [Tag Invoca in Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100067.invoca.html).
