...
Utilizzare la destinazione [!DNL RainFocus Attendee Profiles] per eseguire lo streaming dei profili cliente da Adobe Experience Platform alla piattaforma [!DNL RainFocus] per creare e aggiornare i profili dei partecipanti.
...
* **[!UICONTROL ID client]**: compilare [!DNL Client ID] fornito dal profilo API RainFocus.
* **[!UICONTROL Segreto client]**: compilare [!DNL Client Secret] fornito dal profilo API RainFocus.
* **[!UICONTROL Ambiente]**: specificare l&#39;ambiente RainFocus a cui ci si connette, ad esempio `dev`, `prod`.
* **[!UICONTROL ID organizzazione]**: fornisci `orgid` univoco per l&#39;istanza di RainFocus.
...
* **[!UICONTROL ID evento]**: l&#39;identificatore del codice evento [!DNL RainFocus] in cui si desidera inviare i profili.
