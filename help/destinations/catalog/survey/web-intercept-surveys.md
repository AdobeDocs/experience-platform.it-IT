...
description: L'estensione QuestionPro Intercept Surveys è una destinazione di sondaggio in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell’estensione, consulta la pagina dell’estensione in Adobe Exchange.
...
[!DNL QuestionPro Intercept Surveys] è una piattaforma per la distribuzione di sondaggi e la raccolta di dati attitudinali nel punto della transazione o quando gli utenti entrano/escono dal sito web.

[!DNL QuestionPro Intercept Surveys] è un’estensione di sondaggio in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell&#39;estensione, consulta la pagina dell&#39;estensione in [Scambio Adobe](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html).
...
![Estensione dei sondaggi Intercept QuestionPro](../../assets/catalog/survey/web-intercept-surveys/catalog.png)
...
Per installare [!DNL QuestionPro Intercept Surveys] estensione:
...
Per informazioni sulle opzioni di configurazione dell’estensione e sul supporto per l’installazione, consulta [Pagina Indagini Intercept QuestionPro su Scambio Adobe](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html).
