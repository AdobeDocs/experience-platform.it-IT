...
title: Estensione QuestionPro Intercept Surveys
description: L'estensione QuestionPro Intercept Surveys è una destinazione di sondaggio in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell’estensione, consulta la pagina dell’estensione su Adobe Exchange.
...
# Estensione [!DNL QuestionPro Intercept Surveys] {#questionpro-extension}

## Panoramica {#overview}

[!DNL QuestionPro Intercept Surveys] è una piattaforma per la distribuzione di sondaggi e la raccolta di dati comportamentali nel punto di transazione o quando gli utenti accedono o escono dal sito Web.

[!DNL QuestionPro Intercept Surveys] è un&#39;estensione del sondaggio in [!DNL Adobe Experience Platform]. Per ulteriori informazioni sulla funzionalità dell&#39;estensione, vedere la pagina dell&#39;estensione in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html).
...
![Estensione Intercept Surveys di QuestionPro](../../assets/catalog/survey/web-intercept-surveys/catalog.png)
...
Per informazioni sulle opzioni di configurazione dell&#39;estensione e sul supporto per l&#39;installazione, vedere la pagina [Sondaggi sull&#39;intercettazione di QuestionPro in Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html).
