---
keywords: Qualtrics;qualtrics;qualtrics;Qualtrics Website Feedback;feedback sul sito web Qualtrics;feedback sul sito web Qualtricks;feedback sul sito web Qualtricks
title: Estensione Qualtrics Website Feedback
description: L’estensione Qualtrics Website Feedback è una destinazione dei sondaggi in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità di estensione, consulta la pagina dell'estensione in Adobe Exchange.
...
[!DNL Qualtrics Website Feedback] consente di interagire con i visitatori del sito web con il messaggio giusto al momento giusto. Se desideri migliorare l’esperienza dei visitatori con i sondaggi sul feedback del sito web o aumentare la conversione, [!DNL Qualtrics Website Feedback] ti offre informazioni utili.

Crea e implementa in pochi minuti messaggi web con brand altamente mirati tramite un’interfaccia intuitiva con un semplice clic. I dati e le informazioni raccolte dal sito web vengono visualizzati insieme ai dati di feedback dei clienti su tutti i canali, offrendo una visione completa dell’esperienza del cliente, il tutto su un’unica piattaforma.

[!DNL Qualtrics Website Feedback] è un’estensione del sondaggio in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità di estensione, consulta la pagina dell&#39;estensione in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).
...
![Estensione Qualtrics Website Feedback](../../assets/catalog/survey/qualtrics/catalog.png)
...
Per informazioni sulle opzioni di configurazione dell&#39;estensione e sul supporto dell&#39;installazione, consulta la pagina [Qualtrics Website Feedback su Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).
