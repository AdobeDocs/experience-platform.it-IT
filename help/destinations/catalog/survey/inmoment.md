---
keywords: InMoment;momento;InMomento;Avvia l'integrazione
title: Estensione InMoment
description: L’estensione InMoment è una destinazione di sondaggio in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità di estensione, consulta la pagina dell'estensione in Adobe Exchange.
...
L’ [!DNL InMoment] Launch Integration consente di abilitare in modo rapido e semplice il feedback online tramite il prodotto Digital Intercept. Nell’app, gli intercetti possono essere configurati e gestiti tramite l’amministratore Cloud di CXI, consentendo ai responsabili CX di controllare meglio il proprio programma.

[!DNL InMoment] è un’estensione del sondaggio in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità di estensione, consulta la pagina dell&#39;estensione in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100847.html).
...
![Estensione in ingresso](../../assets/catalog/survey/inmoment/catalog.png)
...
Per informazioni sulle opzioni di configurazione dell&#39;estensione, consulta la [pagina dell&#39;estensione Google Universal Analytics](https://exchange.adobe.com/experiencecloud.details.100847.html) in Adobe Exchange.
