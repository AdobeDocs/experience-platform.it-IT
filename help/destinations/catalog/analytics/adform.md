...
title: Estensione di tracciamento dei siti web di Adobe
description: L'estensione Adform è una destinazione di analisi in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità di estensione, consulta la pagina dell'estensione in Adobe Exchange.
...
# Estensione di tracciamento dei siti web di Adobe {#adform-extension}

## Panoramica {#overview}

L’estensione Adform Website Tracking consente agli inserzionisti di implementare facilmente punti di tracciamento Adform nei loro siti tramite la piattaforma [!DNL Experience Platform Launch] .

[!DNL Adform] è un&#39;estensione analytics in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità di estensione, consulta la pagina dell&#39;estensione in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103195.adform-website-tracking.html)
...
Per informazioni sulle opzioni di configurazione dell&#39;estensione e sul supporto dell&#39;installazione, consulta la pagina [Adform su Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103195.adform-website-tracking.html).
