...
title: Estensione di tracciamento del sito web Adform
description: L'estensione Adform è una destinazione di analisi in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell’estensione, consulta la pagina dell’estensione su Adobe Exchange.
...
# Estensione di tracciamento del sito web Adform {#adform-extension}

## Panoramica {#overview}

L’estensione Adform Website Tracking consente agli inserzionisti di implementare facilmente Adform Tracking Points nei loro siti.

[!DNL Adform] è un&#39;estensione di analytics in [!DNL Adobe Experience Platform]. Per ulteriori informazioni sulla funzionalità dell&#39;estensione, vedere la pagina dell&#39;estensione in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103195.adform-website-tracking.html)
...
![Estensione Adform](../../assets/catalog/analytics/adform/catalog.png)
...
Per installare l’estensione Adform:
...
Per informazioni sulle opzioni di configurazione dell&#39;estensione e sul supporto per l&#39;installazione, vedere la [pagina Adform in Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103195.adform-website-tracking.html).
