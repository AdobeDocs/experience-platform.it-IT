...
[!DNL Quantum Metric's] l’integrazione con Adobe Launch facilita la distribuzione senza codice dei tag di raccolta  [!DNL Quantum Metric's] dati. Inoltre, questa estensione offre la possibilità di acquisire elementi dati Launch contenenti informazioni utili dall’ API [!DNL Quantum Metric].
