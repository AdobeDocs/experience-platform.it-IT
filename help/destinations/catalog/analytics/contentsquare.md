---
keywords: estensione contentsquare;destinazione contentsquare;contentsquare
title: Estensione Contentsquare
description: L’estensione Contentsquare è una destinazione di analisi in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità di estensione, consulta la pagina dell'estensione in Adobe Exchange.
...
Visualizzare i comportamenti nella pagina, vedere PERCHÉ i clienti abbandonano e COME migliorare. Attributo di ricavi a UX ed elementi di contenuto per ogni segmento di Analytics e test di Target. Installa il tag [!DNL Contentsquare], imposta variabili ed eventi personalizzati. Inizia a raccogliere i dati per l’analisi UX in pochi clic.

[!DNL Contentsquare] è un&#39;estensione analytics in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità di estensione, consulta la pagina dell&#39;estensione in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100364.html).
...
Per informazioni sulle opzioni di configurazione dell&#39;estensione, consulta la [pagina dell&#39;estensione Contentsquare](https://exchange.adobe.com/experiencecloud.details.100364.html) in Adobe Exchange.
