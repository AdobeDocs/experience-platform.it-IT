...
description: L'estensione TMMData è una destinazione di analisi nella piattaforma dati cliente in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, vedere la pagina di estensione in  Adobe Exchange.
seo-description: L'estensione TMMData è una destinazione di analisi nella piattaforma dati cliente in tempo reale. Per ulteriori informazioni sulla funzionalità di estensione, vedere la pagina di estensione in  Adobe Exchange.
...
# [!DNL TMMData] Estensione {#tmmdata-extension}

## Panoramica {#overview}

[!DNL TMMData's] La piattaforma Foundation per Adobe Marketing Cloud offre ai team di marketing gli strumenti per accedere e fondere tutte le loro origini dati critiche - inclusi dati interni/esterni e online/off-line - per un&#39;analisi completa e sicura su più canali, con la configurazione automatica delle campagne e l&#39;importazione diretta di  Adobe e altri strumenti di analisi e BI.

[!DNL TMMData] è un&#39;estensione di analisi in Real-time Customer Data Platform. Per ulteriori informazioni sulla funzionalità di estensione, consultate la pagina dell&#39;estensione in [Adobe Exchange](hhttps://exchange.adobe.com/experiencecloud.details.100148.tmmdata-foundation-platform.html).
...
![Estensione TMMData](../../assets/catalog/analytics/tmmdata/catalog.png)
...
Per installare l’ [!DNL TMMData] estensione:
