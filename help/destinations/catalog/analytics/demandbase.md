...
description: L'estensione Demandbase è una destinazione di analisi in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell’estensione, consulta la pagina dell’estensione in Adobe Exchange.
...
Ottenere [!DNL Demandbase] Approfondimenti sull’account B2B direttamente in Adobe Analytics, dove puoi segmentare il traffico e il comportamento per settore, ricavi e account di destinazione. Questa vista basata sull’account fornisce informazioni univoche su coinvolgimento, conversione e sorgente dei visitatori più importanti.

[!DNL Demandbase] è un’estensione di analytics in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell&#39;estensione, consulta la pagina dell&#39;estensione in [Scambio Adobe](https://exchange.adobe.com/experiencecloud.details.101605.html).
...
Per installare [!DNL Demandbase] estensione:
...
Per informazioni sulle opzioni di configurazione dell&#39;estensione, vedi [Pagina dell’estensione Demandbase](https://exchange.adobe.com/experiencecloud.details.101605.html) in caso di scambio di Adobi.
