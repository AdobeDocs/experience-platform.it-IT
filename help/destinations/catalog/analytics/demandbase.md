...
description: L'estensione Demandbase è una destinazione di analisi in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell’estensione, consulta la pagina dell’estensione su Adobe Exchange.
...
# Estensione [!DNL Demandbase] {#demandbase-extension}

## Panoramica {#overview}

Ottieni informazioni sull&#39;account B2B [!DNL Demandbase] direttamente in Adobe Analytics, dove puoi segmentare il traffico e il comportamento per settore, ricavi e account di destinazione. Questa vista basata sull’account fornisce informazioni univoche su coinvolgimento, conversione e sorgente dei visitatori più importanti.

[!DNL Demandbase] è un&#39;estensione di Analytics in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell&#39;estensione, vedere la pagina dell&#39;estensione in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101605.html).
...
![Estensione Demandbase](../../assets/catalog/analytics/demandbase/catalog.png)
...
Per installare l&#39;estensione [!DNL Demandbase]:
...
Per informazioni sulle opzioni di configurazione dell&#39;estensione, vedere la [pagina dell&#39;estensione Demandbase](https://exchange.adobe.com/experiencecloud.details.101605.html) su Adobe Exchange.
