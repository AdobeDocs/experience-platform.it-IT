---
keywords: Gestore del lettore Nielsen VideoJS;lettore nielsen video js;lettore nielsen videojs;Nielsen;lettore Nielsen videojs;Nielsen Digital SDK;sdk digitale nielsen
title: Estensione del gestore del lettore Nielsen VideoJS
description: L’estensione del gestore del lettore Nielsen VideoJS è una destinazione di analisi in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell’estensione, consulta la pagina dell’estensione nell’Adobe Exchange.
...
# Estensione [!DNL Nielsen VideoJS Player Handler] {#nielsen-vjs-extension}

## Panoramica {#overview}

L&#39;estensione tag [!DNL Nielsen Digital SDK] offre la misurazione del pubblico tramite i seguenti prodotti di misurazione digitale:
...
[!DNL Nielsen VideoJS Player Handler] è un&#39;estensione di Analytics in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell&#39;estensione, vedere la pagina dell&#39;estensione nell&#39;[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.nielsen-digital-sdk-extension.html).
...
![Estensione gestore lettore Nielsen VideoJS](../../assets/catalog/analytics/nielsen-videojs/catalog.png)
...
Per informazioni sulle opzioni di configurazione dell&#39;estensione e sul supporto per l&#39;installazione, consulta la pagina [Nielsen Digital SDK all&#39;Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.nielsen-digital-sdk-extension.html).
