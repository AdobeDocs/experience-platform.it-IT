---
keywords: Analizza. ly;parso;parso;parse.ly;parse.ly
title: Estensione Parse.ly Analytics
description: L'estensione Parse.ly Analytics è una destinazione di analisi in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell’estensione, consulta la pagina dell’estensione nell’Adobe Exchange.
...
# Estensione [!DNL Parse.ly Analytics] {#parsely-analytics-extension}

## Panoramica {#overview}

[!DNL Parse.ly Analytics] consente a più di 2.500 aziende di utilizzare i dati per comprendere il proprio pubblico online. Questa estensione installa uno snippet JavaScript che tiene traccia di come i visitatori interagiscono con il contenuto del sito.

Parse.ly è un&#39;estensione di Analytics in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell&#39;estensione, vedere [Parse.ly Analytics](https://www.parse.ly/).
...
![Estensione Analytics Parse.ly](../../assets/catalog/analytics/parsely/catalog.png)
