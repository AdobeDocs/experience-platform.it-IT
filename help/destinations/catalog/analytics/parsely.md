...
description: L'estensione Parse.ly Analytics è una destinazione di analisi in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell’estensione, consulta la pagina dell’estensione in Adobe Exchange.
...
[!DNL Parse.ly Analytics] aiuta più di 2.500 aziende a utilizzare i dati per comprendere il proprio pubblico online. Questa estensione installa un frammento JavaScript che tiene traccia di come i visitatori interagiscono con il contenuto del sito.

Parse.ly è un&#39;estensione di Analytics in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell’estensione, consulta [Analisi.ly](https://www.parse.ly/).
...
Per installare [!DNL Parse.ly] estensione:
