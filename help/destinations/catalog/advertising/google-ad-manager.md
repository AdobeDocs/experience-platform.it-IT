...
* **[!UICONTROL Aggiungi ID pubblico al nome del pubblico]**: seleziona questa opzione per includere l&#39;ID pubblico di Experience Platform nel nome del pubblico in Google Ad Manager, come segue: `Audience Name (Audience ID)`.
