...
description: L'estensione Facebook Pixel è una destinazione pubblicitaria in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell’estensione, consulta la pagina dell’estensione in Adobe Exchange.
...
Il [!DNL Facebook Pixel] è uno strumento di analisi che consente di misurare l’efficacia della pubblicità comprendendo le azioni intraprese dalle persone sul sito web.

[!DNL Facebook Pixel] è un’estensione per annunci pubblicitari in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell&#39;estensione, vedi [Sito Web facebook Pixel](https://developers.facebook.com/docs/facebook-pixel/).
...
Per installare [!DNL Facebook Pixel] estensione:
