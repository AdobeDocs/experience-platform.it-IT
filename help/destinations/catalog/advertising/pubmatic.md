...
1. Connessione PubMatic
   ...
   Durante l&#39;attivazione iniziale, questa destinazione registrerà automaticamente i tipi di pubblico nella piattaforma PubMatic e utilizzerà l&#39;ID [!DNL Adobe Experience Platform] interno per la mappatura.
...
Per aiutarti a capire meglio come e quando utilizzare la destinazione [!DNL PubMatic Connect], ecco un esempio di caso d&#39;uso che i clienti [!DNL Adobe Experience Platform] possono risolvere utilizzando questa destinazione.

### Targeting degli utenti su piattaforme mobili, web e CTV {#targeting}

Gli editori o i provider di dati desiderano inviare tipi di pubblico da [!DNL Adobe Experience Platform] a [!DNL PubMatic Connect] per il targeting degli utenti su piattaforme mobili, web e CTV, utilizzando un&#39;ampia gamma di identificatori.
