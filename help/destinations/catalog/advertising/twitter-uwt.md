---
keywords: twitter;Twitter;tag del sito web universale di twitter;tag del sito web universale di Twitter;tag UWT di Twitter;Twitter uwt;twitter uwwwwwwt
title: Estensione tag del sito web universale Twitter
description: L’estensione tag del sito Web universale Twitter è una destinazione pubblicitaria in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità di estensione, consulta la pagina dell'estensione in Adobe Exchange.
...
# [!DNL Twitter Universal Website Tag] Estensione {#twitter-uwt-extension}

## Panoramica {#overview}

[!DNL Twitter Universal Website Tag] fornisce azioni per inviare beacon al tag UWT di Twitter.

[!DNL Twitter Universal Website Tag] è un&#39;estensione pubblicitaria in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità di estensione, consulta [Tracciamento conversione avanzato](https://business.twitter.com/en/solutions/twitter-ads/website-clicks/advanced-conversion-tracking.html).
...
![Estensione tag del sito web universale Twitter](../../assets/catalog/advertising/twitter-uwt/catalog.png)
