...
description: L’estensione tag per siti web Twitter Universal è una destinazione pubblicitaria in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell’estensione, consulta la pagina dell’estensione in Adobe Exchange.
...
![Estensione tag per sito web twitter Universal](../../assets/catalog/advertising/twitter-uwt/catalog.png)
...
Per installare [!DNL Twitter Universal Website Tag] estensione:
