...
>[!IMPORTANT]
>
>Questa destinazione è attualmente in versione beta ed è disponibile solo per un numero limitato di clienti. Per richiedere l’accesso a [!DNL Google Ad Manager 360] connessione, contatta il tuo rappresentante di Adobe e fornisci [!DNL IMS Organization ID].
