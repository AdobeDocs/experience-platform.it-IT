---
keywords: bing;bing ads event tracking;tracciamento eventi;UET;estensione UET
title: Estensione Bing Ads Universal Event Tracking (UET)
description: L’estensione Bing Ads Universal Event Tracking (UET) è una destinazione pubblicitaria in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità di estensione, consulta la pagina dell'estensione in Adobe Exchange.
...
# [!DNL Bing Ads Universal Event Tracking] Estensione (UET) {#bing-ads-extension}

## Panoramica {#overview}

L&#39;estensione tag [!DNL Bing Ads Universal Event Tracking] (UET) è un modo utile per tenere traccia di ciò che accade dopo che qualcuno ha fatto clic sull&#39;annuncio di ricerca. Utilizzando un singolo tag UET per registrare le attività dei clienti sul tuo sito web, puoi sfruttare tali dati, consentendoti di tenere traccia delle conversioni o indirizzare i tipi di pubblico utilizzando elenchi di remarketing.

[!DNL Bing Ads Universal Event Tracking] (UET) è un&#39;estensione pubblicitaria in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità di estensione, consulta la pagina dell&#39;estensione in [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100154.html).
...
Per informazioni sulle opzioni di configurazione dell&#39;estensione e sul supporto dell&#39;installazione, consulta la pagina [Bing Ads Universal Event Tracking (UET) in Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100154.html).
