...
description: L’estensione Flashtalk OneTag è una destinazione pubblicitaria in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell’estensione, consulta la pagina dell’estensione in Adobe Exchange.
...
Il [!DNL Flashtalking OneTag] l’estensione tag consente di attribuire facilmente le azioni del sito a visualizzazione, video e attività pubblicitarie mobili. Distribuire [!DNL Flashtalking OneTag] alle proprietà web utilizzando i tag.

[!DNL Flashtalking OneTag] è un’estensione per annunci pubblicitari in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell&#39;estensione, consulta la pagina dell&#39;estensione in [Scambio Adobe](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html).
...
![Estensione per sfarfallio](../../assets/catalog/advertising/flashtalking/catalog.png)
...
Per installare [!DNL Flashtalking OneTag] estensione:
...
Per informazioni sulle opzioni di configurazione dell’estensione e sul supporto per l’installazione, consulta [Sfarfallio della pagina OneTag in Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html).
