...
description: L’estensione tag LinkedIn Insight è una destinazione pubblicitaria in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell’estensione, consulta la pagina dell’estensione in Adobe Exchange.
...
Installare [!DNL LinkedIn Insight Tag] per utilizzare le funzioni di tracciamento delle conversioni, retargeting e demografia del sito web.

[!DNL LinkedIn Insight Tag] è un’estensione per annunci pubblicitari in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell’estensione, consulta [Tag linkedIn Insight](https://business.linkedin.com/marketing-solutions/insight-tag).
...
Per installare [!DNL LinkedIn Insight Tag] estensione:
...
Per informazioni sulle opzioni di configurazione dell’estensione e sul supporto per l’installazione, consulta [Tag linkedIn Insight](https://business.linkedin.com/marketing-solutions/insight-tag).
