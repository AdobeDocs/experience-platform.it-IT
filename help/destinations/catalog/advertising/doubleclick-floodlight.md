---
keywords: Fare doppio clic su Luce di inondazione;fare doppio clic su Estensione Luce di inondazione;fare doppio clic;torcia di inondazione
title: Estensione DoubleClick Floodlight (Beta)
description: L’estensione DoubleClick Floodlight (Beta) è una destinazione pubblicitaria in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell’estensione, consulta la pagina dell’estensione su Adobe Exchange.
...
# Estensione [!DNL DoubleClick Floodlight] (Beta)

## Panoramica {#overview}

Questa estensione consente di distribuire in modo semplice e rapido i tag [!DNL DoubleClick Floodlight] utilizzando il formato a luce diretta tradizionale (non il tag del sito globale). Nota: questa estensione è in versione beta.

[!DNL DoubleClick Floodlight] (Beta) è un&#39;estensione pubblicitaria in [!DNL Adobe Experience Platform]. Per ulteriori informazioni sulla funzionalità dell&#39;estensione, vedere la documentazione di supporto di [!DNL Google] per [DoubleClick Floodlight](https://support.google.com/dcm/answer/2823388?hl=en).
...
![Estensione Doubleclick Floodlight](../../assets/catalog/advertising/doubleclick-floodlight/catalog.png)
...
Per installare l’estensione DoubleClick Floodlight (Beta):
