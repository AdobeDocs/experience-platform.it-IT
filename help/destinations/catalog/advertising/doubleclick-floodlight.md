---
keywords: DoubleClick Floodlight;estensione doppio eclick floodlight;doppio eclick;floodlight
title: Estensione DoubleClick Floodlight (Beta)
description: L’estensione DoubleClick Floodlight (Beta) è una destinazione pubblicitaria in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità di estensione, consulta la pagina dell'estensione in Adobe Exchange.
...
Questa estensione consente di distribuire in modo rapido e semplice i tag [!DNL DoubleClick Floodlight] utilizzando il formato di luce mobile tradizionale (non il tag del sito globale). Nota: Questa estensione è in versione beta.

[!DNL DoubleClick Floodlight] (Beta) è un&#39;estensione pubblicitaria in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità di estensione, consulta la documentazione di supporto [!DNL Google] per [DoubleClick Floodlight](https://support.google.com/dcm/answer/2823388?hl=en).
