...
| Elemento | Tipo | Note |
|------------------|---------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Tipo di esportazione | **[!UICONTROL Segment export]** | Stai esportando tutti i membri di un segmento (pubblico) con gli identificatori (nome, numero di telefono o altri) utilizzati nella destinazione [!DNL Magnite: Real-Time]. |
...
* **[!UICONTROL Username]**: nome utente fornito da [!DNL Magnite].
...
Al termine, selezionare il pulsante **[!UICONTROL Create]**.
...
* È possibile aggiungere tutte le mappature necessarie selezionando **[!UICONTROL Add new mapping]**.

Questo esempio, utilizzando la destinazione in tempo reale, mostra una riga contenente un identificatore di origine deviceId generico mappato al campo di destinazione device_id Magnite. Quando si utilizzano i mapping, selezionare [!UICONTROL Next].
...
* Utilizza il campo **[!UICONTROL Mapping ID]** quando un pubblico ha un ID segmento preesistente noto in precedenza a Magnite.

* Per aggiungere un **[!UICONTROL Mapping ID]** a un pubblico, seleziona ogni riga di pubblico singolarmente e immetti i dati nella colonna di destra (vedi immagine qui sopra). Se non vuoi aggiungere un ID mappatura, inserisci NESSUNO nel campo ID mappatura.

Selezionare **[!UICONTROL Next]** e finalizzare il flusso di attivazione.
