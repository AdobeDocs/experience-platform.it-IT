...
In qualità di addetto al marketing, puoi fornire esperienze personalizzate agli utenti, in base agli attributi dei loro profili [!DNL Adobe Experience Platform]. È possibile creare tipi di pubblico dai dati offline e inviarli a [!DNL Dynamics 365] per visualizzarli nei feed degli utenti non appena tipi di pubblico e profili vengono aggiornati in [!DNL Adobe Experience Platform].
...
Per esportare dati da Experience Platform al tuo account [!DNL Dynamics 365], tieni presente i seguenti prerequisiti in [!DNL Dynamics 365]:
