...
description: Utilizza la destinazione di Salesforce CRM per esportare i dati del tuo account e attivarli in Salesforce CRM per le tue esigenze aziendali.
...
In qualità di addetto al marketing, puoi fornire esperienze personalizzate agli utenti, in base agli attributi dei loro profili [!DNL Adobe Experience Platform]. È possibile creare tipi di pubblico dai dati non in linea e inviarli a Salesforce CRM per aggiornare l&#39;appartenenza al sistema di gestione delle relazioni con i clienti non appena tipi di pubblico e profili vengono aggiornati in [!DNL Adobe Experience Platform].
...
Per esportare dati da Experience Platform al tuo account Salesforce, tieni presente i seguenti prerequisiti in [!DNL Salesforce CRM]:
...
1. Infine, vai al sito web Salesforce e verifica se i profili del pubblico sono stati aggiornati.
