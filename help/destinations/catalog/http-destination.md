...
# (Alfa) [!DNL HTTP] connection

>[!IMPORTANT]
>
>La [!DNL HTTP] La destinazione in Platform è attualmente in alfa. La documentazione e le funzionalità sono soggette a modifiche.

## Panoramica {#overview}

La [!DNL HTTP] la destinazione è [!DNL Adobe Experience Platform] destinazione in streaming che consente di inviare dati di profilo a terze parti [!DNL HTTP] endpoint.
