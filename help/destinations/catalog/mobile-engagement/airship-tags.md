...
In **[!UICONTROL Destinations]** > **[!UICONTROL Catalog]**, scorrete fino alla **[!UICONTROL Mobile Engagement]** categoria. Selezionate **[!DNL Airship Tags]**, quindi **[!UICONTROL Configure]**.
...
In **[!UICONTROL Destinations > Browse]**, seleziona la [!DNL Airship Tags] destinazione in cui vuoi attivare i segmenti.
...
Seleziona **[!UICONTROL Activate]**. Nel **[!UICONTROL Activate destination]** flusso di lavoro, nella **[!UICONTROL Select Segments]** pagina, seleziona i segmenti a cui inviare [!DNL Airship Tags].
...
![Connetti ai tag](../../assets/catalog/mobile-engagement/airship-tags/select-source-identity.png)![del volo per la mappatura dei](../../assets/catalog/mobile-engagement/airship-tags/select-target-identity.png)![canali](../../assets/catalog/mobile-engagement/airship-tags/mapping-option.png)
