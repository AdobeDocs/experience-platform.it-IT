...
# Estensione [!DNL Marketo Munchkin] {#marketo-munchkin-extension}

## Panoramica {#overview}

Dalla gestione dei lead al marketing basato sugli account, [!DNL Marketo Engagement Platform] semplifica la pianificazione, la gestione e la misurazione del coinvolgimento con clienti e potenziali clienti in ogni fase della loro esperienza.
...
[!DNL Marketo Munchkin] è un&#39;estensione e-mail in [!DNL Adobe Experience Platform]. Per ulteriori informazioni su Marketo Munchkin, consulta [Tracciamento lead](https://developers.marketo.com/javascript-api/lead-tracking/) nella documentazione di Marketo.
