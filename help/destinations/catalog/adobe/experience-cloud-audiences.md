...
> * *non hai bisogno* di una licenza Audience Manager per condividere [!DNL Real-Time CDP] tipi di pubblico con [!DNL Adobe Advertising], [!DNL Adobe Target], Marketo e altre soluzioni Experience Cloud, menzionate nella [sezione precedente](#share-segments-with-other-solutions).
