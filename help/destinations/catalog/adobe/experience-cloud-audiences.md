...
> * È necessaria una licenza di Audience Manager per abilitare il [Casi d’uso della piattaforma di gestione dati](#dmp-use-cases) di cui sopra.
> * You *non è necessario* una licenza di Audience Manager per condividere segmenti di Experience Platform con Adobe Advertising Cloud, Adobe Target, Marketo e altre soluzioni di Experience Cloud, menzionata in [sezione precedente](#share-segments-with-other-solutions).
