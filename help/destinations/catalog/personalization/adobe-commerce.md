...
1. Nell&#39;interfaccia [Experience Platform](https://experience.adobe.com/platform/), passa a **[!UICONTROL Destinations]** > **[!UICONTROL Catalog]**.
1. Seleziona **[!UICONTROL Personalization]**.
1. Seleziona la destinazione Adobe Commerce per evidenziarla, quindi seleziona **[!UICONTROL Set up]**.
