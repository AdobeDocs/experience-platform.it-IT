...
[!DNL Experience Cloud] Il servizio ID è un&#39;estensione di personalizzazione in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità di estensione, consulta la [pagina di estensione del servizio ID di Experience Cloud](../../../tags/extensions/web/id-service/overview.md) nella documentazione [!DNL Experience Platform Launch] .
...
Per informazioni sulle opzioni di configurazione dell&#39;estensione e sul supporto per l&#39;installazione, consulta la [pagina dell&#39;estensione del servizio ID di Experience Cloud](../../../tags/extensions/web/id-service/overview.md) nella documentazione [!DNL Experience Launch] .
