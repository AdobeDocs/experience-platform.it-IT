...
description: Visualizzare i tipi di pubblico per i quali i clienti si qualificano in Customer Journey Analytics.
...
* È necessario avere almeno un pubblico creato in [!DNL Adobe Experience Platform].
