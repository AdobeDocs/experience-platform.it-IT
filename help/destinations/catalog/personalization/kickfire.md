...
description: L’estensione KickFire è una destinazione di personalizzazione in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell’estensione, consulta la pagina dell’estensione in Adobe Exchange.
...
[!DNL KickFire's] I dati firmografici B2B e IP address intelligence consentono di tradurre gli indirizzi IP in aziende, identificare visitatori web anonimi e integrare i dati dell’account nello stack tecnologico, il tutto in base all’indirizzo IP di un’azienda.

[!DNL KickFire] è un’estensione di personalizzazione in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità dell’estensione, consulta [Sito Web Kickfire](https://www.kickfire.com/).
...
![Estensione Kick-Fire](../../assets/catalog/personalization/kickfire/catalog.png)
...
Per installare [!DNL KickFire] estensione:
