---
keywords: incendio;fuoco di kickfire;estensione kickfire;estensione Kickfire
title: Estensione KickFire
description: L’estensione KickFire è una destinazione di personalizzazione in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità di estensione, consulta la pagina dell'estensione in Adobe Exchange.
...
[!DNL KickFire's] I dati firmografici IP e IP intelligence e B2B consentono di tradurre gli indirizzi IP in aziende, identificare visitatori web anonimi e integrare i dati dell’account nello stack di tecnologia, tutto in base all’indirizzo IP di un’azienda.

[!DNL KickFire] è un’estensione di personalizzazione in Adobe Experience Platform. Per ulteriori informazioni sulla funzionalità di estensione, consulta [Sito web Kickfire](https://www.kickfire.com/).
