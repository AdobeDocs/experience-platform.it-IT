...
>abstract="Questa opzione determina in quale flusso di dati di raccolta dati i segmenti verranno inclusi nella risposta alla pagina. Il menu a discesa mostra solo gli stream di dati per i quali è abilitata la configurazione di destinazione. È necessario configurare uno stream di dati prima di poter configurare la destinazione."
>additional-url="https://experienceleague.adobe.com/docs/experience-platform/edge/fundamentals/datastreams.html?lang=en" text="Scopri come configurare uno stream di dati"
