...
Se non utilizza [Tag](/help/tags/home.md) per distribuire Experienci Platform Web SDK, utilizza [risposte ai comandi](/help/web-sdk/commands/command-responses.md) per visualizzare i dati esportati.
