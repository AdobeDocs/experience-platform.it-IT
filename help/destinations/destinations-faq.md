...
Questo documento fornisce le risposte alle domande frequenti sulle destinazioni [!DNL Adobe Experience Platform]. Per domande e risoluzione dei problemi relativi ad altri servizi [!DNL Experience Platform], inclusi quelli incontrati in tutte le API [!DNL Experience Platform], consulta la [guida alla risoluzione dei problemi di Experience Platform](../landing/troubleshooting.md).
