...
>title="Segmenti"
>abstract="La vista segmenti contiene informazioni su tutti i segmenti dell’organizzazione IMS, con ulteriori informazioni sui relativi processi di attivazione e valutazione."
...
![Il dashboard dei segmenti. Vengono visualizzate le informazioni sui diversi segmenti nell’organizzazione IMS e nella sandbox.](../assets/ui/monitor-segments/segment-monitoring-dashboard.png)
...
| **[!UICONTROL Conteggio profili]** | Il numero di profili valutati dal processo di segmentazione. Ogni utente deve avere un profilo univoco. |
...
>title="Segmenta processi"
>abstract="La vista Job dei segmenti contiene informazioni sui job di valutazione ed esportazione per tutti i segmenti."
