...
| **[!UICONTROL Numero di profili]** | Il numero di profili che il processo del segmento sta valutando. Ogni utente deve avere un profilo univoco. |
...
| **[!UICONTROL Numero di profili]** | Il numero di profili in fase di valutazione. |
