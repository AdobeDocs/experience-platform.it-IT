...
## Monitoraggio del dashboard delle identità {#identity-metrics}

>[!CONTEXTUALHELP]
>id="platform_monitoring_identity_processing"
>title="Elaborazione identità"
>abstract="La vista di elaborazione Identity contiene informazioni sui record acquisiti al servizio Identity, tra cui il numero di identità aggiunte, i grafici creati e quelli aggiornati. Per ulteriori informazioni su metriche e grafici, consulta la guida alla definizione delle metriche."
>text="Learn more in documentation"

>[!CONTEXTUALHELP]
>id="platform_monitoring_dataflow_run_details_identity"
>title="Dettagli dell’esecuzione del flusso di dati"
>abstract="La pagina dei dettagli dell’esecuzione del flusso di dati visualizza ulteriori informazioni sull’esecuzione del flusso di dati Identity, tra cui l’ID organizzazione e l’ID dell’esecuzione del flusso di dati."
