...
>- Per [Amazon Kinesis](/help/destinations/catalog/cloud-storage/amazon-kinesis.md), [Hub eventi di Azure](/help/destinations/catalog/cloud-storage/azure-event-hubs.md)e [API HTTP](/help/destinations/catalog/streaming/http-destination.md) le destinazioni, le metriche relative alle identità escluse, non riuscite e attivate sono stimate. Volumi più elevati di dati di attivazione portano a una maggiore precisione delle metriche.
