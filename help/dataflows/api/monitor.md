...
Per questa esercitazione è necessario avere il valore ID di un flusso di dati valido. Se non disponi di un ID di flusso di dati valido, seleziona il connettore desiderato dalla panoramica [delle](../../sources/home.md) origini o dalla panoramica [delle](../../destinations/catalog/overview.md) destinazioni e segui i passaggi descritti prima di eseguire l&#39;esercitazione.
...
| `fileSummary.extensions` | Contiene informazioni specifiche per l&#39;attività. Ad esempio, `manifest` è solo una parte dell&#39;&quot;Attività di promozione&quot; e pertanto è inclusa nell&#39; `extensions` oggetto. |
| `statusSummary` | Indica se l&#39;esecuzione del flusso è riuscita o meno. |

## Passaggi successivi

Seguendo questa esercitazione, hai recuperato le metriche e le informazioni sugli errori nel flusso di dati utilizzando l&#39; [!DNL Flow Service] API. Ora puoi continuare a monitorare il flusso di dati, a seconda della pianificazione dell&#39;assimilazione, per monitorarne lo stato e le percentuali di assimilazione. Per informazioni su come monitorare i flussi di dati per le origini, consultate i flussi di dati di [monitoraggio per le origini utilizzando l&#39;esercitazione dell&#39;interfaccia](../ui/monitor-sources.md) utente. Per ulteriori informazioni su come monitorare i flussi di dati per le destinazioni, consulta i flussi di dati di [monitoraggio per le destinazioni tramite l’esercitazione sull’interfaccia](../ui/monitor-destinations.md) utente.