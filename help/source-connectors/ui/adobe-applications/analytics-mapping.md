...
| puntiniere | placeContext.POIinteractive.POIDetail.</span>nome | string | Utilizzato dai servizi mobili. Rappresenta il punto di interesse. |
| puntofinterestdistanze | placeContext.POIinteractive.POIDetail.geoInteractionDetails.distanzaToCenter | number | Utilizzato dai servizi mobili. Rappresenta la distanza del punto di interesse. |
| mobilesegnaposto | placeContext.POIinteractive.POIDetail.geoInteractionDetails.deviceGeoAccuracy | number | Raccolte dalla variabile di dati contestuali a.loc.acc. Indica la precisione del GPS in metri al momento della raccolta. |
| mobileplacecategory | placeContext.POIinteractive.POIDetail.category | string | Raccolti dalla variabile di dati contestuali a.loc.category. Descrive la categoria di un luogo specifico. |
...
| mobilecrash | application.crash | Oggetto | <!-- MISSING --> | {id (stringa), value (numero)} |
| mobilemessagecick | directMarketing.Click | Oggetto | <!-- MISSING --> | {id (stringa), value (numero)} |
| mobilesegnaposto | placeContext.POIinteractive.poiEntries | Oggetto | <!-- MISSING --> | {id (stringa), value (numero)} |
| mobilesegnaposto exit | placeContext.POIinteractive.poiExits | Oggetto | <!-- MISSING --> | {id (stringa), value (numero)} |
| videotime | media.mediaTimed.timePlayed | Oggetto | <!-- MISSING --> | {id (stringa), value (numero)} |
| videostart | media.mediaTimed.impression | Oggetto | <!-- MISSING --> | {id (stringa), value (numero)} |
| videocomplete | media.mediaTimed.complete | Oggetto | <!-- MISSING --> | {id (stringa), value (numero)} |
| videosegmentazioni | media.mediaTimed.mediaSegmentViews | Oggetto | <!-- MISSING --> | {id (stringa), value (numero)} |
| videoadstart | advertising.impression | Oggetto | <!-- MISSING --> | {id (stringa), value (numero)} |
| videoadcomplete | advertising.complete | Oggetto | <!-- MISSING --> | {id (stringa), value (numero)} |
| videoadtime | advertising.timePlayed | Oggetto | <!-- MISSING --> | {id (stringa), value (numero)} |
| videochapterstart | media.mediaTimed.mediaChapter.impression | Oggetto | <!-- MISSING --> | {id (stringa), value (numero)} |
| videochaptercomplete | media.mediaTimed.mediaChapter.complete | Oggetto | <!-- MISSING --> | {id (stringa), value (numero)} |
| videochaptertime | media.mediaTimed.mediaChapter.timePlayed | Oggetto | <!-- MISSING --> | {id (stringa), value (numero)} |
| videogioco | media.mediaTimed.begin | Oggetto | <!-- MISSING --> | {id (stringa), value (numero)} |
...
| videoqoedroppedframecount | media.mediaTimed.directAssetViewDetails.qoe.dropFrames | Oggetto | <!-- MISSING --> | {id (stringa), value (numero)} |
...
| videoresume | media.mediaTimed.currices | Oggetto | <!-- MISSING --> | {id (stringa), value (numero)} |
| videopausecount | media.mediaTimed.pause | Oggetto | <!-- MISSING --> | {id (stringa), value (numero)} |
...
Per poter essere generati in XDM, è necessario trasformare alcuni campi provenienti da ADC, rendendo necessaria una logica che vada oltre la copia diretta di Adobe Analytics.
...
| m_pagename_no_url | web.webPageDetails.pageViews.value | number | Il nome della pagina (se impostato). Se non viene specificata alcuna pagina, questo valore viene lasciato vuoto. |
...
| post_page_event | web.webInteraction.linkClicks.value | number | Tipo di hit inviato nella richiesta di immagine (hit standard, collegamento di download, collegamento di uscita o collegamento personalizzato su cui è fatto clic). |
