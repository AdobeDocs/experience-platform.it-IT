...
La relazione tra Real-Time Customer Profile e altri servizi all’interno di Experience Platform è evidenziata nel diagramma seguente:
...
[!DNL Experience Platform] consente ai clienti di inviare richieste di rinuncia relative all&#39;utilizzo e all&#39;archiviazione dei dati in [!DNL Real-Time Customer Profile]. Per ulteriori informazioni sulla gestione delle richieste di rinuncia, consulta la documentazione su [rispetto delle richieste di rinuncia](../segmentation/tutorials/consents.md).
