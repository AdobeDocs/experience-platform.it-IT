...
| `tenantId` | Stringa | Questo ID assicura che le risorse create siano spuntate correttamente e contenute all&#39;interno dell&#39;organizzazione. [Segui i passaggi qui](../../xdm/api/getting-started.md#know-your-tenant_id) per trovare l’ID tenant. |
