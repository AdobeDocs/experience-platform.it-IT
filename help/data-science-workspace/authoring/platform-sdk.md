...
Per effettuare chiamate a è necessaria l’autenticazione [!DNL Adobe Experience Platform], ed è composto da Chiave API, ID organizzazione IMS, token utente e token di servizio.
...
Se non utilizzi Jupyter Notebook o se devi modificare l’organizzazione IMS, utilizza il seguente codice di esempio:
