...
È necessaria l’autenticazione per effettuare chiamate a [!DNL Adobe Experience Platform]ed è composto da chiave API, ID organizzazione, un token utente e un token di servizio.
...
Se non utilizzi Jupyter Notebook o hai bisogno di modificare l&#39;organizzazione, utilizza l&#39;esempio di codice seguente:
...
Se non utilizzi Jupyter Notebook o hai bisogno di cambiare organizzazione, utilizza il seguente codice di esempio:
...
>[!NOTE]
>
>L&#39;organizzazione è impostata all&#39;interno della `client_context`.
