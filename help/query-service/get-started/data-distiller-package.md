...
Consulta le guide su come [visualizzare SQL Insights](../../dashboards/data-distiller/sql-insights/overview.md) o su come utilizzare la modalità pro query per [eseguire analisi complesse con query SQL personalizzate e trasformare i tuoi dati in grafici facilmente interpretabili](../../dashboards/data-distiller/query-pro-mode/overview.md). Puoi utilizzare la modalità query pro per creare informazioni e visualizzazioni personalizzate sulle dashboard personalizzate.
