---
audience: user
user-guide-title: Guida al Query Service di Adobe Experience Platform
...
- Esempi {#use-cases}
   ...
   - [Prevedere l&#39;abbandono dei clienti con SQL](use-cases/predict-customer-churn-stub.md)
