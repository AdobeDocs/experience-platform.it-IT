...
Lo SKU di Data Distiller è necessario per utilizzare l’archivio con accelerazione query. Vedi la [imballaggio](../packages.md) e [guardrail](../guardrails.md#query-accelerated-store) documentazione relativa allo SKU di Data Distiller. Se non disponi della SKU di Data Distiller, contatta il tuo rappresentante del servizio clienti Adobe per ulteriori informazioni.
