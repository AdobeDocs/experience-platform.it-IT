...
È possibile recuperare un elenco di tutti i modelli di query per la propria organizzazione effettuando una richiesta di GET al `/query-templates` punto finale.
...
Una risposta corretta restituisce lo stato HTTP 200 con un elenco di modelli di query per l&#39;organizzazione specificata. La risposta seguente restituisce l’ultimo modello di query creato per la tua organizzazione.
