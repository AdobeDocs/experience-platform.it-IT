...
La guida all’analisi del consenso spiega come creare una dashboard del consenso per vari casi d’uso di marketing per i dati di Real-Time CDP. Per informazioni su come creare un dashboard di analisi del consenso per tenere traccia delle tendenze del consenso degli utenti nel tempo, consulta [guida della dashboard di analisi del consenso](../../dashboards/insights-use-cases/consent-analysis.md).
