...
Le query che utilizzano blocchi anonimi per comporre le istruzioni SQL vengono separate nelle singole query. Questo consente di esaminare i dettagli di esecuzione per ogni blocco di query singolarmente.
...
Le query di blocco anonime dispongono di schede a sinistra dello stato di esecuzione. Selezionare una scheda per visualizzare i dettagli dell&#39;esecuzione.
