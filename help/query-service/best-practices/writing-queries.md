...
La `\d` mostra il comando standard [!DNL PostgreSQL] visualizzazione per l&#39;elenco delle tabelle. Di seguito è riportato un esempio dell&#39;output di questo comando:
