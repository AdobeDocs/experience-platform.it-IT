...
Per ulteriori informazioni su come adattare le istruzioni SQL degli approfondimenti direttamente tramite l&#39;interfaccia utente di Experience Platform, consulta la [Visualizza documentazione SQL](../view-sql.md).
...
Per informazioni sull&#39;aspetto e sulle funzionalità di questo insight, consulta la [documentazione sui widget per la sovrapposizione dei tipi di pubblico con i criteri di unione](../guides/profiles.md#audience-overlap-by-merge-policy).
...
Per informazioni sull&#39;aspetto e sulle funzionalità di questo insight, consulta la [documentazione sui widget per report di sovrapposizione pubblico](../guides/profiles.md#audience-overlap-report).
...
Consulta la [documentazione del widget Tipi di pubblico](../guides/profiles.md#audiences) per informazioni sull&#39;aspetto e le funzionalità di questo insight.
...
Per informazioni sull&#39;aspetto e sulle funzionalità di questo insight, consulta la [documentazione sui tipi di pubblico mappati al widget di stato della destinazione](../guides/profiles.md#audiences-mapped-to-destination-status).
...
Per informazioni sull&#39;aspetto e sulle funzionalità di questo insight, consulta la [documentazione sui widget dimensione pubblico](../guides/profiles.md#audiences-size).
...
Per informazioni sull&#39;aspetto e le funzionalità di questo insight, consulta la [documentazione sulla distribuzione dei punteggi da parte di IA per l&#39;analisi dei clienti](../guides/profiles.md#customer-ai-distribution-of-scores).
...
Consulta la [documentazione del widget di riepilogo del punteggio di IA per l&#39;analisi dei clienti](../guides/profiles.md#customer-ai-scoring-summary) per informazioni sull&#39;aspetto e le funzionalità di questo insight.
...
- Utilizzando questa campagna di prestazioni insight, come possono essere ottimizzate le attività di marketing future?
...
Consulta la [documentazione sui widget di sovrapposizione identità](../guides/profiles.md#identity-overlap) per informazioni sull&#39;aspetto e le funzionalità di questo insight.
...
Informazioni complete sull&#39;aspetto e sulle funzionalità di questo insight sono disponibili nella [Guida del widget Conteggio profili](https://experienceleague.adobe.com/docs/experience-platform/dashboards/guides/profiles.html?lang=it#profile-count).

Consulta la [documentazione del widget del conteggio dei profili](../guides/profiles.md#profile-count) per informazioni sull&#39;aspetto e le funzionalità di questo insight.
...
Consulta la [documentazione del widget per la modifica del conteggio dei profili](../guides/profiles.md#profile-count-change) per informazioni sull&#39;aspetto e le funzionalità di questo insight.
...
Consulta la [documentazione del widget della tendenza di modifica del conteggio dei profili](../guides/profiles.md#profile-count-change-trend) per informazioni sull&#39;aspetto e le funzionalità di questo insight.
...
Consulta la [documentazione del widget di tendenza del conteggio dei profili](../guides/profiles.md#profile-count-trend) per informazioni sull&#39;aspetto e le funzionalità di questo insight.
...
Per informazioni sull&#39;aspetto e sulle funzionalità di questo insight, consulta la [documentazione sui profili per widget di identità](../guides/profiles.md#profiles-by-identity).
...
Per informazioni sull&#39;aspetto e sulle funzionalità di questo insight, consulta la [documentazione del widget della tendenza di modifica del conteggio dei profili](../guides/profiles.md#profiles-count-change-trend).
...
Per informazioni sull&#39;aspetto e sulle funzionalità di questo insight, consulta la [documentazione sulla modifica del conteggio dei profili in base al widget di identità](../guides/profiles.md#profiles-count-change-trend-by-identity).
...
Consulta la [documentazione del widget Profili di identità singola](../guides/profiles.md#single-identity-profiles) per informazioni sull&#39;aspetto e le funzionalità di questo insight.
...
Per informazioni sull&#39;aspetto e sulle funzionalità di questo insight, consulta la [documentazione dei profili di identità singola per widget identità](../guides/profiles.md#single-identity-profiles-by-identity).
...
Per informazioni sull&#39;aspetto e sulle funzionalità di questo insight, consulta la [documentazione sui widget di profili non segmentati](../guides/profiles.md#unsegmented-profiles).
