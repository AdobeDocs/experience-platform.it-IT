...
Un retailer con più negozi online desidera personalizzare l’esperienza dell’acquirente nei suoi domini, in base agli interessi dei clienti. Utilizzando la funzione di condivisione ID tra domini diversi di Web SDK, retailer può fornire offerte precise in base agli interessi dei clienti, su tutti i loro domini.

### Migliorare il reporting delle attività dei visitatori

Una tecnologia con cui retailer vuole migliorare il reporting delle attività dei visitatori con informazioni su quando i visitatori passano dall’app mobile al sito web mobile o ad altri domini. Utilizzando la funzione di condivisione ID tra domini diversi di Web SDK, il team marketing può tracciare con precisione i visitatori nelle loro proprietà web e generare rapporti sulle attività.
...
Per le implementazioni Edge Network per dispositivi mobili, questa funzione è supportata nell&#39;estensione [Identity for Edge Network](https://developer.adobe.com/client-sdks/documentation/identity-for-edge-network/) a partire dalla versione 1.1.0 (iOS e Android).
...
Non è richiesta alcuna configurazione aggiuntiva affinché il Web SDK accetti i valori `ECID` nella stringa di query.
...
Visualizzare i collegamenti seguenti, a seconda della configurazione del Web SDK:

* **Libreria JavaScript**: comando [`appendIdentityToUrl`](../../js/commands/appendidentitytourl.md)
* **Estensione tag**: [Reindirizza con azione identità](/help/tags/extensions/client/web-sdk/actions/redirect-with-identity.md)
