...
Per ulteriori esempi e informazioni sui requisiti storici dei dati, visita il [Customer AI](./customer-ai/data-requirements.md#data-requirements) o [Attribution AI](./attribution-ai/input-output.md#data-requirements) la sezione sui requisiti dei dati storici nella documentazione di input/output.
...
>[!IMPORTANT]
>
>Se recentemente hai impostato un connettore, devi verificare che il set di dati abbia la lunghezza minima necessaria per i dati. Consulta la sezione relativa ai dati storici nel [documentazione di ingresso/uscita](./customer-ai/data-requirements.md) per Customer AI e verifica di disporre di dati sufficienti per l’obiettivo di previsione.
