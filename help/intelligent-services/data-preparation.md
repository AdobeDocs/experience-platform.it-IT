...
Per ulteriori esempi e informazioni sui requisiti dei dati storici, visita [IA per l’analisi dei clienti](./customer-ai/data-requirements.md#data-requirements) o [Attribution AI](./attribution-ai/input-output.md#data-requirements) sezione sui requisiti dei dati storici nella documentazione di input/output.
