...
Una volta completati i passaggi descritti nel documento precedente, visita il [Ingresso e uscita](./data-requirements.md) documentazione. Questo documento fornisce una breve panoramica dei tipi di dati utilizzati e prodotti in Customer AI.
