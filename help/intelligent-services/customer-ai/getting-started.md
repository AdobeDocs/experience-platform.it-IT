...
Dopo aver completato i passaggi descritti nel documento precedente, visita il [Ingresso e uscita](./input-output.md) documentazione. Questo documento fornisce una breve panoramica sui tipi di dati utilizzati e prodotti in Customer AI.
