...
Puoi definire importanti campi del set di dati di profilo (con marche temporali) nei tuoi dati oltre a [campi evento standard](../data-requirements.md#standard-events) utilizzato da Customer AI per generare punteggi di propensione. L’utilizzo di questa opzione consente di aggiungere attributi di profilo aggiuntivi che ritieni influenti e che possono migliorare la qualità del modello e fornire risultati più precisi. Inoltre, l’aggiunta di attributi di profilo personalizzati consente a Customer AI di mostrare meglio in che modo particolari profili sono finiti in un bucket di propensione.
