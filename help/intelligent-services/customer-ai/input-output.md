...
Per visualizzare un gruppo di campi nell’interfaccia utente di Platform, seleziona la scheda **[!UICONTROL Schemas]** nella barra a sinistra, quindi seleziona la scheda **[!UICONTROL Field groups]** .
