...
In questo documento sono delineate le etichette di utilizzo dei dati di base attualmente fornite da [!DNL Experience Platform]. Ulteriori informazioni su [!DNL Data Governance] sono disponibili nella [Panoramica sulla governance dei dati](../home.md).
